...
p = "100"
serialport.write("Y")  # Fuel
time.sleep(.5)
serialport.write("a")  # Fuel map 0
rpmsite = 97
Cmapf = " Config"
Cmapi = " Config"
bar_desc = "Not Def"
...
def read_from_port(ser):   
    ...
    #                                                                print track_name
        ...
        load = w_temp
        throttle = tps
        print("Sleep for a millisecond")
        main.calculator.rand(1)
        time.sleep(0.01)
...
#  # print "log_count is " + str(log_count)
#
#      screen.fill(black)
...
#        else:
#              accel_text = font3.render('%.2fm/s\xb2'%log_count, 1, blue)
...
#        screen.blit(log_count_text, log_count_text_pos)
