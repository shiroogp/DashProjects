...
def on_message(ws, message):
    try:
        ...
        print(message)       # data type is dict.. only showing values for the key 'price'
        time_count += 1
        try:
            result =  message    
            #   print(result)
...
def connect_websocket():
    ...
    # acceleration = 0
    # temperature = 55
    ws = websocket.WebSocketApp("ws://192.168.1.74:8738/ws", on_open = on_open, on_close = on_close, on_message = on_message, on_error = on_error)
    ws.run_forever()
