...
class DashBoard : public QObject
{
    ...
    Q_PROPERTY(QString newDashFile READ newDashFile WRITE setNewDashFile NOTIFY newDashFileChanged)

    // Odometer
    Q_PROPERTY(qreal Odo READ Odo WRITE setOdo NOTIFY odoChanged)
    Q_PROPERTY(qreal orient READ orient WRITE setOrientation NOTIFY orientationChanged)
    ...
    Q_PROPERTY(QStringList dashsetup5 READ dashsetup5 WRITE setdashsetup5 NOTIFY dashsetup5Changed)
    Q_PROPERTY(QStringList dashsetup4 READ dashsetup4 WRITE setdashsetup4 NOTIFY dashsetup4Changed)
    ...
    Q_PROPERTY(qreal pageNo READ pageNo WRITE pageNo NOTIFY pageNoChanged)
    Q_PROPERTY(qreal sourceIndex READ sourceIndex WRITE sourceIndex NOTIFY sourceIndexChanged)
    ...
    Q_PROPERTY(int rpmstyle4 READ rpmstyle4 WRITE setrpmstyle4 NOTIFY rpmstyle4Changed)
...
public:
    ...
    void setNewDashFile(const QString &newDashFile);
    // Odometer
    ...
    void setdashsetup5(const QStringList &dashsetup5);
    void setdashsetup4(const QStringList &dashsetup4);
    ...
    void pageNo(const qreal &pageNo);
    void updatePageNo(const qreal &pageNo);
    void sourceIndex(const qreal &sourceIndex);
    ...
    void setDone();
    void setErrorOcurred(const QString& errStr);
    ...
    void setrpmstyle4(const int &rpmstyle4);
   ...
   Q_INVOKABLE void setgearcalcactivation(const int &gearcalcactivation);
    ...
    QStringList dashsetup5() const;
    QStringList dashsetup4() const;
...
signals:
    ...
    void newDashFileChanged(QString newDashFile);
    //Odometer
    void odoChanged(qreal Odo);
    void orientationChanged(qreal orient);
    //Tripmeter
    ...
    void dashsetup5Changed(QStringList dashsetup5);
    void dashsetup4Changed(QStringList dashsetup4);
    ...
    void pageNoChanged(qreal pageNo);
    void sourceIndexChanged(qreal sourceIndex);
    ...
    void rpmstyle4Changed(int rpmstyle4);
...
private:
    ...
    QStringList m_dashsetup5;
    QStringList m_dashsetup4;
