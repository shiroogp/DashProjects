...
Canvas
{
    ...
    property color cadrancolour: Qt.rgba((lowValues/highValuesColor), 1, (1 - (lowValues/highValues)) * 0.5)
...
//        property string cadrancolour: Qt.rgba((lowValues/highValuesColor), 1, (1 - (lowValues/highValues)) * 0.5)
...
//        }
    ...
    onSubDivsChanged: {
        gauge_canvas.requestPaint();
        value_timer.requestPaint();
    }
    ...
    Canvas
    {
        ...
        property color targetColor : cadrancolour;
//        property color targetColor : getCadranColor();
        Behavior on targetColor {ColorAnimation {duration: 1}}

        onPaint:
        {
//            console.log("paint roundgauge");
            if(parent.visible == true){
//                console.log("paint roundgauge");
