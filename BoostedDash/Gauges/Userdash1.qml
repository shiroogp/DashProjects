...
Item {
    ...
    Connections{
        ...
        onDashsetup1Changed: {
            ...
            //console.log(Dashboard.dashsetup1)
                ...
                if (dashvalue.textAt(26) !== "") {gaugeType = dashvalue.textAt(25);}//else {gaugeType = "SquareGauge";}
                if (dashvalue.textAt(9) === "true") {val1 = true};
                if (dashvalue.textAt(9) === "false") {val1 = false};
                if (dashvalue.textAt(10) === "true") {val2 = true};
                if (dashvalue.textAt(10) === "false") {val2 = false};
                if (dashvalue.textAt(11) === "true") {val3 = true};
                if (dashvalue.textAt(11) === "false") {val3 = false};
                if (dashvalue.textAt(16) !== "") {val4 = dashvalue.textAt(16);}else {val4 = 20000;}
                if (dashvalue.textAt(16) !== "") {val5 = dashvalue.textAt(16);}else {val5 = -20000;}
                if (dashvalue.textAt(17) !== "") {val6 = dashvalue.textAt(17);}else {val6 = "#9f9f9f";}
                if (dashvalue.textAt(18) !== "") {val7 = dashvalue.textAt(18);}else {val7 = "black";}
                if (dashvalue.textAt(19) !== "") {val8 = dashvalue.textAt(19);}else {val8 = "#9f9f9f";}
                if (dashvalue.textAt(20) !== "") {val9 = dashvalue.textAt(20);}else {val9 = "white";}
                if (dashvalue.textAt(21) !== "") {val10 = dashvalue.textAt(21);}else {val10 = "white";}
                if (dashvalue.textAt(22) !== "") {val11 = dashvalue.textAt(22);}else {val11 = "grey";}
                if (dashvalue.textAt(23) !== "") {val12 = dashvalue.textAt(23);}else {val12 = 28;}
                if (dashvalue.textAt(24) !== "") {val13 = dashvalue.textAt(24);}else {val13 = 50;}
                if (dashvalue.textAt(26) !== "") {gaugecolor1 = dashvalue.textAt(26);}else {gaugecolor1 = "white";}
                if (dashvalue.textAt(27) !== "") {gaugecolor2 = dashvalue.textAt(27);}else {gaugecolor2 = "red";}
                if (dashvalue.textAt(28) !== "") {gaugecolor3 = dashvalue.textAt(28);}else {gaugecolor3 = "#ffffff";}
                if (dashvalue.textAt(29) !== "") {gaugecolor4 = dashvalue.textAt(29);}else {gaugecolor4 = "blue";}
                if (dashvalue.textAt(30) !== "") {gaugecolor5 = dashvalue.textAt(30);}else {gaugecolor5 = "red";}
                if (dashvalue.textAt(31) !== "") {gaugecolor6 = dashvalue.textAt(31);}else {gaugecolor6 = "red";}
                if (dashvalue.textAt(32) !== "") {gaugecolor7 = dashvalue.textAt(32);}else {gaugecolor7 = "blue";}
                if (dashvalue.textAt(33) !== "") {gaugecolor8 = dashvalue.textAt(33);}else {gaugecolor8 = "white";}
                if (dashvalue.textAt(34) !== "") {gaugecolor9 = dashvalue.textAt(34);}else {gaugecolor9 = "red";}
                if (dashvalue.textAt(35) !== "") {shadecolor1 = dashvalue.textAt(35);}else {shadecolor1 = "#ffffff";}
                if (dashvalue.textAt(36) !== "") {shadecolor2 = dashvalue.textAt(36);}else {shadecolor2 = "#e96448";}
                if (dashvalue.textAt(37) !== "") {shadecolor3 = dashvalue.textAt(37);}else {shadecolor3 = "#f22900";}
                if (dashvalue.textAt(38) !== "") {shadecolor4 = dashvalue.textAt(38);}else {shadecolor4 = "transparent";}
                if (dashvalue.textAt(39) !== "") {stepsize = dashvalue.textAt(39);}else {stepsize = 20;}
                if (dashvalue.textAt(40) !== "") {minValueAngle = dashvalue.textAt(40);}else {minValueAngle = "-90";}
                if (dashvalue.textAt(41) !== "") {maxValueAngle = dashvalue.textAt(41);}else {maxValueAngle = "180";}
                if (dashvalue.textAt(42) !== "") {myRotation = dashvalue.textAt(42);}else {myRotation = "0";}
                if (dashvalue.textAt(43) !== "") {fullCirc = (dashvalue.textAt(43)==="true");}else {fullCirc = false;}
                if (dashvalue.textAt(44) !== "") {subDivVal = dashvalue.textAt(44);}else {subDivVal = "6";}
                if (dashvalue.textAt(45) !== "") {imgSource = "file://"+dashvalue.textAt(45);}else {imgSource = "";}
                if (gaugeType.toLowerCase()== "squaregauge") {

                    CreateSquareGaugeScript.createSquareGauge(dashvalue.textAt(1),dashvalue.textAt(2),dashvalue.textAt(3),dashvalue.textAt(4),dashvalue.textAt(5),dashvalue.textAt(6),dashvalue.textAt(7),dashvalue.textAt(8),val1,val2,val3,Dashboard,dashvalue.textAt(13),dashvalue.textAt(14),val4,val5,val6,val7,val8,val9,val10,val11,val12,val13,gaugecolor1,gaugecolor2,gaugecolor3,gaugecolor4,gaugecolor5,gaugecolor6,gaugecolor7,gaugecolor8,gaugecolor9,shadecolor1,shadecolor2,shadecolor3,shadecolor4,stepsize,minValueAngle,maxValueAngle,myRotation,fullCirc,subDivVal,imgSource);
                }else if (gaugeType.toLowerCase()== "roundgauge") {

                    CreateRoundGaugeScript.createRoundGauge(dashvalue.textAt(1),dashvalue.textAt(2),dashvalue.textAt(3),dashvalue.textAt(4),dashvalue.textAt(5),dashvalue.textAt(6),dashvalue.textAt(7),dashvalue.textAt(8),val1,val2,val3,Dashboard,dashvalue.textAt(13),dashvalue.textAt(14),val4,val5,val6,val7,val8,val9,val10,val11,val12,val13,gaugecolor1,gaugecolor2,gaugecolor3,gaugecolor4,gaugecolor5,gaugecolor6,gaugecolor7,gaugecolor8,gaugecolor9,shadecolor1,shadecolor2,shadecolor3,shadecolor4,stepsize,minValueAngle,maxValueAngle,myRotation,fullCirc,subDivVal,imgSource);
                }else if (gaugeType.toLowerCase()== "speedogauge") {

                    CreateSpeedoGaugeScript.createSpeedoGauge(dashvalue.textAt(1),dashvalue.textAt(2),dashvalue.textAt(3),dashvalue.textAt(4),dashvalue.textAt(5),dashvalue.textAt(6),dashvalue.textAt(7),dashvalue.textAt(8),val1,val2,val3,Dashboard,dashvalue.textAt(13),dashvalue.textAt(14),val4,val5,val6,val7,val8,val9,val10,val11,val12,val13,gaugecolor1,gaugecolor2,gaugecolor3,gaugecolor4,gaugecolor5,gaugecolor6,gaugecolor7,gaugecolor8,gaugecolor9,shadecolor1,shadecolor2,shadecolor3,shadecolor4,stepsize,minValueAngle,maxValueAngle,myRotation,fullCirc,subDivVal,imgSource);
                }else if (gaugeType.toLowerCase()== "tachogauge") {

                    CreateTachoGaugeScript.createTachoGauge(dashvalue.textAt(1),dashvalue.textAt(2),dashvalue.textAt(3),dashvalue.textAt(4),dashvalue.textAt(5),dashvalue.textAt(6),dashvalue.textAt(7),dashvalue.textAt(8),val1,val2,val3,Dashboard,dashvalue.textAt(13),dashvalue.textAt(14),val4,val5,val6,val7,val8,val9,val10,val11,val12,val13,gaugecolor1,gaugecolor2,gaugecolor3,gaugecolor4,gaugecolor5,gaugecolor6,gaugecolor7,gaugecolor8,gaugecolor9,shadecolor1,shadecolor2,shadecolor3,shadecolor4,stepsize,minValueAngle,maxValueAngle,myRotation,fullCirc,subDivVal,imgSource);
                }else if (gaugeType.toLowerCase()== "imagegauge") {

                    CreateImageScript.createImage(dashvalue.textAt(1),dashvalue.textAt(2),dashvalue.textAt(3),dashvalue.textAt(4),dashvalue.textAt(5),dashvalue.textAt(6),dashvalue.textAt(7),dashvalue.textAt(8),val1,val2,val3,Dashboard,dashvalue.textAt(13),dashvalue.textAt(14),val4,val5,val6,val7,val8,val9,val10,val11,val12,val13,gaugecolor1,gaugecolor2,gaugecolor3,gaugecolor4,gaugecolor5,gaugecolor6,gaugecolor7,gaugecolor8,gaugecolor9,shadecolor1,shadecolor2,shadecolor3,shadecolor4,stepsize,minValueAngle,maxValueAngle,myRotation,fullCirc,subDivVal,imgSource);
                }else             if (dashvalue.textAt(1) !== "") {
            ...
            //        for (var ii=0; ii<userDash.children.length; ii++){
            //            console.log(userDash.children[ii].objectName)//: "SquareGauge");
            //        }
        }
        onRpmstyle1Changed:
        {
    ...
    onChildrenChanged: {
        //        var outfileText = "";
        //        for (var ii=0; ii<userDash.children.length; ii++){
        //            if(userDash.children[ii].objectName == "SquareGauge"){
        //            console.log(userDash.children[ii].objectName)//: "SquareGauge");
        //            console.log(userDash.children[ii].x)//: "SquareGauge");
        //            console.log(userDash.children[ii].y)//: "SquareGauge");
        //            console.log(userDash.children[ii].fullCircl)//: "SquareGauge");

        //                outfileText+=userDash.children[ii].x+","+userDash.children[ii].y+","+userDash.children[ii].fullCirc;
        //            }
        //        }
        //        Connect.writeDashFile("text.txt",outfileText);
    }
    ...
    Loader{
        ...
        ComboBox{
            ...
            model: Dashboard.dashsetup1
            visible:false
            Component.onCompleted: {Connect.readdashsetup1(),rpmgauge.selector();}
        }
    Item{
        id: rpmgauge
        function selector()
