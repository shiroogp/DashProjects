                    ...
                    Item {
                        ...
                        function selDash1()
                        {
                            ...
                            if(loadScreens == true){
                                ...
                                if (dash1.currentIndex == "11") {firstPageLoader.source = "qrc:/Gauges/Cluster.qml"};
                                ...
                                if (dash1.currentIndex == "12") {firstPageLoader.source = "qrc:/Gauges/MyElement.qml"};
...
Connect.setOrientation();
                    ...
                    Item {
                        ...
                        Component.onCompleted: tabView.currentIndex = 3 // opens the 3rd tab
