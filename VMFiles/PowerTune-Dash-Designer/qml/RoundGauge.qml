...
//        Behavior on needleAngleRad {SpringAnimation {spring: 5; damping: 0.8;}}
        onNeedleAngleRadChanged: value_timer.requestPaint();
    }

    onLowValuesColorChanged: requestPaint();
    onHighValuesColorChanged: requestPaint();
    onInnerCirclingColorChanged: requestPaint();
    onOuterCirclingColorChanged: requestPaint();
    onTextColorChanged: requestPaint();
    onGraduationColorChanged: requestPaint();
    onBackgroundColorChanged: requestPaint();
    onMinValueChanged: requestPaint();
    onMaxValueChanged: requestPaint();
    onLowValuesChanged: requestPaint();
    onHighValuesChanged: requestPaint();
    onSubDivsChanged: requestPaint();
    onWidthChanged: requestPaint();
    onHeightChanged: requestPaint();
    onFullCircleChanged: requestPaint();
    ...
    Canvas
    {
        ...
        Behavior on targetColor {ColorAnimation {duration: 25}}
