            ...
            Item {
                ...
                Grid {
                    ...
                    ComboBox {
                        ...
                        font.pixelSize: dashselector.width / 55
                        model: ["Screen Toggle", "Adaptronic","Charts", "GPS", "PowerFC Sensors","User Dash 1","User Dash 2","User Dash 3","G-Force","Dyno","Mediaplayer","Main Dash"]
                        property bool initialized: true
                ...
                Item {
                    ...
                    function selDash2()
                    {
                        if (dash2.currentIndex == "11") {secondPageLoader.source = "qrc:/Gauges/Cluster.qml"};
                ...
                Item {
                    ...
                    function selDash3()
                    {
                        if (dash3.currentIndex == "11") {thirdPageLoader.source = "qrc:/Gauges/Cluster.qml"};
                        ...
                        if (dash3.currentIndex == "0" ){thirdPageLoader.source = "qrc:/Gauges/Screentoggle.qml"};
                ...
                Item {
                    ...
                    function selDash4()
                    {
                        if (dash4.currentIndex == "11") {fourthPageLoader.source = "qrc:/Gauges/Cluster.qml"};
                        ...
                        if (dash4.currentIndex == "0") {fourthPageLoader.source = "qrc:/Gauges/Screentoggle.qml"};
