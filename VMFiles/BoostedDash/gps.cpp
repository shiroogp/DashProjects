...
void GPS::doMyInit()
{
    m_dashboard->setgpsFIXtype("Setting default values for PMods GPS");
    m_serialport->write(QByteArray::fromHex("24504D544B3235312C33383430302A32375C725C6E")); //VTG OFF
    m_serialport->waitForBytesWritten(4000);
    m_serialport->write(QByteArray::fromHex("24504D544B3331342C302C312C312C302C302C302C302C302C302C302C302C302C302C302C302C302C302C302C302A32385C725C6E")); //VTG OFF
    m_serialport->waitForBytesWritten(4000);
    m_serialport->write(QByteArray::fromHex("24504D544B3232302C3130302A32465C725C6E")); //VTG OFF
    m_serialport->waitForBytesWritten(4000);
