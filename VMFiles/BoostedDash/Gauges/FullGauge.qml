...
Item {
    ...
    property string maxvalue: "0"// tacho_gauge.maxValue
    ...
    MouseArea {
        ...
        drag.target: parent
        onDoubleClicked:{
            if(initialSpeedoID.visible == true){
...
//            fullCircle: initialID.fullCirc
//            anchors
//            {
//                top : parent.top
//            }

//            lowValuesColor : initialID.gaugecolor1
//            highValuesColor : initialID.gaugecolor2
//            innerCirclingColor : initialID.gaugecolor3
//            outerCirclingColor : initialID.gaugecolor4
//            textColor : initialID.gaugecolor5
//            graduationColor : initialID.gaugecolor6
//            backgroundColor : initialID.gaugecolor7
//            cadrancolour  : initialID.gaugecolor8
//            unit: initialID.mainunit
//            unitFont.pointSize: initialID.height/30
//            unitFont.bold: true
...
//            digitalFont.pointSize: initialID.height/15
//            currentValue: initialID.mainvalue // / 1000// * (maxValue - minValue) + minValue;
//            subDivs: initialID.subDivVal
//            minValue: 0
//            maxValue: initialID.maxval
//            lowValues: initialID.warnvaluelow
//            highValues: initialID.warnvaluehigh
//        }
...
//        //    border.color: "#9f9f9f"
//        //    border.width: 2
//        Component.onCompleted: colorsettingsTacho.set()
...
//                needleLength: 0
//                needleBaseWidth: 0
//                maximumValueAngle: initialID.maxValueAngle
//                redline: initialID.gaugecolor5
//                redlineVal: initialID.warnvaluehigh
//    //            arcStartDeg: ((((warnvaluehigh ) * (maximumValueAngle-minimumValueAngle) / maxvalue)+minValueAngle) * (Math.PI/180)) + (Math.PI/2)
//                arcStartDeg: ((((initialID.warnvaluehigh/initialID.maxvalue) * (initialID.maximumValueAngle-initialID.minimumValueAngle))+initialID.minValueAngle -90) * (Math.PI/180))// + ((90 - minValueAngle) * Math.PI/180)

//    //            arcStartDeg : (((warnvaluehigh ) * (maximumValueAngle-minimumValueAngle) / maxvalue)+minValueAngle)+90
//                tickmarkLabel: Text {
//                    color: initialID.gaugecolor1
//                    text: styleData.value
...
//                }
//                            minimumValueAngle: initialID.minValueAngle
...
//            minval: initialID.minValueAngle
//            maxvaldegs: initialID.maxValueAngle
//            angle: (Dashboard.rpm * (77/(initialID.maxvalue*1000)))*3.5*Math.PI / 180
//            //        4000/8000
//                    needlecolor: initialID.gaugecolor4
//            angleOffset: (initialID.minValueAngle-90) * (Math.PI / 180)
//            clorStop1: initialID.shadecolor1
...
//        Item {
//            //Set the colors of backround and Boarder
//            id: colorsettingsTacho
//            function set()
//            {
//                initialTachoID.color = initialID.resetbackroundcolor;
//                initialTachoID.border.color = initialID.framecolor;
