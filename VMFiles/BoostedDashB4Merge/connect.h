...
public:
    ...
    Q_INVOKABLE void setfilename4(const QString &file4);
    Q_INVOKABLE void setfilename5(const QString &file5);
    Q_INVOKABLE void setdash1(const QString &file1);
    Q_INVOKABLE void setdash2(const QString &file2);
    Q_INVOKABLE void setdash3(const QString &file3);
    Q_INVOKABLE void setdash4(const QString &file4);
    Q_INVOKABLE void setdash5(const QString &file5);
    Q_INVOKABLE void setdash6(const QString &file6);
    Q_INVOKABLE void checkifraspberrypi();
    Q_INVOKABLE void writeDefaultFiles();
    Q_INVOKABLE void readavailabledashfiles();
    Q_INVOKABLE void setrpm(const int &dash1,const int &dash2,const int &dash3,const int &dash4);
    Q_INVOKABLE void readMaindashsetup();
    Q_INVOKABLE void readdashsetup5();
    Q_INVOKABLE void readdashsetup4();
    ...
    Q_INVOKABLE void setRemoteDash(const QString &remotedashurl, const QString &remotedashport);
    Q_INVOKABLE void writeDashFile(const QString &fileName, const QString &fileContents);
    Q_INVOKABLE void writeReceivedDashFile(const QString &raw);
    Q_INVOKABLE QString copyFileToStore(const QString &oldfileName, const QString &newFileName);
    Q_INVOKABLE QString copyDashFile(const QString &oldfileName, const QString &newFileName);
    Q_INVOKABLE void setSpeedUnits(const int &units1);
    Q_INVOKABLE void setWidth(const int &width1);
    Q_INVOKABLE void setInitSize(const bool &iSize);
    Q_INVOKABLE void setHeight(const int &height1);
    Q_INVOKABLE void setOrientation();
    ...
    Q_INVOKABLE void pageNo(const qreal &pageNo);
    Q_INVOKABLE void updatePageNo(const qreal &pageNo);
    Q_INVOKABLE void sourceIndex(const qreal &sourceIndex);
    ...
    Q_INVOKABLE void reopenConnection();
    ...
    Q_INVOKABLE QStringList getAddresses();
    Q_INVOKABLE QStringList getNetwork();

    Q_INVOKABLE QString getfilename1();
    Q_INVOKABLE QString getfilename2();
    Q_INVOKABLE QString getfilename3();
    Q_INVOKABLE QString getfilename4();
    Q_INVOKABLE QString getfilename5();
    Q_INVOKABLE QString getdash1();
    Q_INVOKABLE QString getdash2();
    Q_INVOKABLE QString getdash3();
    Q_INVOKABLE QString getdash4();
    Q_INVOKABLE QString getdash5();
    Q_INVOKABLE QString getdash6();
