...
TabView {
    ...
    //    property alias dashselector: dashselector
    style: TabViewStyle {
        frameOverlap: 1
        tab: Rectangle {
            id:tabrect
...
*/
                        ...
                        Switch {
                            ...
                            property bool initialized: false
                            onCheckedChanged:{if (initialized) AppSettings.setautoconnect( checked );
                                }
                            Component.onCompleted: { checked = AppSettings.getautoconnect();initialized = true; }
                        ...
                        Slider {
                            ...
                            Item {
                                ...
                                function auto()
                                {
                                    ...
                                    if (AppSettings.getautoconnect() == true) functconnect.connectfunc(),connectButton.enabled =false,ecuSelect.enabled = false,disconnectButton.enabled = true;//Connect.openConnection(serialName.currentText, ecuSelect.currentIndex, loggerSelect.currentIndex,logger.datalogger()),
                                }
                            }
                            Item {
                                ...
                                Row {
                                    ...
                                    Grid {
                                        ...
                                        ComboBox {
                                            ...
                                            property bool initialized: false
                                            onCurrentIndexChanged:{if(loadScreens == true){select1.selDash1()};if (initialized) AppSettings.setScreen1( currentIndex );
                                                }
                                            Component.onCompleted: {
                                                currentIndex = AppSettings.getScreen1(),
                                                initialized = true; }
...
//                                                    Connect.setdash6(dash6.textAt(dash6.currentIndex))} }
                                            onCurrentIndexChanged:{if(loadScreens == true){select6.selDash6()
                                                    Connect.setdash6(dash6.textAt(dash6.currentIndex))};if (initialized) AppSettings.setScreen2( currentIndex );
                                                 }
                                            Component.onCompleted: { currentIndex = AppSettings.getScreen2(),initialized = true; }
...
//                                                    Connect.setdash5(dash5.textAt(dash5.currentIndex))} }
                                            onCurrentIndexChanged:{if(loadScreens == true){select5.selDash5()
                                                    Connect.setdash5(dash5.textAt(dash5.currentIndex))};if (initialized) AppSettings.setScreen3( currentIndex );
                                                 }
                                            Component.onCompleted: { currentIndex = AppSettings.getScreen3(),initialized = true; }
...
//                                                    Connect.setdash2(dash2.textAt(dash2.currentIndex))} }
                                            onCurrentIndexChanged:{if(loadScreens == true){select2.selDash2()
                                                    Connect.setdash2(dash2.textAt(dash2.currentIndex))};if (initialized) AppSettings.setScreen4( currentIndex );
                                                 }
                                            Component.onCompleted: { currentIndex = AppSettings.getScreen4(),initialized = true; }
...
//                                                    Connect.setdash3(dash3.textAt(dash3.currentIndex))} }
                                            onCurrentIndexChanged:{if(loadScreens == true){select3.selDash3()
                                                    Connect.setdash3(dash3.textAt(dash3.currentIndex))};if (initialized) AppSettings.setScreen5( currentIndex );
                                                 }
                                            Component.onCompleted: { currentIndex = AppSettings.getScreen5(),initialized = true; }
...
//                                                    Connect.setdash4(dash4.textAt(dash4.currentIndex))} }
                                            onCurrentIndexChanged:{if(loadScreens == true){select4.selDash4()
                                                    Connect.setdash4(dash4.textAt(dash4.currentIndex)); };if (initialized) AppSettings.setScreen6( currentIndex ); }
                                            Component.onCompleted: { currentIndex = AppSettings.getScreen6(),initialized = true; }
...
//                                            onCurrentIndexChanged: Connect.setfilename1(dash1file.textAt(dash1file.currentIndex))
                                            onCurrentIndexChanged:{Connect.setfilename1(dash1file.textAt(dash1file.currentIndex));if (initialized) AppSettings.setFile1( currentIndex );}
                                            Component.onCompleted: { currentIndex = AppSettings.getFile1();initialized = true; Connect.setfilename1(dash1file.textAt(dash1file.currentIndex))}
...
//                                            onCurrentIndexChanged: Connect.setfilename2(dash2file.textAt(dash2file.currentIndex))
                                            onCurrentIndexChanged:{Connect.setfilename2(dash2file.textAt(dash2file.currentIndex));if (initialized) AppSettings.setFile2( currentIndex );
                                                }
                                            Component.onCompleted: { currentIndex = AppSettings.getFile2();initialized = true; Connect.setfilename2(dash2file.textAt(dash2file.currentIndex))}
                                        }
...
//                                            onCurrentIndexChanged: Connect.setfilename3(dash3file.textAt(dash3file.currentIndex))
                                            onCurrentIndexChanged:{Connect.setfilename3(dash3file.textAt(dash3file.currentIndex));if (initialized) AppSettings.setFile3( currentIndex );}
                                            Component.onCompleted: { currentIndex = AppSettings.getFile3();initialized = true; Connect.setfilename3(dash3file.textAt(dash3file.currentIndex))}
...
//                                            onCurrentIndexChanged: Connect.setfilename5(dash5file.textAt(dash5file.currentIndex))
                                            onCurrentIndexChanged:{Connect.setfilename5(dash5file.textAt(dash5file.currentIndex));if (initialized) AppSettings.setFile5( currentIndex );}
                                            Component.onCompleted: { currentIndex = AppSettings.getFile5();initialized = true; Connect.setfilename5(dash5file.textAt(dash5file.currentIndex))}
...
//                                            onCurrentIndexChanged: Connect.setfilename4(dash4file.textAt(dash4file.currentIndex))
                                            onCurrentIndexChanged:{Connect.setfilename1(dash4file.textAt(dash4file.currentIndex));if (initialized) AppSettings.setFile4( currentIndex );}
                                            Component.onCompleted: { currentIndex = AppSettings.getFile4();initialized = true; Connect.setfilename4(dash4file.textAt(dash4file.currentIndex))}
...
//                                            onCurrentIndexChanged:{Connect.setrpm(rpm1.currentIndex,rpm2.currentIndex,rpm3.currentIndex,rpm4.currentIndex)}
                                            onCurrentIndexChanged:{Connect.setrpm(rpm1.currentIndex,rpm2.currentIndex,rpm3.currentIndex,rpm4.currentIndex);if (initialized) AppSettings.setrpm1( currentIndex );
                                                }
                                            Component.onCompleted: { currentIndex = AppSettings.getrpm1();initialized = true; }
                                        ...
                                        ComboBox {
                                            ...
                                            property bool initialized: false
//                                            onCurrentIndexChanged:{Connect.setrpm(rpm1.currentIndex,rpm2.currentIndex,rpm3.currentIndex,rpm4.currentIndex)}
                                            onCurrentIndexChanged:{Connect.setrpm(rpm1.currentIndex,rpm2.currentIndex,rpm3.currentIndex,rpm4.currentIndex);if (initialized) AppSettings.setrpm2( currentIndex );
                                                }
                                            Component.onCompleted: { currentIndex = AppSettings.getrpm2();initialized = true; }
...
//                                            Component.onCompleted: {Connect.setrpm(rpm1.currentIndex,rpm2.currentIndex,rpm3.currentIndex,rpm4.currentIndex)}
                                            onCurrentIndexChanged:{Connect.setrpm(rpm1.currentIndex,rpm2.currentIndex,rpm3.currentIndex,rpm4.currentIndex);if (initialized) AppSettings.setrpm3( currentIndex );
                                                }
                                            Component.onCompleted: { currentIndex = AppSettings.getrpm3();initialized = true; }
                                            delegate: ItemDelegate {
                                                width: rpm3.width
...
//                                            onCurrentIndexChanged:{Connect.setrpm(rpm1.currentIndex,rpm2.currentIndex,rpm3.currentIndex,rpm4.currentIndex)}
//                                            Component.onCompleted: {Connect.setrpm(rpm1.currentIndex,rpm2.currentIndex,rpm3.currentIndex,rpm4.currentIndex)}
                                            onCurrentIndexChanged:{Connect.setrpm(rpm1.currentIndex,rpm2.currentIndex,rpm3.currentIndex,rpm4.currentIndex);if (initialized) AppSettings.setrpm4( currentIndex );
                                                }
                                            Component.onCompleted: { currentIndex = AppSettings.getrpm4();initialized = true; }
                                            delegate: ItemDelegate {
                                                width: rpm4.width
...
//                                            width: 300
                                ...
                                Connections{
                                    ...
                                    onSourceIndexChanged: {
                                        ...
                                        case 0:
                                            dash1.currentIndex = Dashboard.sourceIndex
                                            return
                                        case 1:
                                            dash6.currentIndex = Dashboard.sourceIndex
                                            //                                select6.selDash6()
                                            return
                                        case 2:
                                            dash5.currentIndex = Dashboard.sourceIndex
                                            //                                select5.selDash5()
                                            return
                                        case 3:
                                            dash2.currentIndex = Dashboard.sourceIndex
                                            //                                select2.selDash2()
                                            return
                                        case 4:
                                            dash3.currentIndex = Dashboard.sourceIndex
                                            //                                select3.selDash3()
                                            return
                                        case 5:
                                            dash4.currentIndex = Dashboard.sourceIndex
                                            //                                select4.selDash4()
                                            return
                                        }
                                    }
...
//                                            if (dash1.currentIndex == "0" || dash1.currentIndex == "0" ){firstPageLoader.source = "qrc:/Gauges/Screentoggle.qml"};
//                                            if (dash1.currentIndex == "1") {firstPageLoader.source = "qrc:/Gauges/MyElement.qml"};
...
//                                            if (dash1.currentIndex == "13") {firstPageLoader.source = "qrc:/Gauges/Userdash4.qml"};
//                                            if (dash1.currentIndex == "6") {firstPageLoader.source = "qrc:/Gauges/Charts.qml"};
...
//                        l                    if (dash1.currentIndex == "99") {firstPageLoader.source = "qrc:/Gauges/Cluster.qml"};
//                                            if (dash1.currentIndex == "98") {firstPageLoader.source = "qrc:/Gauges/DashAdaptronic.qml"};
...
//                                            if (dash2.currentIndex == "11") {fourthPageLoader.source = "qrc:/Gauges/Cluster.qml"};
//                                            if (dash2.currentIndex == "1") {fourthPageLoader.source = "qrc:/Gauges/DashAdaptronic.qml"};
//                                            if (dash2.currentIndex == "2") {fourthPageLoader.source = "qrc:/Gauges/Charts.qml"};
//                                            if (dash2.currentIndex == "3") {fourthPageLoader.source = "qrc:/GPSTracks/Laptimer.qml"};
//                                            if (dash2.currentIndex == "4") {fourthPageLoader.source = "qrc:/Gauges/PFCSensors.qml"};
//                                            if (dash2.currentIndex == "5") {fourthPageLoader.source = "qrc:/Gauges/Userdash1.qml"};
//                                            if (dash2.currentIndex == "6") {fourthPageLoader.source = "qrc:/Gauges/Userdash2.qml"};
//                                            if (dash2.currentIndex == "7") {fourthPageLoader.source = "qrc:/Gauges/Userdash3.qml"};
//                                            if (dash2.currentIndex == "8") {fourthPageLoader.source = "qrc:/Gauges/ForceMeter.qml"};
//                                            if (dash2.currentIndex == "9") {fourthPageLoader.source = "qrc:/Gauges/Dyno.qml"};
//                                            if (dash2.currentIndex == "10"){fourthPageLoader.source = "qrc:/Gauges/Mediaplayer.qml"};
//                                            if (dash2.currentIndex == "0" ){
//                                                fourthPageLoader.source = "qrc:/Gauges/Screentoggle.qml"};
//                                            if (dash2.currentIndex == "12") {fourthPageLoader.source = "qrc:/Gauges/MyElement.qml"};
//                                            if (dash2.currentIndex == "13") {fourthPageLoader.source = "qrc:/Gauges/Userdash4.qml"};
                                        }
                                        Connect.setOrientation();
                                    }
...
//                                            if (dash3.currentIndex == "11") {fifthPageLoader.source = "qrc:/Gauges/Cluster.qml"};
//                                            if (dash3.currentIndex == "1") {fifthPageLoader.source = "qrc:/Gauges/DashAdaptronic.qml"};
//                                            if (dash3.currentIndex == "2") {fifthPageLoader.source = "qrc:/Gauges/Charts.qml"};
//                                            if (dash3.currentIndex == "3") {fifthPageLoader.source = "qrc:/GPSTracks/Laptimer.qml"};
//                                            if (dash3.currentIndex == "4") {fifthPageLoader.source = "qrc:/Gauges/PFCSensors.qml"};
//                                            if (dash3.currentIndex == "5") {fifthPageLoader.source = "qrc:/Gauges/Userdash1.qml"};
//                                            if (dash3.currentIndex == "6") {fifthPageLoader.source = "qrc:/Gauges/Userdash2.qml"};
//                                            if (dash3.currentIndex == "7") {fifthPageLoader.source = "qrc:/Gauges/Userdash3.qml"};
//                                            if (dash3.currentIndex == "8") {fifthPageLoader.source = "qrc:/Gauges/ForceMeter.qml"};
//                                            if (dash3.currentIndex == "9") {fifthPageLoader.source = "qrc:/Gauges/Dyno.qml"};
//                                            if (dash3.currentIndex == "10"){fifthPageLoader.source = "qrc:/Gauges/Mediaplayer.qml"};
//                                            if (dash3.currentIndex == "0" ){fifthPageLoader.source = "qrc:/Gauges/Screentoggle.qml"};
//                                            if (dash3.currentIndex == "12") {fifthPageLoader.source = "qrc:/Gauges/MyElement.qml"};
//                                            if (dash3.currentIndex == "13") {fifthPageLoader.source = "qrc:/Gauges/Userdash4.qml"};
                                        }
                                        Connect.setOrientation();
                                    }
...
//                                            if (dash4.currentIndex == "11") {sixthPageLoader.source = "qrc:/Gauges/Cluster.qml"};
//                                            if (dash4.currentIndex == "1") {sixthPageLoader.source = "qrc:/Gauges/DashAdaptronic.qml"};
//                                            if (dash4.currentIndex == "2") {sixthPageLoader.source = "qrc:/Gauges/Charts.qml"};
//                                            if (dash4.currentIndex == "3") {sixthPageLoader.source = "qrc:/GPSTracks/Laptimer.qml"};
//                                            if (dash4.currentIndex == "4") {sixthPageLoader.source = "qrc:/Gauges/PFCSensors.qml"};
//                                            if (dash4.currentIndex == "5") {sixthPageLoader.source = "qrc:/Gauges/Userdash1.qml"};
//                                            if (dash4.currentIndex == "6") {sixthPageLoader.source = "qrc:/Gauges/Userdash2.qml"};
//                                            if (dash4.currentIndex == "7") {sixthPageLoader.source = "qrc:/Gauges/Userdash3.qml"};
//                                            if (dash4.currentIndex == "8") {sixthPageLoader.source = "qrc:/Gauges/ForceMeter.qml"};
//                                            if (dash4.currentIndex == "9") {sixthPageLoader.source = "qrc:/Gauges/Dyno.qml"};
//                                            if (dash4.currentIndex == "10") {sixthPageLoader.source = "qrc:/Gauges/Mediaplayer.qml"};
//                                            if (dash4.currentIndex == "0") {sixthPageLoader.source = "qrc:/Gauges/Screentoggle.qml"};
//                                            if (dash4.currentIndex == "12") {sixthPageLoader.source = "qrc:/Gauges/MyElement.qml"};
//                                            if (dash4.currentIndex == "13") {sixthPageLoader.source = "qrc:/Gauges/Userdash4.qml"};
                                        }
                                        Connect.setOrientation();
                                    }
...
//                                            if (dash5.currentIndex == "11") {thirdPageLoader.source = "qrc:/Gauges/Cluster.qml"};
//                                            if (dash5.currentIndex == "1") {thirdPageLoader.source = "qrc:/Gauges/DashAdaptronic.qml"};
//                                            if (dash5.currentIndex == "2") {thirdPageLoader.source = "qrc:/Gauges/Charts.qml"};
//                                            if (dash5.currentIndex == "3") {thirdPageLoader.source = "qrc:/GPSTracks/Laptimer.qml"};
//                                            if (dash5.currentIndex == "4") {thirdPageLoader.source = "qrc:/Gauges/PFCSensors.qml"};
//                                            if (dash5.currentIndex == "5") {thirdPageLoader.source = "qrc:/Gauges/Userdash1.qml"};
//                                            if (dash5.currentIndex == "6") {thirdPageLoader.source = "qrc:/Gauges/Userdash2.qml"};
//                                            if (dash5.currentIndex == "7") {thirdPageLoader.source = "qrc:/Gauges/Userdash3.qml"};
//                                            if (dash5.currentIndex == "8") {thirdPageLoader.source = "qrc:/Gauges/ForceMeter.qml"};
//                                            if (dash5.currentIndex == "9") {thirdPageLoader.source = "qrc:/Gauges/Dyno.qml"};
//                                            if (dash5.currentIndex == "10") {thirdPageLoader.source = "qrc:/Gauges/Mediaplayer.qml"};
//                                            if (dash5.currentIndex == "12") {thirdPageLoader.source = "qrc:/Gauges/MyElement.qml"};
//                                            if (dash5.currentIndex == "0") {thirdPageLoader.source = "qrc:/Gauges/Screentoggle.qml"};
//                                            if (dash5.currentIndex == "13") {thirdPageLoader.source = "qrc:/Gauges/Userdash4.qml"};
                                        }
                                        Connect.setOrientation();
                                    }
...
//                                            if (dash6.currentIndex == "11") {secondPageLoader.source = "qrc:/Gauges/Cluster.qml"};
//                                            if (dash6.currentIndex == "1") {secondPageLoader.source = "qrc:/Gauges/DashAdaptronic.qml"};
//                                            if (dash6.currentIndex == "2") {secondPageLoader.source = "qrc:/Gauges/Charts.qml"};
//                                            if (dash6.currentIndex == "3") {secondPageLoader.source = "qrc:/GPSTracks/Laptimer.qml"};
//                                            if (dash6.currentIndex == "4") {secondPageLoader.source = "qrc:/Gauges/PFCSensors.qml"};
//                                            if (dash6.currentIndex == "5") {secondPageLoader.source = "qrc:/Gauges/Userdash1.qml"};
//                                            if (dash6.currentIndex == "6") {secondPageLoader.source = "qrc:/Gauges/Userdash2.qml"};
//                                            if (dash6.currentIndex == "7") {secondPageLoader.source = "qrc:/Gauges/Userdash3.qml"};
//                                            if (dash6.currentIndex == "8") {secondPageLoader.source = "qrc:/Gauges/ForceMeter.qml"};
//                                            if (dash6.currentIndex == "9") {secondPageLoader.source = "qrc:/Gauges/Dyno.qml"};
//                                            if (dash6.currentIndex == "10") {secondPageLoader.source = "qrc:/Gauges/Mediaplayer.qml"};
//                                            if (dash6.currentIndex == "12") {secondPageLoader.source = "qrc:/Gauges/MyElement.qml"};
//                                            if (dash6.currentIndex == "0") {secondPageLoader.source = "qrc:/Gauges/Screentoggle.qml"};
//                                            if (dash6.currentIndex == "13") {secondPageLoader.source = "qrc:/Gauges/Userdash4.qml"};
                                        }
                                        Connect.setOrientation();
                                    }
                                            ...
                                            TextField {
                                                ...
                                                Tab {
                                                    ...
                                                    Rectangle{
                                                        ...
                                                        Component.onCompleted: visible = false , tabView.currentIndex = 1;
