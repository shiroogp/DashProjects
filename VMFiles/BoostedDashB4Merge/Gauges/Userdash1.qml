    ...
    Connections{
        ...
        onDashsetup1Changed: {
            ...
            for (var ii=0; ii<userDash.children.length; ii++){
                console.log("Child Name - " + userDash.children[ii].objectName)//: "SquareGauge");
                console.log("Child X - " + userDash.children[ii].x)//: "SquareGauge");
                console.log("Child Y - " + userDash.children[ii].y)//: "SquareGauge");
                console.log("Child INIT X - " + userDash.children[ii].initialX)//: "SquareGauge");
                console.log("Child INIT Y - " + userDash.children[ii].initialY)//: "SquareGauge");
            }
        }
        onRpmstyle1Changed:
        {
...
//        Connect.writeDashFile("text.txt",outfileText);
    ...
    Rectangle{
        anchors.fill: parent
        z:1 //This makes the Rectangle appear in front of the bar gauges
        color: "transparent"
