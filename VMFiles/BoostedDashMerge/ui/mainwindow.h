...
public:
    ...
    explicit MainWindow(QQmlApplicationEngine *mengine, DashBoard *dashboard, QObject *parent = 0);
    ~MainWindow() override;

    QStringList getAddresses();
    QStringList getmynetwork();
    TransferTableModel* mSenderModel;
    TransferTableModel* mReceiverModel;
    DeviceListModel* mDeviceModel;
    Device mThisDevice;
    QStringList ipaddresses;
    QStringList mynetwork;
...
public Q_SLOTS:
    ...
    void onSendFilesActionTriggered(const QString &oldfileName);
