...
void Connect::readavailabledashfiles()
{
   ...
   QDir directory("/home/pi/PowerTune/exampleDash/");
...
void Connect::readMaindashsetup()
{
   // QString path = "MainDash.txt";//for Windows
    QString path = "/home/pi/PowerTune/exampleDash/MainDash.txt";
...
void Connect::readdashsetup3()
{
    ...
    QString path = "/home/pi/PowerTune/exampleDash/"+dashfilename3;
    QFile inputFile(path);
    if (inputFile.open(QIODevice::ReadOnly))
    {
        QTextStream in(&inputFile);
...
void Connect::readdashsetup2()
{
    ...
    QString path = "/home/pi/PowerTune/exampleDash/"+dashfilename2;
    QFile inputFile(path);
    if (inputFile.open(QIODevice::ReadOnly))
    {
        QTextStream in(&inputFile);
...
void Connect::readdashsetup1()
{
    ...
    QString path = "/home/pi/PowerTune/exampleDash/"+dashfilename1;
    QFile inputFile(path);
    if (inputFile.open(QIODevice::ReadOnly))
    {
        QTextStream in(&inputFile);
