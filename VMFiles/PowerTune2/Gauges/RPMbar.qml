  ...
  Item {
    ...
    Image
    {
      ...
      Item{
            ...
            width: (1051*(Dashboard.rpm)/Dashboard.maxRPM)+61 //+61 is the pixel where the RPM bar starts and from there is 651 pixels wide
    ...
    PathInterpolator {
     ...
     /* path: Path {
      ...
      progress: Dashboard.rpm / Dashboard.maxRPM //slider.value/8000 // replace this with Dashboard.rpm
            ...
            ShiftLights{ anchors.fill: parent}
            // remove slider
/*
    Slider {
          id: slider
