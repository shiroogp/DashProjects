...
class Ui_BtConnector(object):
    def setupUi(self, BtConnector):
        ...
        self.buttonClose.setGeometry(QRect(280, 360, 80, 25))
        self.groupBox = QGroupBox(BtConnector)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(10, 10, 381, 91))
        ...
        self.textEdit.setGeometry(QRect(10, 340, 201, 41))
        self.buttonUnpair = QPushButton(BtConnector)
        self.buttonUnpair.setObjectName(u"buttonUnpair")
        self.buttonUnpair.setGeometry(QRect(280, 220, 80, 25))
        self.buttonConnect = QPushButton(BtConnector)
        self.buttonConnect.setObjectName(u"buttonConnect")
        self.buttonConnect.setGeometry(QRect(280, 280, 80, 25))
    ...
    def retranslateUi(self, BtConnector):
        ...
        self.buttonConnect.setText(QCoreApplication.translate("BtConnector", u"Connnect", None))
    # retranslateUi
