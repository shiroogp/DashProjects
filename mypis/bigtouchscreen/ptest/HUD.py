...
compass_background = pygame.transform.scale(compass_background, (200*xfactor,200*yfactor))
compass_needle = pygame.image.load('compass_needle.png')
compass_needle = pygame.transform.scale(compass_needle, (150*xfactor,150*yfactor))
