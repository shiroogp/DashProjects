...
def threaded(c):
    ...
    while True:
        ...
        try:
            ...
            a_temp = iat
            print("setting RPM val to" + str(int(listdata[8]) * 10))

            rpmd = int(listdata[8])  # int(listdata[14])
            batt_v = int(listdata[9])
            volts = int(listdata[9])
            mapsensor = map_bar
            w_temp = coolant
            tps = int(listdata[10])
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_RIGHT:
                ...
                if screen_view == 4:
                    ...
                    pygame.draw.circle(
                        background, (0, 0, 200), (525, 240), 2 + (lap_dia)
                    )  # outer black circle
                    pygame.draw.circle(
                        background, (200, 200, 200), (525, 240), lap_dia
                    )  # outer black circle
                time.sleep(0.5)
            ...
            if event.type == pygame.MOUSEBUTTONUP:
                ...
                if x < 400 and y < 240:
                    ...
                    if screen_view == 4:
                        pygame.draw.rect(background, (50, 50, 50), (260, 10, 530, 460))
                        pygame.draw.rect(
                            background, (220, 220, 220), (265, 15, 520, 450)
                        )
                        pygame.draw.circle(
                            background, (0, 0, 200), (525, 240), 2 + (lap_dia)
                        )  # outer black circle
        ...
        try:
            ...
            if displ == 1:
                ...
                if laptrig == 0:
                    if (
                        Xlat < 275 + lap_dia
                        and Xlat > 275 - lap_dia
                        and Ylong < 240 + lap_dia
                        and Ylong > 240 - lap_dia
                    ):
                        disp_now = 1
                        laptrig = 1
                ...
                if (
                    ...
                    if s1_trig == 0:
                        if (
                            Xlat < s1latcen + lap_dia
                            and Xlat > s1latcen - lap_dia
                            and Ylong < s1longcen + lap_dia
                            and Ylong > s1longcen - lap_dia
                        ):
                            disp_now = 1
                            s1_trig = 1
                    ...
                    if (
                        Xlat > s1latcen + lap_dia
                        or Xlat < s1latcen - lap_dia
                        or Ylong > s1longcen + lap_dia
                        or Ylong < s1longcen - lap_dia
                    ):
                        s1_trig = 0
                    if s2_trig == 0:
                        if (
                            Xlat < s2latcen + lap_dia
                            and Xlat > s2latcen - lap_dia
                            and Ylong < s2longcen + lap_dia
                            and Ylong > s2longcen - lap_dia
                        ):
                            disp_now = 1
                            s2_trig = 1
                    ...
                    if (
                        Xlat > s2latcen + lap_dia
                        or Xlat < s2latcen - lap_dia
                        or Ylong > s2longcen + lap_dia
                        or Ylong < s2longcen - lap_dia
                    ):
                        s2_trig = 0
                ...
                if screen_view == 0:
                    ...
                    for k in range(1, 200):
                        ...
                        if (
                            ...
                            pygame.draw.rect(
                                background, grey, (X, Y - 10, 4, 45 + Y / 10)
                            )
                        if (
                            k == 10
                            or k == 30
                            ...
                            pygame.draw.rect(
                                background, grey, (X, Y - 15, 4, 45 + Y / 10)
                            )
                        if k < 5:
                            pygame.draw.rect(
                                background, cyan, (X, Y - 10, 4, 45 + Y / 10)
                            )
                        X = X + 4
                        Y = Y - (Y / 25)
                        if Y < 40:
                    ...
                    for k in range(1, int(krpm)):
                        ...
                        if k > (sl_max / 50) - 16:
                            pygame.draw.rect(
                                background, yellow, (X, Y - 10, 4, 45 + Y / 10)
                            )
                        if k > sl_max / 50:
                            pygame.draw.rect(
                                background, red, (X, Y - 10, 4, 45 + Y / 10)
                            )
                        X = X + 4
                        Y = Y - (Y / 25)
                        if Y < 40:
                    ...
                    if data_refresh == 9:
                        ...
                        font = pygame.font.Font(None, 120)
                        text = font.render(
                            str(curminute) + ":" + str("%.2f" % cursec), 2, cyan
                        )
                    if cursec < 10:
                        text = font.render(
                            str(curminute) + ":0" + str("%.2f" % cursec), 2, cyan
                        )
                        textpos.top = 380
                        textpos.left = 520
                        background.blit(text, textpos)
                    ...
                    if disp_now == 1:
                        ...
                        font = pygame.font.Font(None, 50)
                        text = font.render(
                            str(lapminute) + ":" + str("%.1f" % lapsec), 2, yellow
                        )
                        if lapsec < 10:
                            text = font.render(
                                str(lapminute) + ":0" + str("%.1f" % lapsec), 2, yellow
                            )
                        textpos = text.get_rect()
                        textpos.top = 160
                        textpos.left = 670
                        ...
                        font = pygame.font.Font(None, 50)
                        text = font.render(
                            str(bestminute) + ":" + str("%.1f" % bestsec), 2, purple
                        )
                        if bestsec < 10:
                            text = font.render(
                                str(bestminute) + ":0" + str("%.1f" % bestsec),
                                2,
                                purple,
                            )
                        textpos = text.get_rect()
                        ...
                        font = pygame.font.Font(None, 35)
                        text = font.render(
                            "Sector 2:  " + ("%.1f" % (s2_time - s1_time)), 1, grey
                        )
                        textpos.top = 350
                        textpos.left = 620
                        background.blit(text, textpos)
                ...
                if screen_view == 2:
                    ...
                    for k in range(1, 200):
                        ...
                        if (
                            ...
                            pygame.draw.rect(
                                background, grey, (X, Y - 20, 4, 55 + Y / 10)
                            )
                        if (
                            k == 10
                            or k == 30
                            ...
                            pygame.draw.rect(
                                background, grey, (X, Y - 25, 4, 55 + Y / 10)
                            )
                        if k < 5:
                            pygame.draw.rect(
                                background, cyan, (X, Y - 20, 4, 55 + Y / 10)
                            )
                        X = X + 4
                        Y = Y - (Y / 25)
                        if Y < 40:
                    ...
                    for k in range(1, int(krpm)):
                        ...
                        if k > (sl_max / 50) - 16:
                            pygame.draw.rect(
                                background, yellow, (X, Y - 20, 4, 55 + Y / 10)
                            )
                        if k > sl_max / 50:
                            pygame.draw.rect(
                                background, red, (X, Y - 20, 4, 55 + Y / 10)
                            )
                        X = X + 4
                        Y = Y - (Y / 25)
                        if Y < 40:
                    ...
                    if (
                        ...
                        if disp_now == 1:
                            ...
                            font = pygame.font.Font(None, 50)
                            text = font.render(
                                str(lapminute) + ":" + str("%.1f" % lapsec), 2, green
                            )
                            if lapsec < 10:
                                text = font.render(
                                    str(lapminute) + ":0" + str("%.1f" % lapsec),
                                    2,
                                    green,
                                )
                            textpos = text.get_rect()
                ...
                if screen_view == 3:
                    ...
                    pygame.draw.circle(
                        background, purple, (200, 200), 202
                    )  # outer black circle
                    pygame.draw.circle(
                        background, grey, (200, 200), 198
                    )  # outer black circle
                    if (
                        rpmd > (sl_max - 200)
                        or an_1 < oilpress_lim
                        or an_2 > oiltemp_lim
                    ):
                        pygame.draw.circle(
                            background, yellow, (200, 200), 178
                        )  # inner white circle
                    else:
                        pygame.draw.circle(
                            background, black, (200, 200), 178
                        )  # inner white circle
                    pygame.draw.line(
                        background, red, (200, 200), (X1, Y1), 12
                    )  # pointer
                    pygame.draw.circle(
                        background, red, (200, 200), 25
                    )  # pointer circle
                    pygame.draw.circle(
                        background, green, (200, 200), 7
                    )  # pointer circle centre
                    rpm_inds = 50
                    for rpm_drw in range(1, 100):
                        rpm_points = (
                            (rpm_inds * (270.0 / 10000)) - 90 + (270 * sl_max / 10000)
                        )
                    ...
                    pygame.draw.circle(
                        background, purple, (500, 100), 99
                    )  # outer black circle
                    pygame.draw.circle(
                        background, grey, (500, 100), 97
                    )  # inner white circle
                    if w_temp > watertemp_lim:
                        pygame.draw.circle(
                            background, yellow, (500, 100), 85
                        )  # inner white circle
                    else:
                        pygame.draw.circle(
                            background, black, (500, 100), 85
                        )  # inner white circle
                    pygame.draw.line(
                        background, red, (498, 100), (X1, Y1), 4
                    )  # pointer
                    pygame.draw.circle(background, red, (500, 100), 7)  # pointer circle
                    pygame.draw.circle(
                        background, green, (500, 100), 3
                    )  # pointer circle centre
                    wt_inds = 1
                    ...
                    pygame.draw.circle(
                        background, purple, (700, 100), 99
                    )  # outer black circle
                    pygame.draw.circle(
                        background, grey, (700, 100), 97
                    )  # inner white circle
                    if mapsensor > boost_lim:
                        pygame.draw.circle(
                            background, yellow, (700, 100), 85
                        )  # inner white circle
                    else:
                        pygame.draw.circle(
                            background, black, (700, 100), 85
                        )  # inner white circle
                    pygame.draw.line(
                        background, red, (698, 100), (X1, Y1), 4
                    )  # pointer
                    pygame.draw.circle(background, red, (700, 100), 7)  # pointer circle
                    pygame.draw.circle(
                        background, green, (700, 100), 3
                    )  # pointer circle centre
                    bst_inds = 1
                ...
                if screen_view == 4:
                    ...
                    Ylong = int((y_long - longcen) * 24000)
                    pygame.draw.circle(
                        background, (255, 0, 255), (Xlat + 250, Ylong), 2
                    )
                    pygame.draw.line(
                        background, (0, 0, 0), (X + 250, Y), (Xlat + 250, Ylong), 2
                    )
                    X = Xlat
                    Y = Ylong
                    ...
                    font = pygame.font.Font(None, 30)
                    text = font.render(
                        "S1 Trig: " + str(s1_trig) + " - " + str("%.3f" % s1_time),
                        1,
                        black,
                    )
                    textpos.top = 385
                    ...
                    font = pygame.font.Font(None, 30)
                    text = font.render(
                        "S2 Trig: " + str(s2_trig) + " - " + str("%.3f" % s2_time),
                        1,
                        black,
                    )
                    textpos.top = 410
                    ...
                    font = pygame.font.Font(None, 40)
                    text = font.render(
                        "Lap " + str(laps_done) + ":  " + str("%.3f" % laptime) + "s",
                        1,
                        black,
                    )
                    textpos.top = 440
                ...
                if screen_view == 5:
                    ...
                    pygame.draw.circle(
                        background, black, (400, 220), 210
                    )  # outer black circle
                    pygame.draw.circle(
                        background, silver, (400, 220), 208
                    )  # outer black circle
                    pygame.draw.circle(
                        background, black, (400, 220), 198
                    )  # outer black circle
                    pygame.draw.circle(
                        background, blue, (400, 220), 178
                    )  # inner white circle
                    pygame.draw.line(
                        background, red, (400, 220), (X1, Y1), 12
                    )  # pointer
                    pygame.draw.circle(
                        background, red, (400, 220), 25
                    )  # pointer circle
                    pygame.draw.circle(
                        background, black, (400, 220), 7
                    )  # pointer circle centre
                    rpm_inds = 50
                    for rpm_drw in range(1, 100):
                        rpm_points = (rpm_inds * (270.0 / 10000)) + 90
                    ...
                    font = pygame.font.Font(None, 30)
                    text = font.render(
                        str("%.1f" % data_rate) + " Hz " + str(screen_view), 2, black
                    )
                    textpos.top = 450
                    textpos.left = 20
                    background.blit(text, textpos)
                ...
                if 1 == log_en:
                    ...
                    if gps_sel == 1:
                        ...
                        if p > 250:
                            while gps_scan == 0:
                                ...
                                if "GPRMC" == chgps:
                                    if gps_refresh == 10:
                                        gps_refresh = 0
                                        gps_rate = 10 / (
                                            float(time.time()) - float(gps_time)
                                        )
                                        gps_time = time.time()
                            ...
                            lattitude = (
                                str(latbit1) + str(latbit2) + "." + str("%.0f" % latcor)
                            )
                            if testlat < 6:
                                lattitude = (
                                    str(latbit1)
                            ...
                            if 1 == gpslock:
                                try:
                                    if (
                                        os.path.exists("/media/Transcend/track.dat")
                                        and track_sel < 100
                                    ):
                                        ...
                                        while track_found == 0 and track_no < 999:
                                            ...
                                            if (
                                                x_lat + 0.012 > lap_lat
                                                and x_lat - 0.012 < lap_lat
                                                and y_long + 0.012 > lap_long
                                                and y_long - 0.012 < lap_long
                                            ):
                                                track_found = 1
                                                track_no = 1000
                                                ...
                                                s1longcen = int(
                                                    (s1_long - longcen) * 24000
                                                )
                                                s2latcen = int(
                                                    (s2_lat - latcen) * 27500
                                                )
                                                s2longcen = int(
                                                    (s2_long - longcen) * 24000
                                                )
                                        file.close()
                                    else:
                                        if (
                                            os.path.exists("/home/pi/track.dat")
                                            and track_sel < 100
                                        ):
