...
def readACCx():
  acc_l = 32768 #bus.read_byte_data(ACC_ADDRESS, OUT_X_L_A)
  acc_h = 0 #bus.read_byte_data(ACC_ADDRESS, OUT_X_H_A)
  acc_combined = (acc_l | acc_h <<8)
  return acc_combined  if acc_combined < 32768 else acc_combined - 65536

def readACCy():
  acc_l = 32768 #bus.read_byte_data(ACC_ADDRESS, OUT_Y_L_A)
  acc_h = 0 #bus.read_byte_data(ACC_ADDRESS, OUT_Y_H_A)
  acc_combined = (acc_l | acc_h <<8)
  return acc_combined  if acc_combined < 32768 else acc_combined - 65536

def readACCz():
  acc_l = 32768 #bus.read_byte_data(ACC_ADDRESS, OUT_Z_L_A)
  acc_h = 0 #bus.read_byte_data(ACC_ADDRESS, OUT_Z_H_A)
  acc_combined = (acc_l | acc_h <<8)
  return acc_combined  if acc_combined < 32768 else acc_combined - 65536

def readMAGx():
  mag_l = 32768 #bus.read_byte_data(MAG_ADDRESS, OUT_X_L_M)
  mag_h = 0 #bus.read_byte_data(MAG_ADDRESS, OUT_X_H_M)
  mag_combined = (mag_l | mag_h <<8)
  return mag_combined  if mag_combined < 32768 else mag_combined - 65536

def readMAGy():
  mag_l = 32768 #bus.read_byte_data(MAG_ADDRESS, OUT_Y_L_M)
  mag_h = 0 #bus.read_byte_data(MAG_ADDRESS, OUT_Y_H_M)
  mag_combined = (mag_l | mag_h <<8)
  return mag_combined  if mag_combined < 32768 else mag_combined - 65536

def readMAGz():
  mag_l = 32768 #bus.read_byte_data(MAG_ADDRESS, OUT_Z_L_M)
  mag_h = 0 #bus.read_byte_data(MAG_ADDRESS, OUT_Z_H_M)
  mag_combined = (mag_l | mag_h <<8)
  return mag_combined  if mag_combined < 32768 else mag_combined - 65536

def readGYRx():
  gyr_l = 32768 #bus.read_byte_data(GYR_ADDRESS, OUT_X_L_G)
  gyr_h = 0 #bus.read_byte_data(GYR_ADDRESS, OUT_X_H_G)
  gyr_combined = (gyr_l | gyr_h <<8)
  return gyr_combined  if gyr_combined < 32768 else gyr_combined - 65536
  
def readGYRy():
  gyr_l = 32768 #bus.read_byte_data(GYR_ADDRESS, OUT_Y_L_G)
  gyr_h = 0 #bus.read_byte_data(GYR_ADDRESS, OUT_Y_H_G)
  gyr_combined = (gyr_l | gyr_h <<8)
  return gyr_combined  if gyr_combined < 32768 else gyr_combined - 65536

def readGYRz():
  gyr_l = 32768 #bus.read_byte_data(GYR_ADDRESS, OUT_Z_L_G)
  gyr_h = 0 #bus.read_byte_data(GYR_ADDRESS, OUT_Z_H_G)
  gyr_combined = (gyr_l | gyr_h <<8)
  return gyr_combined  if gyr_combined < 32768 else gyr_combined - 65536
