...
def message_handling(client, userdata, msg):
    ...
    try:
        ...
        #         clear = True
        #         countdown -= 1
        #         pygame.draw.rect(screen, BLACK, [CENTER_X - (150*scalex), 180*scaley, 300*scalex, 150*scaley])# rect change, border_radius=10)
        ...
        print("Error: "+str(e))
        print(e.with_traceback)   # print(f"{msg.topic}: {msg.payload.decode()}")
