        ...
        for (int i = 0; i < size; i++) {
            ...
            if ("Basic".equalsIgnoreCase(challenge.scheme())) {
                ...
                if (passwordAuthentication != null) {
                    return request.newBuilder().header(z ? "Proxy-Authorization" : FileRequest.FIELD_AUTHORIZATION, Credentials.basic(passwordAuthentication.getUserName(), new String(passwordAuthentication.getPassword()), challenge.charset())).build();
                }
            }
        }
        return null;
