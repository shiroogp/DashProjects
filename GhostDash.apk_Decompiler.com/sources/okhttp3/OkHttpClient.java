...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public Builder callTimeout(long j, TimeUnit timeUnit) {
            this.callTimeout = Util.checkDuration(FetchErrorStrings.CONNECTION_TIMEOUT, j, timeUnit);
            return this;
        }

        public Builder callTimeout(Duration duration) {
            this.callTimeout = Util.checkDuration(FetchErrorStrings.CONNECTION_TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }

        public Builder connectTimeout(long j, TimeUnit timeUnit) {
            this.connectTimeout = Util.checkDuration(FetchErrorStrings.CONNECTION_TIMEOUT, j, timeUnit);
            return this;
        }

        public Builder connectTimeout(Duration duration) {
            this.connectTimeout = Util.checkDuration(FetchErrorStrings.CONNECTION_TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }

        public Builder readTimeout(long j, TimeUnit timeUnit) {
            this.readTimeout = Util.checkDuration(FetchErrorStrings.CONNECTION_TIMEOUT, j, timeUnit);
            return this;
        }

        public Builder readTimeout(Duration duration) {
            this.readTimeout = Util.checkDuration(FetchErrorStrings.CONNECTION_TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }

        public Builder writeTimeout(long j, TimeUnit timeUnit) {
            this.writeTimeout = Util.checkDuration(FetchErrorStrings.CONNECTION_TIMEOUT, j, timeUnit);
            return this;
        }

        public Builder writeTimeout(Duration duration) {
            this.writeTimeout = Util.checkDuration(FetchErrorStrings.CONNECTION_TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }
        ...
        public Builder pingInterval(Duration duration) {
            this.pingInterval = Util.checkDuration(FetchErrorStrings.CONNECTION_TIMEOUT, duration.toMillis(), TimeUnit.MILLISECONDS);
            return this;
        }
