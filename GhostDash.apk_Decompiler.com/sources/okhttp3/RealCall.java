...
final class RealCall implements Call {
    ...
    final class AsyncCall extends NamedRunnable {
        ...
        /* access modifiers changed from: protected */
        /* JADX WARNING: Removed duplicated region for block: B:14:0x0032 A[Catch:{ IOException -> 0x0052, all -> 0x0027, all -> 0x0094 }] */
        /* JADX WARNING: Removed duplicated region for block: B:20:0x005e A[Catch:{ IOException -> 0x0052, all -> 0x0027, all -> 0x0094 }] */
        /* JADX WARNING: Removed duplicated region for block: B:21:0x0080 A[Catch:{ IOException -> 0x0052, all -> 0x0027, all -> 0x0094 }] */
        ...
        public void execute() {
            /*
                ...
                r0.enter()
                r0 = 0
                okhttp3.RealCall r1 = okhttp3.RealCall.this     // Catch:{ IOException -> 0x0052, all -> 0x0027 }
                okhttp3.Response r0 = r1.getResponseWithInterceptorChain()     // Catch:{ IOException -> 0x0052, all -> 0x0027 }
                r1 = 1
                okhttp3.Callback r2 = r6.responseCallback     // Catch:{ IOException -> 0x0025, all -> 0x0023 }
                okhttp3.RealCall r3 = okhttp3.RealCall.this     // Catch:{ IOException -> 0x0025, all -> 0x0023 }
            ...
            L_0x0027:
                ...
                r0 = r5
            L_0x002b:
                okhttp3.RealCall r2 = okhttp3.RealCall.this     // Catch:{ all -> 0x0094 }
                r2.cancel()     // Catch:{ all -> 0x0094 }
                ...
                java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ all -> 0x0094 }
                java.lang.StringBuilder r2 = r2.append(r0)     // Catch:{ all -> 0x0094 }
                java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x0094 }
                r1.<init>(r2)     // Catch:{ all -> 0x0094 }
                okhttp3.Callback r2 = r6.responseCallback     // Catch:{ all -> 0x0094 }
                okhttp3.RealCall r3 = okhttp3.RealCall.this     // Catch:{ all -> 0x0094 }
                r2.onFailure(r3, r1)     // Catch:{ all -> 0x0094 }
            L_0x0051:
            ...
            L_0x0056:
                okhttp3.RealCall r2 = okhttp3.RealCall.this     // Catch:{ all -> 0x0094 }
                java.io.IOException r0 = r2.timeoutExit(r0)     // Catch:{ all -> 0x0094 }
                if (r1 == 0) goto L_0x0080
                okhttp3.internal.platform.Platform r1 = okhttp3.internal.platform.Platform.get()     // Catch:{ all -> 0x0094 }
                r2 = 4
                ...
                okhttp3.RealCall r4 = okhttp3.RealCall.this     // Catch:{ all -> 0x0094 }
                java.lang.String r4 = r4.toLoggableString()     // Catch:{ all -> 0x0094 }
                java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x0094 }
                java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0094 }
                r1.log(r2, r3, r0)     // Catch:{ all -> 0x0094 }
                goto L_0x0016
            L_0x0080:
                okhttp3.RealCall r1 = okhttp3.RealCall.this     // Catch:{ all -> 0x0094 }
                okhttp3.EventListener r1 = r1.eventListener     // Catch:{ all -> 0x0094 }
                okhttp3.RealCall r2 = okhttp3.RealCall.this     // Catch:{ all -> 0x0094 }
                r1.callFailed(r2, r0)     // Catch:{ all -> 0x0094 }
                okhttp3.Callback r1 = r6.responseCallback     // Catch:{ all -> 0x0094 }
                okhttp3.RealCall r2 = okhttp3.RealCall.this     // Catch:{ all -> 0x0094 }
                r1.onFailure(r2, r0)     // Catch:{ all -> 0x0094 }
                goto L_0x0016
            L_0x0093:
                return
            L_0x0094:
