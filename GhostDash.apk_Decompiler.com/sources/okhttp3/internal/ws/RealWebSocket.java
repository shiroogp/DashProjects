...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        if (FetchCoreUtils.GET_REQUEST_METHOD.equals(request.method())) {
    ...
    public void writePingFrame() {
        /*
            r7 = this;
            monitor-enter(r7)
            boolean r0 = r7.failed     // Catch:{ all -> 0x0058 }
            if (r0 == 0) goto L_0x0007
            monitor-exit(r7)     // Catch:{ all -> 0x0058 }
            return
        L_0x0007:
            okhttp3.internal.ws.WebSocketWriter r0 = r7.writer     // Catch:{ all -> 0x0058 }
            boolean r1 = r7.awaitingPong     // Catch:{ all -> 0x0058 }
            r2 = -1
            if (r1 == 0) goto L_0x0011
            int r1 = r7.sentPingCount     // Catch:{ all -> 0x0058 }
            goto L_0x0012
        L_0x0011:
            r1 = r2
        L_0x0012:
            int r3 = r7.sentPingCount     // Catch:{ all -> 0x0058 }
            r4 = 1
            int r3 = r3 + r4
            r7.sentPingCount = r3     // Catch:{ all -> 0x0058 }
            r7.awaitingPong = r4     // Catch:{ all -> 0x0058 }
            monitor-exit(r7)     // Catch:{ all -> 0x0058 }
            r3 = 0
