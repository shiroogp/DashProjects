...
public final class Http2Codec implements HttpCodec {
    ...
    private static final List<String> HTTP_2_SKIPPED_REQUEST_HEADERS = Util.immutableList((T[]) new String[]{"connection", HOST, KEEP_ALIVE, PROXY_CONNECTION, TE, "transfer-encoding", ENCODING, UPGRADE, Header.TARGET_METHOD_UTF8, Header.TARGET_PATH_UTF8, Header.TARGET_SCHEME_UTF8, Header.TARGET_AUTHORITY_UTF8});
    private static final List<String> HTTP_2_SKIPPED_RESPONSE_HEADERS = Util.immutableList((T[]) new String[]{"connection", HOST, KEEP_ALIVE, PROXY_CONNECTION, TE, "transfer-encoding", ENCODING, UPGRADE});
