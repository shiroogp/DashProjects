    ...
    private Request followUpRequest(Response response, Route route) throws IOException {
        ...
        if (response != null) {
            ...
            if (code == 307 || code == 308) {
                if (!method.equals(FetchCoreUtils.GET_REQUEST_METHOD) && !method.equals(FetchCoreUtils.HEAD_REQUEST_METHOD)) {
                    return null;
                }
            } else if (code == 401) {
            ...
            if (HttpMethod.permitsRequestBody(method)) {
                ...
                if (HttpMethod.redirectsToGet(method)) {
                    newBuilder.method(FetchCoreUtils.GET_REQUEST_METHOD, (RequestBody) null);
                } else {
