...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private void readJournal() throws java.io.IOException {
        /*
            ...
            boolean r7 = r7.equals(r2)     // Catch:{ all -> 0x00b1 }
            if (r7 == 0) goto L_0x007a
            java.lang.String r7 = "1"
            boolean r7 = r7.equals(r3)     // Catch:{ all -> 0x00b1 }
            if (r7 == 0) goto L_0x007a
            int r7 = r9.appVersion     // Catch:{ all -> 0x00b1 }
            java.lang.String r7 = java.lang.Integer.toString(r7)     // Catch:{ all -> 0x00b1 }
            boolean r4 = r7.equals(r4)     // Catch:{ all -> 0x00b1 }
            if (r4 == 0) goto L_0x007a
            int r4 = r9.valueCount     // Catch:{ all -> 0x00b1 }
            java.lang.String r4 = java.lang.Integer.toString(r4)     // Catch:{ all -> 0x00b1 }
            boolean r4 = r4.equals(r5)     // Catch:{ all -> 0x00b1 }
            if (r4 == 0) goto L_0x007a
            java.lang.String r4 = ""
            boolean r4 = r4.equals(r6)     // Catch:{ all -> 0x00b1 }
            if (r4 == 0) goto L_0x007a
            r0 = 0
        L_0x0053:
            ...
            goto L_0x0053
        L_0x005d:
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r2 = r9.lruEntries     // Catch:{ all -> 0x00b1 }
            int r2 = r2.size()     // Catch:{ all -> 0x00b1 }
            int r0 = r0 - r2
            r9.redundantOpCount = r0     // Catch:{ all -> 0x00b1 }
            boolean r0 = r1.exhausted()     // Catch:{ all -> 0x00b1 }
            if (r0 != 0) goto L_0x0070
            r9.rebuildJournal()     // Catch:{ all -> 0x00b1 }
            goto L_0x0076
        L_0x0070:
        ...
        L_0x007a:
            ...
            java.lang.StringBuilder r7 = r7.append(r8)     // Catch:{ all -> 0x00b1 }
            java.lang.StringBuilder r2 = r7.append(r2)     // Catch:{ all -> 0x00b1 }
            java.lang.StringBuilder r2 = r2.append(r0)     // Catch:{ all -> 0x00b1 }
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ all -> 0x00b1 }
            java.lang.StringBuilder r2 = r2.append(r0)     // Catch:{ all -> 0x00b1 }
            java.lang.StringBuilder r2 = r2.append(r5)     // Catch:{ all -> 0x00b1 }
            java.lang.StringBuilder r0 = r2.append(r0)     // Catch:{ all -> 0x00b1 }
            java.lang.StringBuilder r0 = r0.append(r6)     // Catch:{ all -> 0x00b1 }
            java.lang.String r2 = "]"
