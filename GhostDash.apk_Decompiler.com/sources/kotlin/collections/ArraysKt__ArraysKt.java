...
class ArraysKt__ArraysKt extends ArraysKt__ArraysJVMKt {
                                                ...
                                                if (!(t instanceof boolean[]) || !(t2 instanceof boolean[])) {
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            ...
                                                            } else if (!UArraysKt.m586contentEqualsKJPZfPQ(((UIntArray) t).m188unboximpl(), ((UIntArray) t2).m188unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m585contentEqualsFGO6Aew(((UShortArray) t).m370unboximpl(), ((UShortArray) t2).m370unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m588contentEqualskV0jMPg(((UByteArray) t).m110unboximpl(), ((UByteArray) t2).m110unboximpl())) {
                                                        return false;
                                                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] r5, java.lang.StringBuilder r6, java.util.List<java.lang.Object[]> r7) {
        ...
        L_0x00c5:
            ...
            byte[] r4 = r2.m110unboximpl()
        L_0x00d2:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m602contentToString2csIQuQ(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x00da:
            ...
            short[] r4 = r2.m370unboximpl()
        L_0x00e6:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m606contentToStringd6D3K8(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x00ee:
            ...
            int[] r4 = r2.m188unboximpl()
        L_0x00fa:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m605contentToStringXUkPCBk(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x0102:
            ...
            long[] r4 = r2.m266unboximpl()
        L_0x010e:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m608contentToStringuLth9ew(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x0116:
