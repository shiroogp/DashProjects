...
public final class UStringsKt {
    ...
    public static final String m1320toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1322toStringolVBNx4(short s, int i) {
    ...
    public static final String m1321toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1319toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m93unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m353unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m171unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m171unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m120constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m38boximpl(UByte.m44constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m171unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m120constructorimpl(65535)) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r5 = UInt.m120constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m373uintDivideJ1ME1BU(-1, r5);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int r3 = UInt.m120constructorimpl(i2 * r5);
            int r8 = UInt.m120constructorimpl(UInt.m120constructorimpl(digitOf) + r3);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r9 = ULong.m198constructorimpl((long) i2);
        long j2 = 0;
        ...
        while (i3 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m375ulongDivideeb3DHEI(j, r9);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long r11 = ULong.m198constructorimpl(j2 * r9);
            long r4 = ULong.m198constructorimpl(ULong.m198constructorimpl(((long) UInt.m120constructorimpl(digitOf)) & BodyPartID.bodyIdMax) + r11);
