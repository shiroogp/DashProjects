...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public static final long m257getsVKNKU(long[] jArr, int i) {
        return ULong.m198constructorimpl(jArr[i]);
    }
    ...
    private static final class Iterator implements java.util.Iterator<ULong>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ Object next() {
            return ULong.m192boximpl(m267nextsVKNKU());
        }
    ...
    public static boolean m254containsAllimpl(long[] jArr, Collection<ULong> collection) {
        boolean z;
        Intrinsics.checkNotNullParameter(collection, "elements");
        Iterable iterable = collection;
        if (!((Collection) iterable).isEmpty()) {
            for (Object next : iterable) {
                if (!(next instanceof ULong) || !ArraysKt.contains(jArr, ((ULong) next).m249unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
