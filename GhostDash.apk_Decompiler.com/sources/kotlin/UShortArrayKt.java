...
public final class UShortArrayKt {
    ...
    private static final short[] m372ushortArrayOfrL5Bavg(short... sArr) {
    ...
    private static final short[] UShortArray(int i, Function1<? super Integer, UShort> function1) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            sArr[i2] = function1.invoke(Integer.valueOf(i2)).m353unboximpl();
        }
        return UShortArray.m356constructorimpl(sArr);
    }
}
