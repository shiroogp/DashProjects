...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m1331minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1475minusLRDsOJo(this, j);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m1330getAdjustmentUwyO8pc() {
    ...
    public long m1329elapsedNowUwyO8pc() {
        return Duration.m1372minusLRDsOJo(this.mark.m1472elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1332plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1373plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
