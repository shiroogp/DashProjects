...
public interface TimeMark {
    ...
    TimeMark m1473minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    TimeMark m1474plusLRDsOJo(long j);

    @Metadata(k = 3, mv = {1, 7, 1}, xi = 48)
    /* compiled from: TimeSource.kt */
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1476plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1475minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.m1474plusLRDsOJo(Duration.m1389unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1370isNegativeimpl(timeMark.m1472elapsedNowUwyO8pc());
        }
