                ...
                try {
                    if (algorithm.on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
                        ...
                        if (instance3.isDefaultPrf()) {
                            secretKey = createSecretKeyFactory.generateSecret(new PBEKeySpec(cArr, instance3.getSalt(), instance3.getIterationCount().intValue(), JcePKCSPBEInputDecryptorProviderBuilder.this.keySizeProvider.getKeySize(instance4)));
                        } else {
                            secretKey = createSecretKeyFactory.generateSecret(new PBKDF2KeySpec(cArr, instance3.getSalt(), instance3.getIterationCount().intValue(), JcePKCSPBEInputDecryptorProviderBuilder.this.keySizeProvider.getKeySize(instance4), instance3.getPrf()));
                        }
                        ...
                        if (parameters instanceof ASN1OctetString) {
                            ...
                            this.cipher.init(2, secretKey, new GOST28147ParameterSpec(instance5.getEncryptionParamSet(), instance5.getIV()));
                        }
                    }
