...
public class PKIXNameConstraintValidator {
    ...
    public String toString() {
        ...
        if (this.permittedSubtreesDN != null) {
            str = (str + "DN:\n") + this.permittedSubtreesDN.toString() + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        }
        if (this.permittedSubtreesDNS != null) {
            str = (str + "DNS:\n") + this.permittedSubtreesDNS.toString() + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        }
        if (this.permittedSubtreesEmail != null) {
            str = (str + "Email:\n") + this.permittedSubtreesEmail.toString() + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        }
        if (this.permittedSubtreesURI != null) {
            str = (str + "URI:\n") + this.permittedSubtreesURI.toString() + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        }
        if (this.permittedSubtreesIP != null) {
            str = (str + "IP:\n") + stringifyIPCollection(this.permittedSubtreesIP) + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        }
        String str2 = str + "excluded:\n";
        if (!this.excludedSubtreesDN.isEmpty()) {
            str2 = (str2 + "DN:\n") + this.excludedSubtreesDN.toString() + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        }
        if (!this.excludedSubtreesDNS.isEmpty()) {
            str2 = (str2 + "DNS:\n") + this.excludedSubtreesDNS.toString() + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        }
        if (!this.excludedSubtreesEmail.isEmpty()) {
            str2 = (str2 + "Email:\n") + this.excludedSubtreesEmail.toString() + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        }
        if (!this.excludedSubtreesURI.isEmpty()) {
            str2 = (str2 + "URI:\n") + this.excludedSubtreesURI.toString() + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
        }
        if (this.excludedSubtreesIP.isEmpty()) {
            return str2;
        }
        return (str2 + "IP:\n") + stringifyIPCollection(this.excludedSubtreesIP) + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE;
    }
}
