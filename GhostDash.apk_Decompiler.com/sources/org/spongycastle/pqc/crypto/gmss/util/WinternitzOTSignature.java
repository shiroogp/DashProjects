...
public class WinternitzOTSignature {
    ...
    public byte[] getSignature(byte[] bArr) {
        ...
        if (8 % i4 == 0) {
            ...
            long j2 = 0;
            while (i33 < i32) {
                j2 ^= (long) ((bArr5[i23] & UByte.MAX_VALUE) << (i33 << 3));
                i23++;
                i33++;
                i32 = i32;
            }
            ...
            while (i48 <= i45) {
                ...
                for (int i53 = i48 >>> 3; i53 < i51; i53++) {
                    j3 ^= (long) ((bArr5[i53] & UByte.MAX_VALUE) << (i52 << 3));
                    i52++;
                }
            ...
            if (i55 < this.mdsize) {
                ...
                while (true) {
                    ...
                    j5 ^= (long) ((bArr5[i55] & UByte.MAX_VALUE) << (i57 << 3));
                    i57++;
                    i55++;
                }
            ...
            int i59 = (this.messagesize << this.w) - i47;
            int i60 = i49;
            int i61 = 0;
