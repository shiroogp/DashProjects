...
class Horst {
    ...
    static int horst_verify(HashFunctions hashFunctions, byte[] bArr, byte[] bArr2, int i, byte[] bArr3, byte[] bArr4) {
        ...
        for (int i18 = 0; i18 < 32; i18++) {
            hashFunctions.hash_2n_n_mask(bArr6, i18 * 32, bArr2, i3 + (i18 * 2 * 32), bArr3, OlympusMakernoteDirectory.TAG_PREVIEW_IMAGE);
        }
        ...
        for (int i21 = 0; i21 < 4; i21++) {
            hashFunctions.hash_2n_n_mask(bArr6, i21 * 32, bArr6, i21 * 2 * 32, bArr3, LeicaMakernoteDirectory.TAG_IMAGE_ID_NUMBER);
        }
