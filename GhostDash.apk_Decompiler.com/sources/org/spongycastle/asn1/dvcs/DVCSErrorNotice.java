...
public class DVCSErrorNotice extends ASN1Object {
    ...
    public String toString() {
        return "DVCSErrorNotice {\ntransactionStatus: " + this.transactionStatus + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + (this.transactionIdentifier != null ? "transactionIdentifier: " + this.transactionIdentifier + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE : "") + "}\n";
    }
