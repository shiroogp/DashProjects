...
public class DVCSRequest extends ASN1Object {
    ...
    public String toString() {
        return "DVCSRequest {\nrequestInformation: " + this.requestInformation + "\ndata: " + this.data + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + (this.transactionIdentifier != null ? "transactionIdentifier: " + this.transactionIdentifier + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE : "") + "}\n";
    }
