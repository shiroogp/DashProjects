...
public class SecP521R1Point extends ECPoint.AbstractFp {
    ...
    public org.spongycastle.math.ec.ECPoint add(org.spongycastle.math.ec.ECPoint r17) {
        ...
        L_0x0019:
            ...
            org.spongycastle.math.ec.ECFieldElement r2 = r0.x
            ...
            org.spongycastle.math.ec.ECFieldElement r4 = r0.y
            ...
            org.spongycastle.math.ec.ECFieldElement[] r7 = r0.zs
            r8 = 0
            r7 = r7[r8]
        ...
        L_0x005b:
            int[] r15 = r7.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.square(r15, r12)
            int[] r5 = r5.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.multiply(r12, r5, r11)
            int[] r5 = r7.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.multiply(r12, r5, r12)
            int[] r5 = r6.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.multiply(r12, r5, r12)
            r5 = r11
            r6 = r12
        ...
        L_0x007c:
            int[] r8 = r1.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.square(r8, r13)
            int[] r2 = r2.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.multiply(r13, r2, r10)
            int[] r2 = r1.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.multiply(r13, r2, r13)
            int[] r2 = r4.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.multiply(r13, r2, r13)
            r2 = r10
            r4 = r13
        L_0x0092:
            ...
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.subtract(r2, r5, r8)
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.subtract(r4, r6, r11)
        ...
        L_0x00ad:
            ...
            return r1
        L_0x00b2:
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.square(r8, r12)
            int[] r5 = org.spongycastle.math.raw.Nat.create(r9)
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.multiply(r12, r8, r5)
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.multiply(r12, r2, r12)
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.multiply(r4, r5, r10)
            ...
            r4.<init>((int[]) r13)
            int[] r2 = r4.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.square(r11, r2)
            int[] r2 = r4.x
            int[] r6 = r4.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.add(r2, r5, r6)
            int[] r2 = r4.x
            int[] r6 = r4.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.subtract(r2, r12, r6)
            int[] r2 = r4.x
            int[] r6 = r4.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.subtract(r2, r12, r6)
            ...
            int[] r2 = r4.x
            int[] r5 = r6.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.subtract(r12, r2, r5)
            int[] r2 = r6.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.multiply(r2, r11, r11)
            int[] r2 = r6.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.subtract(r11, r10, r2)
            ...
            int[] r7 = r7.x
            int[] r8 = r2.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.multiply(r5, r7, r8)
        L_0x0107:
            if (r15 != 0) goto L_0x0112
            int[] r5 = r2.x
            int[] r1 = r1.x
            int[] r7 = r2.x
            org.spongycastle.math.ec.custom.sec.SecP521R1Field.multiply(r5, r1, r7)
        L_0x0112:
            r1 = 1
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.math.ec.custom.sec.SecP521R1Point.add(org.spongycastle.math.ec.ECPoint):org.spongycastle.math.ec.ECPoint");
    }
