...
public class SecT193R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        return new SecT193R2Point(curve, square, eCFieldElement4.squarePlusProduct(add, eCFieldElement).add(square).add(eCFieldElement3), eCFieldElementArr, this.withCompression);
    }
