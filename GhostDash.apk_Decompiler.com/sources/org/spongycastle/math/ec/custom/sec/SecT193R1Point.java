...
public class SecT193R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        return new SecT193R1Point(curve, square, eCFieldElement4.squarePlusProduct(add, eCFieldElement).add(square).add(eCFieldElement3), eCFieldElementArr, this.withCompression);
    }
