...
public class SecP384R1Point extends ECPoint.AbstractFp {
    ...
    public org.spongycastle.math.ec.ECPoint add(org.spongycastle.math.ec.ECPoint r17) {
        ...
        L_0x005d:
            int[] r15 = r7.x
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.square(r15, r12)
            int[] r5 = r5.x
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.multiply(r12, r5, r9)
            int[] r5 = r7.x
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.multiply(r12, r5, r12)
            int[] r5 = r6.x
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.multiply(r12, r5, r12)
            r5 = r9
            r6 = r12
        ...
        L_0x007e:
            int[] r8 = r1.x
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.square(r8, r13)
            int[] r2 = r2.x
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.multiply(r13, r2, r10)
            int[] r2 = r1.x
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.multiply(r13, r2, r13)
            int[] r2 = r4.x
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.multiply(r13, r2, r13)
            r2 = r10
            r4 = r13
        L_0x0094:
            ...
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.subtract(r2, r5, r8)
            int[] r5 = org.spongycastle.math.raw.Nat.create(r11)
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.subtract(r4, r6, r5)
        ...
        L_0x00b3:
            ...
            return r1
        L_0x00b8:
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.square(r8, r12)
            int[] r6 = org.spongycastle.math.raw.Nat.create(r11)
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.multiply(r12, r8, r6)
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.multiply(r12, r2, r12)
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.negate(r6, r6)
            org.spongycastle.math.raw.Nat384.mul(r4, r6, r10)
            int r2 = org.spongycastle.math.raw.Nat.addBothTo(r11, r12, r12, r6)
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.reduce32(r2, r6)
            ...
            r4.<init>((int[]) r13)
            int[] r2 = r4.x
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.square(r5, r2)
            int[] r2 = r4.x
            int[] r11 = r4.x
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.subtract(r2, r6, r11)
            ...
            int[] r2 = r4.x
            int[] r6 = r11.x
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.subtract(r12, r2, r6)
            int[] r2 = r11.x
            org.spongycastle.math.raw.Nat384.mul(r2, r5, r9)
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.addExt(r10, r9, r10)
            int[] r2 = r11.x
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.reduce(r10, r2)
            ...
            int[] r6 = r7.x
            int[] r7 = r2.x
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.multiply(r5, r6, r7)
        L_0x010c:
            if (r15 != 0) goto L_0x0117
            int[] r5 = r2.x
            int[] r1 = r1.x
            int[] r6 = r2.x
            org.spongycastle.math.ec.custom.sec.SecP384R1Field.multiply(r5, r1, r6)
        L_0x0117:
            r1 = 1
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.math.ec.custom.sec.SecP384R1Point.add(org.spongycastle.math.ec.ECPoint):org.spongycastle.math.ec.ECPoint");
    }
