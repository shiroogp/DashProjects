...
public class IssuerKeyID extends SignatureSubpacket {
    ...
    public long getKeyID() {
        return (((long) (this.data[0] & UByte.MAX_VALUE)) << 56) | (((long) (this.data[1] & UByte.MAX_VALUE)) << 48) | (((long) (this.data[2] & UByte.MAX_VALUE)) << 40) | (((long) (this.data[3] & UByte.MAX_VALUE)) << 32) | (((long) (this.data[4] & UByte.MAX_VALUE)) << 24) | ((long) ((this.data[5] & UByte.MAX_VALUE) << Tnaf.POW_2_WIDTH)) | ((long) ((this.data[6] & UByte.MAX_VALUE) << 8)) | ((long) (this.data[7] & UByte.MAX_VALUE));
    }
}
