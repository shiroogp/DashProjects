...
public class DefaultCMSSignatureAlgorithmNameGenerator implements CMSSignatureAlgorithmNameGenerator {
    ...
    public DefaultCMSSignatureAlgorithmNameGenerator() {
        ...
        addEntries(OIWObjectIdentifiers.md4WithRSA, "MD4", RSA.ALGORITHM);
        addEntries(OIWObjectIdentifiers.md4WithRSAEncryption, "MD4", RSA.ALGORITHM);
        addEntries(OIWObjectIdentifiers.md5WithRSA, "MD5", RSA.ALGORITHM);
        addEntries(OIWObjectIdentifiers.sha1WithRSA, "SHA1", RSA.ALGORITHM);
        addEntries(PKCSObjectIdentifiers.md2WithRSAEncryption, "MD2", RSA.ALGORITHM);
        addEntries(PKCSObjectIdentifiers.md4WithRSAEncryption, "MD4", RSA.ALGORITHM);
        addEntries(PKCSObjectIdentifiers.md5WithRSAEncryption, "MD5", RSA.ALGORITHM);
        addEntries(PKCSObjectIdentifiers.sha1WithRSAEncryption, "SHA1", RSA.ALGORITHM);
        addEntries(PKCSObjectIdentifiers.sha224WithRSAEncryption, "SHA224", RSA.ALGORITHM);
        addEntries(PKCSObjectIdentifiers.sha256WithRSAEncryption, McElieceCCA2ParameterSpec.DEFAULT_MD, RSA.ALGORITHM);
        addEntries(PKCSObjectIdentifiers.sha384WithRSAEncryption, "SHA384", RSA.ALGORITHM);
        addEntries(PKCSObjectIdentifiers.sha512WithRSAEncryption, "SHA512", RSA.ALGORITHM);
        addEntries(TeleTrusTObjectIdentifiers.rsaSignatureWithripemd128, "RIPEMD128", RSA.ALGORITHM);
        addEntries(TeleTrusTObjectIdentifiers.rsaSignatureWithripemd160, "RIPEMD160", RSA.ALGORITHM);
        addEntries(TeleTrusTObjectIdentifiers.rsaSignatureWithripemd256, "RIPEMD256", RSA.ALGORITHM);
        ...
        addEntries(EACObjectIdentifiers.id_TA_RSA_v1_5_SHA_1, "SHA1", RSA.ALGORITHM);
        addEntries(EACObjectIdentifiers.id_TA_RSA_v1_5_SHA_256, McElieceCCA2ParameterSpec.DEFAULT_MD, RSA.ALGORITHM);
        ...
        hashMap.put(PKCSObjectIdentifiers.rsaEncryption, RSA.ALGORITHM);
        hashMap.put(TeleTrusTObjectIdentifiers.teleTrusTRSAsignatureAlgorithm, RSA.ALGORITHM);
        hashMap.put(X509ObjectIdentifiers.id_ea_rsa, RSA.ALGORITHM);
