...
public class EnvelopedDataHelper {
    ...
    public byte[] calculateDerivedKey(int i, char[] cArr, AlgorithmIdentifier algorithmIdentifier, int i2) throws CMSException {
        ...
        if (i == 0) {
            ...
            secretKeyFactory = this.helper.createSecretKeyFactory("PBKDF2");
        }
        return secretKeyFactory.generateSecret(new PBEKeySpec(cArr, instance.getSalt(), instance.getIterationCount().intValue(), i2)).getEncoded();
    }
}
