...
public class RSA {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("Alg.Alias.Cipher.RSA//RAW", com.pedrouid.crypto.RSA.ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.Cipher.RSA//NOPADDING", com.pedrouid.crypto.RSA.ALGORITHM);
            ...
            registerOid(configurableProvider, PKCSObjectIdentifiers.rsaEncryption, com.pedrouid.crypto.RSA.ALGORITHM, keyFactorySpi);
            registerOid(configurableProvider, X509ObjectIdentifiers.id_ea_rsa, com.pedrouid.crypto.RSA.ALGORITHM, keyFactorySpi);
            registerOid(configurableProvider, PKCSObjectIdentifiers.id_RSAES_OAEP, com.pedrouid.crypto.RSA.ALGORITHM, keyFactorySpi);
            registerOid(configurableProvider, PKCSObjectIdentifiers.id_RSASSA_PSS, com.pedrouid.crypto.RSA.ALGORITHM, keyFactorySpi);
            registerOidAlgorithmParameters(configurableProvider, PKCSObjectIdentifiers.rsaEncryption, com.pedrouid.crypto.RSA.ALGORITHM);
            registerOidAlgorithmParameters(configurableProvider, X509ObjectIdentifiers.id_ea_rsa, com.pedrouid.crypto.RSA.ALGORITHM);
            ...
            configurableProvider.addAlgorithm("Alg.Alias.Signature.RAWRSA", com.pedrouid.crypto.RSA.ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.Signature.NONEWITHRSA", com.pedrouid.crypto.RSA.ALGORITHM);
            ...
            addDigestSignature(configurableProvider, "SHA512(224)", "org.spongycastle.jcajce.provider.asymmetric.rsa.DigestSignatureSpi$SHA512_224", (ASN1ObjectIdentifier) null);
            addDigestSignature(configurableProvider, "SHA512(256)", "org.spongycastle.jcajce.provider.asymmetric.rsa.DigestSignatureSpi$SHA512_256", (ASN1ObjectIdentifier) null);
        ...
        private void addDigestSignature(ConfigurableProvider configurableProvider, String str, String str2, ASN1ObjectIdentifier aSN1ObjectIdentifier) {
            ...
            String str6 = str + "/" + com.pedrouid.crypto.RSA.ALGORITHM;
