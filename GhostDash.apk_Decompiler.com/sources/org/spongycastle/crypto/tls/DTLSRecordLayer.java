...
class DTLSRecordLayer implements DatagramTransport {
    ...
    public int receive(byte[] r19, int r20, int r21, int r22) throws java.io.IOException {
        ...
        L_0x0016:
            byte[] r2 = new byte[r3]
        L_0x0018:
            org.spongycastle.crypto.tls.DTLSHandshakeRetransmit r6 = r1.retransmit     // Catch:{ IOException -> 0x0138 }
        ...
        L_0x003b:
            r6 = 11
            int r6 = org.spongycastle.crypto.tls.TlsUtils.readUint16(r2, r6)     // Catch:{ IOException -> 0x0138 }
            int r6 = r6 + r5
            if (r3 == r6) goto L_0x0045
            goto L_0x0036
        L_0x0045:
            short r5 = org.spongycastle.crypto.tls.TlsUtils.readUint8(r2, r13)     // Catch:{ IOException -> 0x0138 }
            switch(r5) {
        ...
        L_0x004d:
            r6 = 3
            int r15 = org.spongycastle.crypto.tls.TlsUtils.readUint16(r2, r6)     // Catch:{ IOException -> 0x0138 }
            org.spongycastle.crypto.tls.DTLSEpoch r6 = r1.readEpoch     // Catch:{ IOException -> 0x0138 }
        ...
        L_0x005f:
            ...
            org.spongycastle.crypto.tls.DTLSEpoch r6 = r1.retransmitEpoch     // Catch:{ IOException -> 0x0138 }
        ...
        L_0x0075:
            r6 = 5
            long r11 = org.spongycastle.crypto.tls.TlsUtils.readUint48(r2, r6)     // Catch:{ IOException -> 0x0138 }
            org.spongycastle.crypto.tls.DTLSReplayWindow r6 = r16.getReplayWindow()     // Catch:{ IOException -> 0x0138 }
            boolean r6 = r6.shouldDiscard(r11)     // Catch:{ IOException -> 0x0138 }
            if (r6 == 0) goto L_0x0085
            goto L_0x0036
        L_0x0085:
            r10 = 1
            org.spongycastle.crypto.tls.ProtocolVersion r9 = org.spongycastle.crypto.tls.TlsUtils.readVersion(r2, r10)     // Catch:{ IOException -> 0x0138 }
            boolean r6 = r9.isDTLS()     // Catch:{ IOException -> 0x0138 }
            if (r6 != 0) goto L_0x0091
            goto L_0x0036
        L_0x0091:
            org.spongycastle.crypto.tls.ProtocolVersion r6 = r1.readVersion     // Catch:{ IOException -> 0x0138 }
            if (r6 == 0) goto L_0x009e
            org.spongycastle.crypto.tls.ProtocolVersion r6 = r1.readVersion     // Catch:{ IOException -> 0x0138 }
            boolean r6 = r6.equals((org.spongycastle.crypto.tls.ProtocolVersion) r9)     // Catch:{ IOException -> 0x0138 }
            if (r6 != 0) goto L_0x009e
            goto L_0x0036
        L_0x009e:
            org.spongycastle.crypto.tls.TlsCipher r6 = r16.getCipher()     // Catch:{ IOException -> 0x0138 }
        ...
        L_0x00db:
            boolean r0 = r1.inHandshake     // Catch:{ IOException -> 0x0138 }
            if (r0 != 0) goto L_0x0120
            org.spongycastle.crypto.tls.DTLSHandshakeRetransmit r0 = r1.retransmit     // Catch:{ IOException -> 0x0138 }
        ...
        L_0x00e9:
            ...
            org.spongycastle.crypto.tls.TlsPeer r6 = r1.peer     // Catch:{ IOException -> 0x0138 }
        ...
        L_0x0102:
            ...
            org.spongycastle.crypto.tls.TlsFatalAlert r0 = new org.spongycastle.crypto.tls.TlsFatalAlert     // Catch:{ IOException -> 0x0138 }
        ...
        L_0x010d:
            ...
            short r0 = org.spongycastle.crypto.tls.TlsUtils.readUint8(r3, r13)     // Catch:{ IOException -> 0x0138 }
            if (r0 == r6) goto L_0x0117
            goto L_0x011d
        L_0x0117:
            org.spongycastle.crypto.tls.DTLSEpoch r0 = r1.pendingEpoch     // Catch:{ IOException -> 0x0138 }
