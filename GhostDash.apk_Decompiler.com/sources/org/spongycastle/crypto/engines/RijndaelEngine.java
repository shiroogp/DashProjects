...
public class RijndaelEngine implements BlockCipher {
    ...
    private void MixColumn() {
        ...
        for (int i = 0; i < this.BC; i += 8) {
            ...
            j4 |= ((long) ((((mul0x2(i3) ^ mul0x3(i4)) ^ i5) ^ i2) & UByte.MAX_VALUE)) << i;
            j2 |= ((long) ((((mul0x2(i4) ^ mul0x3(i5)) ^ i2) ^ i3) & UByte.MAX_VALUE)) << i;
            j3 = (((long) ((((mul0x2(i5) ^ mul0x3(i2)) ^ i3) ^ i4) & UByte.MAX_VALUE)) << i) | j5;
        }
        this.A0 = j;
        this.A1 = j4;
        this.A2 = j2;
    ...
    private void InvMixColumn() {
        ...
        for (int i = 0; i < this.BC; i += 8) {
            ...
            j4 |= ((long) ((((mul0xe(b3) ^ mul0xb(b4)) ^ mul0xd(b)) ^ mul0x9(b2)) & UByte.MAX_VALUE)) << i;
            j2 |= ((long) ((((mul0xe(b4) ^ mul0xb(b)) ^ mul0xd(b2)) ^ mul0x9(b3)) & UByte.MAX_VALUE)) << i;
            j3 = (((long) ((((mul0xe(b) ^ mul0xb(b2)) ^ mul0xd(b3)) ^ mul0x9(b4)) & UByte.MAX_VALUE)) << i) | j5;
        }
        this.A0 = j;
        this.A1 = j4;
        this.A2 = j2;
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        while (i8 < i && i9 < (this.ROUNDS + 1) * (this.BC / 8)) {
            ...
            while (i10 < i4) {
                ...
                jArr2[i10] = (((long) (bArr3[i10][i8] & UByte.MAX_VALUE)) << ((i9 * 8) % i11)) | jArr2[i10];
                i10++;
                i4 = 4;
            }
            i8++;
        ...
        while (i9 < (this.ROUNDS + 1) * (this.BC / i3)) {
            ...
            while (i13 < 4) {
                ...
                i13++;
                bArr4[i5] = (byte) (bArr4[i5] ^ S[bArr3[i13 % 4][i - 1] & UByte.MAX_VALUE]);
            }
            byte[] bArr5 = bArr3[i5];
            int i14 = i12 + 1;
            ...
            if (i <= 6) {
                ...
                for (int i19 = i5; i19 < 4; i19++) {
                    ...
                    bArr8[4] = (byte) (bArr8[4] ^ S[bArr3[i19][3] & UByte.MAX_VALUE]);
                }
                int i20 = 5;
                while (i20 < i) {
                    int i21 = i5;
            ...
            while (i22 < i && i9 < (this.ROUNDS + 1) * (this.BC / i3)) {
                for (int i23 = i5; i23 < 4; i23++) {
                    ...
                    jArr3[i23] = (((long) (bArr3[i23][i22] & UByte.MAX_VALUE)) << ((i9 * 8) % i24)) | jArr3[i23];
                }
                i22++;
                i9++;
                i5 = 0;
