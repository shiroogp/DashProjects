...
public class ISO9796d2Signer implements SignerWithRecovery {
    ...
    public void updateWithRecoveredMessage(byte[] bArr) throws InvalidCipherTextException {
        ...
        if (((processBlock[0] & 192) ^ RevocationKeyTags.CLASS_SENSITIVE) != 0) {
            ...
            if (length > 0) {
                if ((processBlock[0] & RevocationReasonTags.USER_NO_LONGER_VALID) == 0) {
    ...
    public byte[] generateSignature() throws CryptoException {
        ...
        if ((b & RevocationReasonTags.USER_NO_LONGER_VALID) != 0) {
            z = false;
        }
        this.fullMessage = z;
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        if (((bArr2[0] & 192) ^ RevocationKeyTags.CLASS_SENSITIVE) != 0) {
        ...
        if ((bArr2[0] & RevocationReasonTags.USER_NO_LONGER_VALID) == 0) {
            this.fullMessage = true;
