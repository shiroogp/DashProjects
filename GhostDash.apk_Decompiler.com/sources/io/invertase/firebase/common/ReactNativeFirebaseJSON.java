...
public class ReactNativeFirebaseJSON {
    ...
    public String getRawJSON() {
        return "{\"android_task_executor_maximum_pool_size\":10,\"android_task_executor_keep_alive_seconds\":3,\"crashlytics_debug_enabled\":true}";
    }

    private ReactNativeFirebaseJSON() {
        try {
            this.jsonObject = new JSONObject("{\"android_task_executor_maximum_pool_size\":10,\"android_task_executor_keep_alive_seconds\":3,\"crashlytics_debug_enabled\":true}");
