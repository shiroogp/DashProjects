...
public class UniversalFirebaseAnalyticsModule extends UniversalFirebaseModule {
    ...
    public Task<Void> setDefaultEventParameters(Bundle bundle) {
        return Tasks.call(new Callable(bundle) {
            ...
            public final Object call() {
                return UniversalFirebaseAnalyticsModule.this.lambda$setDefaultEventParameters$7$UniversalFirebaseAnalyticsModule(this.f$1);
            }
        });
    }

    public /* synthetic */ Void lambda$setDefaultEventParameters$7$UniversalFirebaseAnalyticsModule(Bundle bundle) throws Exception {
