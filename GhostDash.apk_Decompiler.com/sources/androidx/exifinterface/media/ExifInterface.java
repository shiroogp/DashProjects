...
public class ExifInterface {
    ...
    private static class Rational {
        ...
        Rational(double d) {
            this((long) (d * 10000.0d), FetchDefaults.DEFAULT_NOTIFICATION_TIMEOUT_AFTER);
        }
    ...
    public void setAttribute(java.lang.String r18, java.lang.String r19) {
        ...
        L_0x00c5:
            ...
            goto L_0x012f
        L_0x0104:
            double r8 = java.lang.Double.parseDouble(r2)     // Catch:{ NumberFormatException -> 0x0112 }
            androidx.exifinterface.media.ExifInterface$Rational r10 = new androidx.exifinterface.media.ExifInterface$Rational     // Catch:{ NumberFormatException -> 0x0112 }
            r10.<init>(r8)     // Catch:{ NumberFormatException -> 0x0112 }
            java.lang.String r2 = r10.toString()     // Catch:{ NumberFormatException -> 0x0112 }
            goto L_0x012f
        L_0x0112:
            java.lang.StringBuilder r3 = new java.lang.StringBuilder
            r3.<init>()
    ...
    /* JADX WARNING: Removed duplicated region for block: B:68:0x00dd A[Catch:{ Exception -> 0x010b, all -> 0x0109 }] */
    /* JADX WARNING: Removed duplicated region for block: B:71:0x00f0 A[Catch:{ Exception -> 0x010b, all -> 0x0109 }] */
    /* JADX WARNING: Removed duplicated region for block: B:95:0x0144  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void saveAttributes() throws java.io.IOException {
        ...
        L_0x0017:
            ...
            java.io.File r2 = java.io.File.createTempFile(r2, r3)     // Catch:{ Exception -> 0x0157, all -> 0x0154 }
            java.lang.String r3 = r14.mFilename     // Catch:{ Exception -> 0x0157, all -> 0x0154 }
            r4 = 0
            r6 = 21
            if (r3 == 0) goto L_0x003b
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0157, all -> 0x0154 }
            java.lang.String r7 = r14.mFilename     // Catch:{ Exception -> 0x0157, all -> 0x0154 }
            r3.<init>(r7)     // Catch:{ Exception -> 0x0157, all -> 0x0154 }
            goto L_0x004f
        L_0x003b:
            int r3 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x0157, all -> 0x0154 }
            if (r3 < r6) goto L_0x004e
            java.io.FileDescriptor r3 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0157, all -> 0x0154 }
            int r7 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x0157, all -> 0x0154 }
            android.system.Os.lseek(r3, r4, r7)     // Catch:{ Exception -> 0x0157, all -> 0x0154 }
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0157, all -> 0x0154 }
            java.io.FileDescriptor r7 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0157, all -> 0x0154 }
            r3.<init>(r7)     // Catch:{ Exception -> 0x0157, all -> 0x0154 }
            goto L_0x004f
        L_0x004e:
            r3 = r1
        L_0x004f:
            java.io.FileOutputStream r7 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x0150, all -> 0x014c }
            r7.<init>(r2)     // Catch:{ Exception -> 0x0150, all -> 0x014c }
            copy(r3, r7)     // Catch:{ Exception -> 0x014a, all -> 0x0148 }
            closeQuietly(r3)
            closeQuietly(r7)
            r3 = 0
        ...
        L_0x00d2:
            ...
            r8 = r10
        L_0x00d4:
            java.io.FileInputStream r11 = new java.io.FileInputStream     // Catch:{ Exception -> 0x010f, all -> 0x010d }
            r11.<init>(r2)     // Catch:{ Exception -> 0x010f, all -> 0x010d }
            java.lang.String r1 = r14.mFilename     // Catch:{ Exception -> 0x010b, all -> 0x0109 }
            if (r1 != 0) goto L_0x00f0
            int r1 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x010b, all -> 0x0109 }
            if (r1 < r6) goto L_0x00f8
            java.io.FileDescriptor r1 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x010b, all -> 0x0109 }
            int r6 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x010b, all -> 0x0109 }
            android.system.Os.lseek(r1, r4, r6)     // Catch:{ Exception -> 0x010b, all -> 0x0109 }
            java.io.FileOutputStream r1 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x010b, all -> 0x0109 }
            java.io.FileDescriptor r4 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x010b, all -> 0x0109 }
            r1.<init>(r4)     // Catch:{ Exception -> 0x010b, all -> 0x0109 }
            goto L_0x00f7
        L_0x00f0:
            java.io.FileOutputStream r1 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x010b, all -> 0x0109 }
            java.lang.String r4 = r14.mFilename     // Catch:{ Exception -> 0x010b, all -> 0x0109 }
            r1.<init>(r4)     // Catch:{ Exception -> 0x010b, all -> 0x0109 }
        L_0x00f7:
            r8 = r1
        L_0x00f8:
            copy(r11, r8)     // Catch:{ Exception -> 0x010b, all -> 0x0109 }
            closeQuietly(r11)     // Catch:{ all -> 0x013a }
            closeQuietly(r8)     // Catch:{ all -> 0x013a }
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x013a }
            java.lang.String r1 = "Failed to save new file"
            r0.<init>(r1, r7)     // Catch:{ all -> 0x013a }
        ...
        L_0x010f:
            ...
            r1 = r3
        L_0x0112:
            java.io.IOException r3 = new java.io.IOException     // Catch:{ all -> 0x012f }
            ...
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x012f }
            java.lang.String r5 = r2.getAbsolutePath()     // Catch:{ all -> 0x012f }
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ all -> 0x012f }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x012f }
            r3.<init>(r4, r1)     // Catch:{ all -> 0x012f }
        ...
        L_0x0132:
            r1 = r11
        L_0x0133:
            closeQuietly(r1)     // Catch:{ all -> 0x013a }
            closeQuietly(r8)     // Catch:{ all -> 0x013a }
            throw r0     // Catch:{ all -> 0x013a }
        L_0x013a:
            r0 = move-exception
        ...
        L_0x0157:
            ...
            r7 = r1
        L_0x0159:
            java.io.IOException r2 = new java.io.IOException     // Catch:{ all -> 0x0161 }
            java.lang.String r3 = "Failed to copy original file to temp file"
            r2.<init>(r3, r0)     // Catch:{ all -> 0x0161 }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:103:0x02e1  */
