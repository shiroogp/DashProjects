...
public class VideoSampleDescriptionAtom extends SampleDescriptionAtom<VideoSampleDescription> {
    ...
    public void addMetadata(QuickTimeVideoDirectory quickTimeVideoDirectory) {
        ...
        quickTimeVideoDirectory2.setDouble(6, ((double) ((videoSampleDescription.horizontalResolution & -65536) >> 16)) + (((double) (videoSampleDescription.horizontalResolution & 65535)) / Math.pow(2.0d, 4.0d)));
        quickTimeVideoDirectory2.setDouble(7, ((double) ((videoSampleDescription.verticalResolution & -65536) >> 16)) + (((double) (videoSampleDescription.verticalResolution & 65535)) / Math.pow(2.0d, 4.0d)));
    }
