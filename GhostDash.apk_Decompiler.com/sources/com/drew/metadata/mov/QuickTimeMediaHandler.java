...
public abstract class QuickTimeMediaHandler<T extends QuickTimeDirectory> extends QuickTimeHandler<T> {
    ...
    /* access modifiers changed from: protected */
    public abstract void processMediaInformation(SequentialReader sequentialReader, Atom atom) throws IOException;

    /* access modifiers changed from: protected */
    public abstract void processSampleDescription(SequentialReader sequentialReader, Atom atom) throws IOException;

    /* access modifiers changed from: protected */
    public abstract void processTimeToSample(SequentialReader sequentialReader, Atom atom) throws IOException;
