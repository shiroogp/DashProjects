            ...
            if (str.equals(AviDirectory.CHUNK_STREAM_HEADER)) {
                ...
                if (str2.equals("vids")) {
                    if (!this._directory.containsTag(1)) {
                        ...
                        this._directory.setString(3, String.format("%1$02d:%2$02d:%3$02d", new Object[]{valueOf, valueOf2, Integer.valueOf((int) Math.round((d / Math.pow(60.0d, 0.0d)) - ((double) (valueOf2.intValue() * 60))))}));
