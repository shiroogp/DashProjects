...
public abstract class Mp4MediaHandler<T extends Mp4MediaDirectory> extends Mp4Handler<T> {
    ...
    /* access modifiers changed from: protected */
    public abstract void processMediaInformation(SequentialReader sequentialReader, Box box) throws IOException;

    /* access modifiers changed from: protected */
    public abstract void processSampleDescription(SequentialReader sequentialReader, Box box) throws IOException;

    /* access modifiers changed from: protected */
    public abstract void processTimeToSample(SequentialReader sequentialReader, Box box) throws IOException;
