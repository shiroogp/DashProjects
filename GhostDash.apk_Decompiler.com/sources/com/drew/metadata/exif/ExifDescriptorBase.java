...
public abstract class ExifDescriptorBase<T extends Directory> extends TagDescriptor<T> {
    ...
    public String getReferenceBlackWhiteDescription() {
        ...
        int i2 = intArray[0];
        int i3 = intArray[1];
        return String.format("[%d,%d,%d] [%d,%d,%d]", new Object[]{Integer.valueOf(i2), Integer.valueOf(intArray[2]), Integer.valueOf(intArray[4]), Integer.valueOf(i3), Integer.valueOf(intArray[3]), Integer.valueOf(intArray[5])});
    }
    ...
    public String getCompressedAverageBitsPerPixelDescription() {
        ...
        if (!rational.isInteger() || rational.intValue() != 1) {
            sb = new StringBuilder().append(simpleString);
            str = " bits/pixel";
        } else {
            sb = new StringBuilder().append(simpleString);
            str = " bit/pixel";
    ...
    public String getJpegProcDescription() {
        ...
        int intValue = integer.intValue();
        if (intValue != 1) {
            return intValue != 14 ? "Unknown (" + integer + ")" : "Lossless";
        }
        return "Baseline";
    }
}
