...
public class PanasonicMakernoteDescriptor extends TagDescriptor<PanasonicMakernoteDirectory> {
    ...
    private String getTransformDescription(int i) {
        ...
        try {
            ...
            return (uInt16 == 3 && uInt162 == 2) ? "Stretch High" : "Unknown (" + uInt16 + " " + uInt162 + ")";
    ...
    public String getRotationDescription() {
        ...
        if (intValue != 6) {
            return intValue != 8 ? "Unknown (" + integer + ")" : "Rotate 270 CW";
        }
        return "Rotate 90 CW";
    }
    ...
    private String buildFacesDescription(Face[] faceArr) {
        ...
        while (i < faceArr.length) {
            int i2 = i + 1;
            sb.append("Face ").append(i2).append(": ").append(faceArr[i].toString()).append(ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
            i = i2;
        }
        if (sb.length() > 0) {
    ...
    public String getAfAreaModeDescription() {
        ...
        if (i == 0) {
            int i2 = intArray[1];
            if (i2 != 1) {
                return i2 != 16 ? "Unknown (" + intArray[0] + " " + intArray[1] + ")" : "Spot Mode Off";
            }
            return "Spot Mode On";
        } else if (i == 1) {
            int i3 = intArray[1];
            if (i3 != 0) {
                return i3 != 1 ? "Unknown (" + intArray[0] + " " + intArray[1] + ")" : "5-area";
            }
            return "Spot Focusing";
        } else if (i == 16) {
            int i4 = intArray[1];
            if (i4 != 0) {
                return i4 != 16 ? "Unknown (" + intArray[0] + " " + intArray[1] + ")" : "1-area (high speed)";
            }
            return "1-area";
        } else if (i != 32) {
            return i != 64 ? "Unknown (" + intArray[0] + " " + intArray[1] + ")" : "Face Detect";
        } else {
            int i5 = intArray[1];
            if (i5 == 0) {
            ...
            if (i5 != 2) {
                return i5 != 3 ? "Unknown (" + intArray[0] + " " + intArray[1] + ")" : "3-area (right)";
            }
