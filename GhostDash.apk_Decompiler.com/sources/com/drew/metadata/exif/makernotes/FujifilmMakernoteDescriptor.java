...
public class FujifilmMakernoteDescriptor extends TagDescriptor<FujifilmMakernoteDirectory> {
    ...
    public String getSharpnessDescription() {
        ...
        if (intValue != 32768) {
            return intValue != 65535 ? "Unknown (" + integer + ")" : "N/A";
        }
    ...
    public String getToneDescription() {
        ...
        if (intValue != 768) {
            return intValue != 32768 ? "Unknown (" + integer + ")" : "Film Simulation";
        }
        return "None (B&W)";
    }
    ...
    public String getContrastDescription() {
        ...
        if (intValue != 256) {
            return intValue != 768 ? "Unknown (" + integer + ")" : "Low";
        }
        return "High";
    }
    ...
    public String getNoiseReductionDescription() {
        ...
        if (intValue != 128) {
            return intValue != 256 ? "Unknown (" + integer + ")" : "N/A";
        }
        return "Normal";
    }
    ...
    public String getHighIsoNoiseReductionDescription() {
        ...
        if (intValue != 256) {
            return intValue != 512 ? "Unknown (" + integer + ")" : "Weak";
        }
        return "Strong";
    }
    ...
    public String getExrModeDescription() {
        ...
        if (intValue != 512) {
            return intValue != 768 ? "Unknown (" + integer + ")" : "DR (Dynamic Range Priority)";
        }
    ...
    public String getFinePixColorDescription() {
        ...
        if (intValue != 16) {
            return intValue != 48 ? "Unknown (" + integer + ")" : "B&W";
        }
        return "Chrome";
    }
    ...
    public String getFilmModeDescription() {
        ...
        if (intValue != 1280) {
            return intValue != 1281 ? "Unknown (" + integer + ")" : "Pro Neg. Hi";
        }
        return "Pro Neg. Std";
    }
    ...
    public String getDynamicRangeSettingDescription() {
        ...
        if (intValue != 512) {
            return intValue != 513 ? "Unknown (" + integer + ")" : "Wide 2 (400%)";
        }
        return "Wide 1 (230%)";
    }
}
