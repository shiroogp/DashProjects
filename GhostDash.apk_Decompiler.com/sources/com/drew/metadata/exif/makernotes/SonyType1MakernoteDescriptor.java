...
public class SonyType1MakernoteDescriptor extends TagDescriptor<SonyType1MakernoteDirectory> {
    ...
    public String getTeleconverterDescription() {
        ...
        if (intValue != 144) {
            return intValue != 160 ? "Unknown (" + integer + ")" : "Minolta AF 1.4x APO";
        }
    ...
    public String getWhiteBalanceDescription() {
        ...
        if (intValue != 96) {
            return intValue != 112 ? "Unknown (" + integer + ")" : "Custom";
        }
        return "Fluorescent";
    }
    ...
    public String getAFModeDescription() {
        ...
        if (intValue != 14) {
            return intValue != 15 ? "Unknown (" + integer + ")" : "Face Detected";
        }
        return "Manual Focus";
    }
    ...
    public String getReleaseModeDescription() {
        ...
        if (intValue != 5) {
            return intValue != 6 ? "Unknown (" + integer + ")" : "White Balance Bracketing";
        }
