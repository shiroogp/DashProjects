...
public class ProcessAllImagesInFolderUtility {
    ...
    static class TextFileOutputHandler extends FileHandlerBase {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:77:0x0134 A[Catch:{ all -> 0x0149 }] */
        /* JADX WARNING: Removed duplicated region for block: B:97:0x0139 A[SYNTHETIC] */
        ...
        public void onExtractionSuccess(java.io.File r17, com.drew.metadata.Metadata r18, java.lang.String r19, java.io.PrintStream r20) {
            /*
                ...
                java.io.PrintWriter r2 = openWriter(r17)     // Catch:{ all -> 0x014c }
                boolean r0 = r18.hasErrors()     // Catch:{ all -> 0x0149 }
                r3 = 2
                r4 = 3
                r5 = 1
                java.lang.String r6 = "\n"
                ...
                java.lang.Iterable r0 = r18.getDirectories()     // Catch:{ all -> 0x0149 }
                java.util.Iterator r0 = r0.iterator()     // Catch:{ all -> 0x0149 }
            L_0x001b:
                boolean r8 = r0.hasNext()     // Catch:{ all -> 0x0149 }
                if (r8 == 0) goto L_0x0054
                java.lang.Object r8 = r0.next()     // Catch:{ all -> 0x0149 }
                com.drew.metadata.Directory r8 = (com.drew.metadata.Directory) r8     // Catch:{ all -> 0x0149 }
                boolean r9 = r8.hasErrors()     // Catch:{ all -> 0x0149 }
                if (r9 != 0) goto L_0x002e
                goto L_0x001b
            L_0x002e:
                java.lang.Iterable r9 = r8.getErrors()     // Catch:{ all -> 0x0149 }
                java.util.Iterator r9 = r9.iterator()     // Catch:{ all -> 0x0149 }
            L_0x0036:
                boolean r10 = r9.hasNext()     // Catch:{ all -> 0x0149 }
                if (r10 == 0) goto L_0x001b
                java.lang.Object r10 = r9.next()     // Catch:{ all -> 0x0149 }
                java.lang.String r10 = (java.lang.String) r10     // Catch:{ all -> 0x0149 }
                java.lang.String r11 = "[ERROR: %s] %s%s"
                java.lang.Object[] r12 = new java.lang.Object[r4]     // Catch:{ all -> 0x0149 }
                java.lang.String r13 = r8.getName()     // Catch:{ all -> 0x0149 }
                r12[r7] = r13     // Catch:{ all -> 0x0149 }
                r12[r5] = r10     // Catch:{ all -> 0x0149 }
                r12[r3] = r6     // Catch:{ all -> 0x0149 }
                r2.format(r11, r12)     // Catch:{ all -> 0x0149 }
                goto L_0x0036
            L_0x0054:
                r2.write(r6)     // Catch:{ all -> 0x0149 }
            L_0x0057:
                java.lang.Iterable r0 = r18.getDirectories()     // Catch:{ all -> 0x0149 }
                java.util.Iterator r8 = r0.iterator()     // Catch:{ all -> 0x0149 }
            L_0x005f:
                boolean r0 = r8.hasNext()     // Catch:{ all -> 0x0149 }
                if (r0 == 0) goto L_0x013c
                java.lang.Object r0 = r8.next()     // Catch:{ all -> 0x0149 }
                com.drew.metadata.Directory r0 = (com.drew.metadata.Directory) r0     // Catch:{ all -> 0x0149 }
                java.lang.String r9 = r0.getName()     // Catch:{ all -> 0x0149 }
                java.util.Collection r10 = r0.getTags()     // Catch:{ all -> 0x0149 }
                java.util.Iterator r10 = r10.iterator()     // Catch:{ all -> 0x0149 }
            L_0x0077:
                boolean r11 = r10.hasNext()     // Catch:{ all -> 0x0149 }
                r12 = 4
                java.lang.String r13 = ""
                if (r11 == 0) goto L_0x00b5
                java.lang.Object r11 = r10.next()     // Catch:{ all -> 0x0149 }
                com.drew.metadata.Tag r11 = (com.drew.metadata.Tag) r11     // Catch:{ all -> 0x0149 }
                java.lang.String r14 = r11.getTagName()     // Catch:{ all -> 0x0149 }
                java.lang.String r15 = r11.getDescription()     // Catch:{ all -> 0x0149 }
                if (r15 != 0) goto L_0x0091
                goto L_0x0092
            L_0x0091:
                r13 = r15
            L_0x0092:
                boolean r15 = r0 instanceof com.drew.metadata.file.FileSystemDirectory     // Catch:{ all -> 0x0149 }
                if (r15 == 0) goto L_0x009e
                int r15 = r11.getTagType()     // Catch:{ all -> 0x0149 }
            ...
            L_0x009e:
                ...
                r1[r7] = r9     // Catch:{ all -> 0x0149 }
                java.lang.String r11 = r11.getTagTypeHex()     // Catch:{ all -> 0x0149 }
                r1[r5] = r11     // Catch:{ all -> 0x0149 }
                r1[r3] = r14     // Catch:{ all -> 0x0149 }
                r1[r4] = r13     // Catch:{ all -> 0x0149 }
                r1[r12] = r6     // Catch:{ all -> 0x0149 }
                r2.format(r15, r1)     // Catch:{ all -> 0x0149 }
                goto L_0x0077
            L_0x00b5:
                int r1 = r0.getTagCount()     // Catch:{ all -> 0x0149 }
                if (r1 == 0) goto L_0x00be
                r2.write(r6)     // Catch:{ all -> 0x0149 }
            L_0x00be:
                boolean r1 = r0 instanceof com.drew.metadata.xmp.XmpDirectory     // Catch:{ all -> 0x0149 }
                if (r1 == 0) goto L_0x0138
                com.drew.metadata.xmp.XmpDirectory r0 = (com.drew.metadata.xmp.XmpDirectory) r0     // Catch:{ all -> 0x0149 }
                com.adobe.xmp.XMPMeta r0 = r0.getXMPMeta()     // Catch:{ all -> 0x0149 }
                com.adobe.xmp.XMPIterator r0 = r0.iterator()     // Catch:{ XMPException -> 0x012c }
                r1 = r7
            L_0x00cd:
                boolean r9 = r0.hasNext()     // Catch:{ XMPException -> 0x0129 }
                if (r9 == 0) goto L_0x0127
                java.lang.Object r9 = r0.next()     // Catch:{ XMPException -> 0x0129 }
                com.adobe.xmp.properties.XMPPropertyInfo r9 = (com.adobe.xmp.properties.XMPPropertyInfo) r9     // Catch:{ XMPException -> 0x0129 }
                java.lang.String r10 = r9.getNamespace()     // Catch:{ XMPException -> 0x0129 }
                java.lang.String r11 = r9.getPath()     // Catch:{ XMPException -> 0x0129 }
                java.lang.String r9 = r9.getValue()     // Catch:{ XMPException -> 0x0129 }
            ...
            L_0x00eb:
                ...
                goto L_0x010f
            L_0x00ef:
                int r14 = r9.length()     // Catch:{ XMPException -> 0x0129 }
                r15 = 512(0x200, float:7.175E-43)
                if (r14 <= r15) goto L_0x010f
                java.lang.String r14 = "%s <truncated from %d characters>"
                java.lang.Object[] r4 = new java.lang.Object[r3]     // Catch:{ XMPException -> 0x0124 }
                java.lang.String r15 = r9.substring(r7, r15)     // Catch:{ XMPException -> 0x0124 }
                r4[r7] = r15     // Catch:{ XMPException -> 0x0124 }
                int r9 = r9.length()     // Catch:{ XMPException -> 0x0124 }
                java.lang.Integer r9 = java.lang.Integer.valueOf(r9)     // Catch:{ XMPException -> 0x0124 }
                r4[r5] = r9     // Catch:{ XMPException -> 0x0124 }
                java.lang.String r9 = java.lang.String.format(r14, r4)     // Catch:{ XMPException -> 0x0124 }
            L_0x010f:
                java.lang.String r4 = "[XMPMeta - %s] %s = %s%s"
                java.lang.Object[] r14 = new java.lang.Object[r12]     // Catch:{ XMPException -> 0x0124 }
                r14[r7] = r10     // Catch:{ XMPException -> 0x0124 }
                r14[r5] = r11     // Catch:{ XMPException -> 0x0124 }
                r14[r3] = r9     // Catch:{ XMPException -> 0x0124 }
                r9 = 3
            ...
            L_0x013c:
                r1 = r18
                r3 = 0
                writeHierarchyLevel(r1, r2, r3, r7)     // Catch:{ all -> 0x0149 }
                r2.write(r6)     // Catch:{ all -> 0x0149 }
                closeWriter(r2)     // Catch:{ IOException -> 0x0153 }
                goto L_0x0157
            L_0x0149:
                r0 = move-exception
                r1 = r2
            ...
            L_0x014c:
                ...
                r1 = r3
            L_0x014f:
                closeWriter(r1)     // Catch:{ IOException -> 0x0153 }
        ...
        private static java.io.PrintWriter openWriter(java.io.File r7) throws java.io.IOException {
            ...
            L_0x001e:
                ...
                r2.write(r0)
                r0 = 0
                java.io.BufferedInputStream r5 = new java.io.BufferedInputStream     // Catch:{ all -> 0x0092 }
                java.io.FileInputStream r6 = new java.io.FileInputStream     // Catch:{ all -> 0x0092 }
                r6.<init>(r7)     // Catch:{ all -> 0x0092 }
                r5.<init>(r6)     // Catch:{ all -> 0x0092 }
                com.drew.imaging.FileType r7 = com.drew.imaging.FileTypeDetector.detectFileType(r5)     // Catch:{ all -> 0x008f }
                ...
                java.lang.String r7 = r7.toUpperCase()     // Catch:{ all -> 0x008f }
                r1[r4] = r7     // Catch:{ all -> 0x008f }
                java.lang.String r7 = java.lang.String.format(r0, r1)     // Catch:{ all -> 0x008f }
                r2.write(r7)     // Catch:{ all -> 0x008f }
                r2.write(r3)     // Catch:{ all -> 0x008f }
                r5.close()
    ...
    static class MarkdownTableOutputHandler extends FileHandlerBase {
        ...
        static class Row {
            ...
            Row(File file2, Metadata metadata2, String str) {
                ...
                Iterator<Directory> it2 = metadata2.getDirectories().iterator();
                while (true) {
                    if (!it2.hasNext()) {
                        break;
                    }
