...
public class JpegMetadataReader {
    ...
    public static Metadata readMetadata(InputStream inputStream, Iterable<JpegSegmentMetadataReader> iterable) throws JpegProcessingException, IOException {
    ...
    public static Metadata readMetadata(File file, Iterable<JpegSegmentMetadataReader> iterable) throws JpegProcessingException, IOException {
    ...
    public static void process(Metadata metadata, InputStream inputStream, Iterable<JpegSegmentMetadataReader> iterable) throws JpegProcessingException, IOException {
        if (iterable == null) {
