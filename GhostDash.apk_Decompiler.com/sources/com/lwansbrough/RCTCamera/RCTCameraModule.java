...
public class RCTCameraModule extends ReactContextBaseJavaModule implements MediaRecorder.OnInfoListener, MediaRecorder.OnErrorListener, LifecycleEventListener {
        ...
        return Collections.unmodifiableMap(new HashMap<String, Object>() {
            {
                ...
                put(FileRequest.FIELD_TYPE, getTypeConstants());
    ...
    private void releaseMediaRecorder() {
        /*
            ...
            java.lang.String r5 = "RCTCameraModule"
            if (r4 >= 0) goto L_0x001a
            long r2 = r2 - r0
            java.lang.Thread.sleep(r2)     // Catch:{ InterruptedException -> 0x0014 }
            goto L_0x001a
        L_0x0014:
            r0 = move-exception
        ...
        L_0x0023:
            r0 = move-exception
            java.lang.String r2 = "Media recorder stop error."
