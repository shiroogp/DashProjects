    ...
    private final class ExoUnpacker extends UnpackingSoSource.Unpacker {
        ...
        ExoUnpacker(com.facebook.soloader.ExoSoSource r18, com.facebook.soloader.UnpackingSoSource r19) throws java.io.IOException {
            ...
            L_0x0061:
                ...
                r10.<init>(r8)
                java.io.BufferedReader r8 = new java.io.BufferedReader     // Catch:{ all -> 0x010d }
                r8.<init>(r10)     // Catch:{ all -> 0x010d }
            L_0x006b:
            ...
            L_0x0103:
                r0 = move-exception
                r4 = r0
                r2.addSuppressed(r4)     // Catch:{ all -> 0x010d }
                goto L_0x010c
            L_0x0109:
                r8.close()     // Catch:{ all -> 0x010d }
            L_0x010c:
                throw r3     // Catch:{ all -> 0x010d }
            L_0x010d:
                r0 = move-exception
                r2 = r0
