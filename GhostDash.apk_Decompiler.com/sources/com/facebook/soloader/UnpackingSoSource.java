...
public abstract class UnpackingSoSource extends DirectorySoSource {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:12:0x0045 A[Catch:{ all -> 0x009f, all -> 0x00d1 }] */
    /* JADX WARNING: Removed duplicated region for block: B:16:0x005c A[Catch:{ all -> 0x009f, all -> 0x00d1 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void regenerate(byte r10, com.facebook.soloader.UnpackingSoSource.DsoManifest r11, com.facebook.soloader.UnpackingSoSource.InputDsoIterator r12) throws java.io.IOException {
        ...
        L_0x0062:
            ...
            com.facebook.soloader.UnpackingSoSource$Dso[] r7 = r10.dsos     // Catch:{ all -> 0x008d }
            int r7 = r7.length     // Catch:{ all -> 0x008d }
            if (r6 >= r7) goto L_0x008f
            com.facebook.soloader.UnpackingSoSource$Dso[] r7 = r10.dsos     // Catch:{ all -> 0x008d }
            r7 = r7[r6]     // Catch:{ all -> 0x008d }
            java.lang.String r7 = r7.name     // Catch:{ all -> 0x008d }
            com.facebook.soloader.UnpackingSoSource$Dso r8 = r4.dso     // Catch:{ all -> 0x008d }
            java.lang.String r8 = r8.name     // Catch:{ all -> 0x008d }
            boolean r7 = r7.equals(r8)     // Catch:{ all -> 0x008d }
            if (r7 == 0) goto L_0x008a
            com.facebook.soloader.UnpackingSoSource$Dso[] r7 = r10.dsos     // Catch:{ all -> 0x008d }
            r7 = r7[r6]     // Catch:{ all -> 0x008d }
            java.lang.String r7 = r7.hash     // Catch:{ all -> 0x008d }
            com.facebook.soloader.UnpackingSoSource$Dso r8 = r4.dso     // Catch:{ all -> 0x008d }
            java.lang.String r8 = r8.hash     // Catch:{ all -> 0x008d }
            boolean r7 = r7.equals(r8)     // Catch:{ all -> 0x008d }
            if (r7 == 0) goto L_0x008a
            r5 = r3
        L_0x008a:
        ...
        L_0x008f:
            ...
            r9.extractDso(r4, r11)     // Catch:{ all -> 0x008d }
            goto L_0x00a8
        L_0x0095:
        ...
        L_0x009f:
            r12 = move-exception
            r10.addSuppressed(r12)     // Catch:{ all -> 0x0038 }
            goto L_0x00a7
        L_0x00a4:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:84:0x0118, code lost:
        throw r13;
     */
    /* JADX WARNING: Removed duplicated region for block: B:44:0x00af A[RETURN] */
    ...
    private boolean refreshLocked(com.facebook.soloader.FileLocker r12, int r13, byte[] r14) throws java.io.IOException {
        /*
            ...
            r8 = 1
            r3 = 0
            byte r4 = r1.readByte()     // Catch:{ EOFException -> 0x0038, all -> 0x003a }
            if (r4 == r8) goto L_0x004c
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ EOFException -> 0x0038, all -> 0x003a }
            r4.<init>()     // Catch:{ EOFException -> 0x0038, all -> 0x003a }
            java.lang.String r5 = "dso store "
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ EOFException -> 0x0038, all -> 0x003a }
            java.io.File r5 = r11.soDirectory     // Catch:{ EOFException -> 0x0038, all -> 0x003a }
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ EOFException -> 0x0038, all -> 0x003a }
            java.lang.String r5 = " regeneration interrupted: wiping clean"
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ EOFException -> 0x0038, all -> 0x003a }
            java.lang.String r4 = r4.toString()     // Catch:{ EOFException -> 0x0038, all -> 0x003a }
            android.util.Log.v(r0, r4)     // Catch:{ EOFException -> 0x0038, all -> 0x003a }
        L_0x0038:
            r4 = r3
            goto L_0x004c
        L_0x003a:
        ...
        L_0x004c:
            ...
            r7.<init>(r5, r2)
            long r9 = r7.length()     // Catch:{ all -> 0x0107 }
            int r2 = (int) r9     // Catch:{ all -> 0x0107 }
            byte[] r9 = new byte[r2]     // Catch:{ all -> 0x0107 }
            int r10 = r7.read(r9)     // Catch:{ all -> 0x0107 }
            if (r10 == r2) goto L_0x0072
            java.lang.String r2 = "short read of so store deps file: marking unclean"
            android.util.Log.v(r0, r2)     // Catch:{ all -> 0x0107 }
            r4 = r3
        L_0x0072:
            boolean r2 = java.util.Arrays.equals(r9, r14)     // Catch:{ all -> 0x0107 }
        ...
        L_0x0087:
            ...
            android.util.Log.v(r0, r1)     // Catch:{ all -> 0x0107 }
            writeState(r6, r3)     // Catch:{ all -> 0x0107 }
            com.facebook.soloader.UnpackingSoSource$Unpacker r0 = r11.makeUnpacker()     // Catch:{ all -> 0x0107 }
            com.facebook.soloader.UnpackingSoSource$DsoManifest r1 = r0.getDsoManifest()     // Catch:{ all -> 0x00f3 }
            com.facebook.soloader.UnpackingSoSource$InputDsoIterator r2 = r0.openDsoIterator()     // Catch:{ all -> 0x00f3 }
            r11.regenerate(r4, r1, r2)     // Catch:{ all -> 0x00e5 }
        ...
        L_0x00ee:
            r14 = move-exception
            r12.addSuppressed(r14)     // Catch:{ all -> 0x00f3 }
        L_0x00f2:
        ...
        L_0x00fe:
            r14 = move-exception
            r12.addSuppressed(r14)     // Catch:{ all -> 0x0107 }
            goto L_0x0106
        L_0x0103:
            r0.close()     // Catch:{ all -> 0x0107 }
        L_0x0106:
        ...
        L_0x0107:
            r12 = move-exception
            throw r12     // Catch:{ all -> 0x0109 }
        L_0x0109:
            r13 = move-exception
            if (r12 == 0) goto L_0x0115
            r7.close()     // Catch:{ all -> 0x0110 }
            goto L_0x0118
        L_0x0110:
            r14 = move-exception
            r12.addSuppressed(r14)
