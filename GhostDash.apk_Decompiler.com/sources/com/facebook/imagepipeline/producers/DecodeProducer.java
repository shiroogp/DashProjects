...
public class DecodeProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    private abstract class ProgressiveDecoder extends DelegatingConsumer<EncodedImage, CloseableReference<CloseableImage>> {
        ...
        /* access modifiers changed from: private */
        /* JADX WARNING: Removed duplicated region for block: B:31:0x00bb A[Catch:{ all -> 0x0150 }] */
        ...
        public void doDecode(com.facebook.imagepipeline.image.EncodedImage r19, int r20) {
            ...
            L_0x0096:
                r14 = r2
                com.facebook.imagepipeline.producers.JobScheduler r2 = r11.mJobScheduler     // Catch:{ all -> 0x0150 }
                long r15 = r2.getQueuedTime()     // Catch:{ all -> 0x0150 }
                com.facebook.imagepipeline.producers.ProducerContext r2 = r11.mProducerContext     // Catch:{ all -> 0x0150 }
                com.facebook.imagepipeline.request.ImageRequest r2 = r2.getImageRequest()     // Catch:{ all -> 0x0150 }
                android.net.Uri r2 = r2.getSourceUri()     // Catch:{ all -> 0x0150 }
                java.lang.String r2 = java.lang.String.valueOf(r2)     // Catch:{ all -> 0x0150 }
                if (r5 != 0) goto L_0x00b5
                if (r13 == 0) goto L_0x00b0
                goto L_0x00b5
            L_0x00b0:
                int r3 = r18.getIntermediateImageEndOffset(r19)     // Catch:{ all -> 0x0150 }
                goto L_0x00b9
            L_0x00b5:
                int r3 = r19.getSize()     // Catch:{ all -> 0x0150 }
            L_0x00b9:
                if (r5 != 0) goto L_0x00c3
                if (r13 == 0) goto L_0x00be
                goto L_0x00c3
            L_0x00be:
                com.facebook.imagepipeline.image.QualityInfo r5 = r18.getQualityInfo()     // Catch:{ all -> 0x0150 }
                goto L_0x00c5
            L_0x00c3:
                com.facebook.imagepipeline.image.QualityInfo r5 = com.facebook.imagepipeline.image.ImmutableQualityInfo.FULL_QUALITY     // Catch:{ all -> 0x0150 }
            L_0x00c5:
                com.facebook.imagepipeline.producers.ProducerListener r13 = r11.mProducerListener     // Catch:{ all -> 0x0150 }
                com.facebook.imagepipeline.producers.ProducerContext r1 = r11.mProducerContext     // Catch:{ all -> 0x0150 }
                java.lang.String r1 = r1.getId()     // Catch:{ all -> 0x0150 }
                r13.onProducerStart(r1, r12)     // Catch:{ all -> 0x0150 }
                com.facebook.imagepipeline.producers.DecodeProducer r13 = com.facebook.imagepipeline.producers.DecodeProducer.this     // Catch:{ DecodeException -> 0x0108 }
                com.facebook.imagepipeline.decoder.ImageDecoder r13 = r13.mImageDecoder     // Catch:{ DecodeException -> 0x0108 }
                com.facebook.imagepipeline.common.ImageDecodeOptions r1 = r11.mImageDecodeOptions     // Catch:{ DecodeException -> 0x0108 }
                r4 = r19
                com.facebook.imagepipeline.image.CloseableImage r13 = r13.decode(r4, r3, r5, r1)     // Catch:{ DecodeException -> 0x0108 }
                int r1 = r19.getSampleSize()     // Catch:{ Exception -> 0x0102 }
                r2 = 1
            ...
            L_0x00e7:
                ...
                r3 = r15
                r9 = r14
                java.util.Map r1 = r1.getExtraMap(r2, r3, r5, r6, r7, r8, r9, r10)     // Catch:{ all -> 0x0150 }
                com.facebook.imagepipeline.producers.ProducerListener r2 = r11.mProducerListener     // Catch:{ all -> 0x0150 }
                com.facebook.imagepipeline.producers.ProducerContext r3 = r11.mProducerContext     // Catch:{ all -> 0x0150 }
                java.lang.String r3 = r3.getId()     // Catch:{ all -> 0x0150 }
                r2.onProducerFinishWithSuccess(r3, r12, r1)     // Catch:{ all -> 0x0150 }
                r11.handleResult(r13, r0)     // Catch:{ all -> 0x0150 }
            ...
            L_0x0108:
                r0 = move-exception
                com.facebook.imagepipeline.image.EncodedImage r1 = r0.getEncodedImage()     // Catch:{ Exception -> 0x0105 }
                ...
                java.lang.String r13 = r0.getMessage()     // Catch:{ Exception -> 0x0105 }
                r17 = 0
                r9[r17] = r13     // Catch:{ Exception -> 0x0105 }
                r13 = 1
                r9[r13] = r2     // Catch:{ Exception -> 0x0105 }
                r2 = 2
                r13 = 10
                java.lang.String r13 = r1.getFirstBytesAsHexString(r13)     // Catch:{ Exception -> 0x0105 }
                r9[r2] = r13     // Catch:{ Exception -> 0x0105 }
                r2 = 3
                int r1 = r1.getSize()     // Catch:{ Exception -> 0x0105 }
                java.lang.Integer r1 = java.lang.Integer.valueOf(r1)     // Catch:{ Exception -> 0x0105 }
                r9[r2] = r1     // Catch:{ Exception -> 0x0105 }
                com.facebook.common.logging.FLog.w((java.lang.String) r3, (java.lang.String) r4, (java.lang.Object[]) r9)     // Catch:{ Exception -> 0x0105 }
            ...
            L_0x0136:
                ...
                com.facebook.imagepipeline.producers.ProducerContext r3 = r11.mProducerContext     // Catch:{ all -> 0x0150 }
                java.lang.String r3 = r3.getId()     // Catch:{ all -> 0x0150 }
                r2.onProducerFinishWithFailure(r3, r12, r0, r1)     // Catch:{ all -> 0x0150 }
                r11.handleError(r0)     // Catch:{ all -> 0x0150 }
                com.facebook.imagepipeline.image.EncodedImage.closeSafely(r19)
                return
            L_0x0150:
                r0 = move-exception
