...
public class ImagePipeline {
    ...
    private <T> com.facebook.datasource.DataSource<com.facebook.common.references.CloseableReference<T>> submitFetchRequest(com.facebook.imagepipeline.producers.Producer<com.facebook.common.references.CloseableReference<T>> r11, com.facebook.imagepipeline.request.ImageRequest r12, com.facebook.imagepipeline.request.ImageRequest.RequestLevel r13, java.lang.Object r14, @javax.annotation.Nullable com.facebook.imagepipeline.listener.RequestListener r15) {
        ...
        L_0x0016:
            com.facebook.imagepipeline.request.ImageRequest$RequestLevel r0 = r12.getLowestPermittedRequestLevel()     // Catch:{ Exception -> 0x0055 }
            com.facebook.imagepipeline.request.ImageRequest$RequestLevel r6 = com.facebook.imagepipeline.request.ImageRequest.RequestLevel.getMax(r0, r13)     // Catch:{ Exception -> 0x0055 }
            com.facebook.imagepipeline.producers.SettableProducerContext r13 = new com.facebook.imagepipeline.producers.SettableProducerContext     // Catch:{ Exception -> 0x0055 }
            java.lang.String r3 = r10.generateUniqueFutureId()     // Catch:{ Exception -> 0x0055 }
            r7 = 0
            boolean r0 = r12.getProgressiveRenderingEnabled()     // Catch:{ Exception -> 0x0055 }
            if (r0 != 0) goto L_0x0038
            android.net.Uri r0 = r12.getSourceUri()     // Catch:{ Exception -> 0x0055 }
            boolean r0 = com.facebook.common.util.UriUtil.isNetworkUri(r0)     // Catch:{ Exception -> 0x0055 }
        ...
        L_0x0039:
            r8 = r0
            com.facebook.imagepipeline.common.Priority r9 = r12.getPriority()     // Catch:{ Exception -> 0x0055 }
            r1 = r13
            r2 = r12
            r4 = r15
            r5 = r14
            r1.<init>(r2, r3, r4, r5, r6, r7, r8, r9)     // Catch:{ Exception -> 0x0055 }
            com.facebook.datasource.DataSource r11 = com.facebook.imagepipeline.datasource.CloseableProducerToDataSourceAdapter.create(r11, r13, r15)     // Catch:{ Exception -> 0x0055 }
        ...
        L_0x0055:
            r11 = move-exception
            com.facebook.datasource.DataSource r11 = com.facebook.datasource.DataSources.immediateFailedDataSource(r11)     // Catch:{ all -> 0x0053 }
            boolean r12 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
