...
public class WebpUtil {
    ...
    private static int getInt(InputStream inputStream) throws IOException {
        return ((((byte) inputStream.read()) << 24) & -16777216) | ((((byte) inputStream.read()) << Tnaf.POW_2_WIDTH) & 16711680) | ((((byte) inputStream.read()) << 8) & 65280) | (((byte) inputStream.read()) & UByte.MAX_VALUE);
    }
    ...
    private static int read3Bytes(InputStream inputStream) throws IOException {
        ...
        return ((getByte(inputStream) << Tnaf.POW_2_WIDTH) & 16711680) | ((getByte(inputStream) << 8) & 65280) | (b & UByte.MAX_VALUE);
    }
