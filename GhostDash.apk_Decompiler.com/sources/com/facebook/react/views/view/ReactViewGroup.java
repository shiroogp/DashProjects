        ...
        if (str != null) {
            ...
            if (str.equals(ViewProps.HIDDEN)) {
                ...
                if (reactViewBackgroundDrawable != null) {
                    ...
                    if (borderRadiusOrDefaultTo > f3 || borderRadiusOrDefaultTo2 > f3 || borderRadiusOrDefaultTo4 > f3 || borderRadiusOrDefaultTo3 > f3) {
                        if (this.mPath == null) {
                            this.mPath = new Path();
                        }
                        this.mPath.rewind();
                ...
                if (!z) {
                    canvas2.clipRect(new RectF(f4, f, width, height));
                }
