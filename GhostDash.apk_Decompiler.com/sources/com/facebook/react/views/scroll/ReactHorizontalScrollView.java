        ...
        if (getChildCount() > 0) {
            ...
            if (list != null) {
                ...
                for (int i9 = 0; i9 < this.mSnapOffsets.size(); i9++) {
                    int intValue = this.mSnapOffsets.get(i9).intValue();
            ...
            int i10 = predictFinalScrollPosition - i4;
            int i11 = i3 - predictFinalScrollPosition;
            int i12 = i10 < i11 ? i4 : i3;
            ...
            if (overScroller != null) {
                ...
                overScroller.fling(scrollX2, scrollY, i7, 0, min, min, 0, 0, i8, 0);
