    ...
    private void emitProgress(Map<String, String> map, long j, boolean z, ChunkListener chunkListener) throws IOException {
        if (map != null && chunkListener != null) {
            ...
            if (currentTimeMillis - this.mLastProgressEvent > 16 || z) {
                ...
                chunkListener.onChunkProgress(map, j, map.get(FetchCoreUtils.HEADER_CONTENT_LENGTH_LEGACY) != null ? Long.parseLong(map.get(FetchCoreUtils.HEADER_CONTENT_LENGTH_LEGACY)) : 0);
            }
        }
    }
