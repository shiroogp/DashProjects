...
public class DevServerHelper {
    ...
    public java.io.File downloadBundleResourceFromUrlSync(java.lang.String r5, java.io.File r6) {
        /*
            ...
            r1 = 0
            okhttp3.OkHttpClient r2 = r4.mClient     // Catch:{ Exception -> 0x006e }
            okhttp3.Call r0 = r2.newCall(r0)     // Catch:{ Exception -> 0x006e }
            okhttp3.Response r0 = r0.execute()     // Catch:{ Exception -> 0x006e }
        ...
        L_0x0065:
            r0 = move-exception
            r2.addSuppressed(r0)     // Catch:{ Exception -> 0x006e }
            goto L_0x006d
        L_0x006a:
            r0.close()     // Catch:{ Exception -> 0x006e }
        L_0x006d:
