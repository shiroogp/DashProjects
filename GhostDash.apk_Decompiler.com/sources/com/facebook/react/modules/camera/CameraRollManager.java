...
public class CameraRollManager extends NativeCameraRollManagerSpec {
    ...
    private static class SaveToCameraRoll extends GuardedAsyncTask<Void, Void> {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:12:0x0055 A[Catch:{ IOException -> 0x0135, all -> 0x0130 }] */
        ...
        public void doInBackgroundGuarded(java.lang.Void... r14) {
            /*
                ...
                r2.<init>(r3)
                r3 = 0
                android.net.Uri r4 = r13.mUri     // Catch:{ IOException -> 0x013d, all -> 0x013a }
                java.lang.String r4 = r4.getScheme()     // Catch:{ IOException -> 0x013d, all -> 0x013a }
                java.lang.String r5 = "http"
                boolean r5 = r4.equals(r5)     // Catch:{ IOException -> 0x013d, all -> 0x013a }
                if (r5 != 0) goto L_0x0033
                java.lang.String r5 = "https"
                boolean r4 = r4.equals(r5)     // Catch:{ IOException -> 0x013d, all -> 0x013a }
                if (r4 == 0) goto L_0x0029
                goto L_0x0033
            L_0x0029:
                java.io.FileInputStream r4 = new java.io.FileInputStream     // Catch:{ IOException -> 0x013d, all -> 0x013a }
                r4.<init>(r2)     // Catch:{ IOException -> 0x013d, all -> 0x013a }
                java.nio.channels.FileChannel r4 = r4.getChannel()     // Catch:{ IOException -> 0x013d, all -> 0x013a }
                goto L_0x0046
            L_0x0033:
                java.net.URL r4 = new java.net.URL     // Catch:{ IOException -> 0x013d, all -> 0x013a }
                android.net.Uri r5 = r13.mUri     // Catch:{ IOException -> 0x013d, all -> 0x013a }
                java.lang.String r5 = r5.toString()     // Catch:{ IOException -> 0x013d, all -> 0x013a }
                r4.<init>(r5)     // Catch:{ IOException -> 0x013d, all -> 0x013a }
                java.io.InputStream r4 = r4.openStream()     // Catch:{ IOException -> 0x013d, all -> 0x013a }
                java.nio.channels.ReadableByteChannel r4 = java.nio.channels.Channels.newChannel(r4)     // Catch:{ IOException -> 0x013d, all -> 0x013a }
            L_0x0046:
                java.lang.String r5 = android.os.Environment.DIRECTORY_DCIM     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                java.io.File r5 = android.os.Environment.getExternalStoragePublicDirectory(r5)     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                r5.mkdirs()     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                boolean r6 = r5.isDirectory()     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                if (r6 != 0) goto L_0x006f
                com.facebook.react.bridge.Promise r2 = r13.mPromise     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                java.lang.String r5 = "E_UNABLE_TO_LOAD"
                java.lang.String r6 = "External media storage directory not available"
                r2.reject((java.lang.String) r5, (java.lang.String) r6)     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
            ...
            L_0x006e:
                return
            L_0x006f:
                java.io.File r6 = new java.io.File     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                java.lang.String r7 = r2.getName()     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                r6.<init>(r5, r7)     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                java.lang.String r2 = r2.getName()     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                r7 = 46
                int r8 = r2.indexOf(r7)     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                r9 = 0
                if (r8 < 0) goto L_0x0098
                int r8 = r2.lastIndexOf(r7)     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                java.lang.String r8 = r2.substring(r9, r8)     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                int r7 = r2.lastIndexOf(r7)     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                java.lang.String r2 = r2.substring(r7)     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                r7 = r2
                r2 = r8
                goto L_0x009a
            L_0x0098:
            ...
            L_0x009a:
                r8 = r9
            L_0x009b:
                boolean r10 = r6.createNewFile()     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                if (r10 != 0) goto L_0x00c5
                java.io.File r6 = new java.io.File     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                java.lang.StringBuilder r10 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                r10.<init>()     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                java.lang.StringBuilder r10 = r10.append(r2)     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                java.lang.String r11 = "_"
                java.lang.StringBuilder r10 = r10.append(r11)     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                int r11 = r8 + 1
                java.lang.StringBuilder r8 = r10.append(r8)     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                java.lang.StringBuilder r8 = r8.append(r7)     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                java.lang.String r8 = r8.toString()     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                r6.<init>(r5, r8)     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                r8 = r11
                goto L_0x009b
            L_0x00c5:
                java.io.FileOutputStream r2 = new java.io.FileOutputStream     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                r2.<init>(r6)     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                java.nio.channels.FileChannel r2 = r2.getChannel()     // Catch:{ IOException -> 0x0135, all -> 0x0130 }
                r5 = 1048576(0x100000, float:1.469368E-39)
                java.nio.ByteBuffer r5 = java.nio.ByteBuffer.allocate(r5)     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
            L_0x00d4:
                int r7 = r4.read(r5)     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
                if (r7 <= 0) goto L_0x00e4
                r5.flip()     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
                r2.write(r5)     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
                r5.compact()     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
                goto L_0x00d4
            L_0x00e4:
                r5.flip()     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
            L_0x00e7:
                boolean r7 = r5.hasRemaining()     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
                if (r7 == 0) goto L_0x00f1
                r2.write(r5)     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
                goto L_0x00e7
            L_0x00f1:
                r4.close()     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
                r2.close()     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
                android.content.Context r5 = r13.mContext     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
                r7 = 1
                java.lang.String[] r7 = new java.lang.String[r7]     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
                java.lang.String r6 = r6.getAbsolutePath()     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
                r7[r9] = r6     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
                com.facebook.react.modules.camera.CameraRollManager$SaveToCameraRoll$1 r6 = new com.facebook.react.modules.camera.CameraRollManager$SaveToCameraRoll$1     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
                r6.<init>()     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
                android.media.MediaScannerConnection.scanFile(r5, r7, r3, r6)     // Catch:{ IOException -> 0x012b, all -> 0x0126 }
            ...
            L_0x013d:
                ...
                r4 = r3
            L_0x013f:
                com.facebook.react.bridge.Promise r5 = r13.mPromise     // Catch:{ all -> 0x0165 }
                r5.reject((java.lang.Throwable) r2)     // Catch:{ all -> 0x0165 }
    ...
    private static void putBasicNodeInfo(Cursor cursor, WritableMap writableMap, int i, int i2, int i3) {
        ...
        writableMap.putDouble(ServerValues.NAME_OP_TIMESTAMP, ((double) cursor.getLong(i3)) / 1000.0d);
    }
