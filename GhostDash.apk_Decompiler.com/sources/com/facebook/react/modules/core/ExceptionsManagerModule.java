...
public class ExceptionsManagerModule extends NativeExceptionsManagerSpec {
    ...
    public void reportFatalException(String str, ReadableArray readableArray, double d) {
        ...
        javaOnlyMap.putString(FFmpegKitReactNativeModule.KEY_LOG_MESSAGE, str);
        javaOnlyMap.putArray("stack", readableArray);
        javaOnlyMap.putInt(Chapter.KEY_ID, (int) d);
    ...
    public void reportException(ReadableMap readableMap) {
        String string = readableMap.hasKey(FFmpegKitReactNativeModule.KEY_LOG_MESSAGE) ? readableMap.getString(FFmpegKitReactNativeModule.KEY_LOG_MESSAGE) : "";
        ReadableArray array = readableMap.hasKey("stack") ? readableMap.getArray("stack") : Arguments.createArray();
        int i = readableMap.hasKey(Chapter.KEY_ID) ? readableMap.getInt(Chapter.KEY_ID) : -1;
        boolean z = false;
