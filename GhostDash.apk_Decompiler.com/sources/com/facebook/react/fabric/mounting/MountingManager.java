...
public class MountingManager {
    ...
    public void removeViewAt(int i, int i2) {
        ...
        ViewState nullableViewState = getNullableViewState(i);
        if (nullableViewState == null) {
            ReactSoftException.logSoftException(TAG, new IllegalStateException("Unable to find viewState for tag: " + i + " for removeViewAt"));
            return;
        }
    ...
    public void deleteView(int i) {
        ...
        ViewState nullableViewState = getNullableViewState(i);
        if (nullableViewState == null) {
            ReactSoftException.logSoftException(TAG, new IllegalStateException("Unable to find viewState for tag: " + i + " for deleteView"));
            return;
        }
