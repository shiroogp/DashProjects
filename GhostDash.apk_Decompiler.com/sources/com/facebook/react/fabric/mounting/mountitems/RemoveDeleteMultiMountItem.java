...
public class RemoveDeleteMultiMountItem implements MountItem {
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.mMetadata.length; i += 4) {
            ...
            sb.append("RemoveDeleteMultiMountItem (").append((i / 4) + 1).append("/").append(this.mMetadata.length / 4).append("): [").append(this.mMetadata[i + 0]).append("] parent [").append(this.mMetadata[i + 1]).append("] idx ").append(this.mMetadata[i + 2]).append(" ").append(this.mMetadata[i + 3]);
        }
        return sb.toString();
    }
}
