...
public class DebugServerException extends RuntimeException {
    ...
    public static DebugServerException parse(String str, String str2) {
        ...
        try {
            ...
            return new DebugServerException(jSONObject.getString(FFmpegKitReactNativeModule.KEY_LOG_MESSAGE), shortenFileName(jSONObject.getString(MediaInformation.KEY_FILENAME)), jSONObject.getInt(StackTraceHelper.LINE_NUMBER_KEY), jSONObject.getInt(StackTraceHelper.COLUMN_KEY));
