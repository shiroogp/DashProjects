                ...
                try {
                    ...
                    if (jSONObject.has(AppMeasurementSdk.ConditionalUserProperty.NAME)) {
                        ...
                        if (createMap3.hasKey("firstName") || createMap3.hasKey("lastName")) {
                            createMap2.putMap(AppMeasurementSdk.ConditionalUserProperty.NAME, createMap3);
                        }
                    }
                    if (jSONObject.has("email")) {
                        createMap2.putString("email", jSONObject.getString("email"));
                    }
                    if (createMap2.hasKey(AppMeasurementSdk.ConditionalUserProperty.NAME) || createMap2.hasKey("email")) {
