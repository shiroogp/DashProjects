    ...
    public void addPatchFile(String str) throws IOException {
        ...
        if (length >= 22) {
            ...
            if (read4LE == kEOCDSignature) {
                ...
                long j2 = ((long) allocate.getInt(length2 + 12)) & BodyPartID.bodyIdMax;
                long j3 = ((long) allocate.getInt(length2 + 16)) & BodyPartID.bodyIdMax;
                if (j3 + j2 > length) {
                    ...
                    while (i2 < s) {
                        if (map.getInt(i3) == kCDESignature) {
                            ...
                            zipEntryRO.mWhenModified = ((long) map.getInt(i3 + 12)) & BodyPartID.bodyIdMax;
                            zipEntryRO.mCRC32 = map.getLong(i3 + 16) & BodyPartID.bodyIdMax;
                            zipEntryRO.mCompressedLength = map.getLong(i3 + 20) & BodyPartID.bodyIdMax;
                            zipEntryRO.mUncompressedLength = map.getLong(i3 + 24) & BodyPartID.bodyIdMax;
                            zipEntryRO.mLocalHdrOffset = ((long) map.getInt(i3 + 42)) & BodyPartID.bodyIdMax;
                            allocate2.clear();
