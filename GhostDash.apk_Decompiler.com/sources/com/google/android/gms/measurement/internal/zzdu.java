...
public final class zzdu {
    ...
    public static final zzdt zzd = zza("measurement.config.url_scheme", UriUtil.HTTPS_SCHEME, UriUtil.HTTPS_SCHEME, zzbl.zza);
    ...
    static {
        ...
        zzj = zza("measurement.upload.max_events_per_day", valueOf2, valueOf2, zzdm.zza);
        zzo = zza("measurement.store.max_stored_events_per_app", valueOf2, valueOf2, zzdk.zza);
        zzt = zza("measurement.upload.realtime_upload_interval", valueOf, valueOf, zzay.zza);
        Integer valueOf3 = Integer.valueOf(CropImageView.DEFAULT_IMAGE_TO_CROP_BOUNDS_ANIM_DURATION);
        zzG = zza("measurement.upload.max_event_name_cardinality", valueOf3, valueOf3, (zzdq) null);
