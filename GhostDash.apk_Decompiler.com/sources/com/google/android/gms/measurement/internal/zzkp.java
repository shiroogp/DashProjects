...
public final class zzkp implements zzgm {
    ...
    public final void zzC(zzg zzg2) {
        ...
        if (!TextUtils.isEmpty(zzg2.zzy()) || !TextUtils.isEmpty(zzg2.zzr())) {
            ...
            Uri.Builder appendQueryParameter = encodedAuthority.path(str).appendQueryParameter("app_instance_id", zzg2.zzu()).appendQueryParameter("platform", FFmpegKitReactNativeModule.PLATFORM_NAME);
            zzkg.zzs.zzf().zzh();
            ...
            zzH((String) Preconditions.checkNotNull(zzg2.zzt()), XMPError.BADSTREAM, (Throwable) null, (byte[]) null, (Map) null);
        }
    }
    ...
    public final String zzx(zzp zzp2) {
        try {
            return (String) zzaz().zzh(new zzkk(this, zzp2)).get(30000, TimeUnit.MILLISECONDS);
