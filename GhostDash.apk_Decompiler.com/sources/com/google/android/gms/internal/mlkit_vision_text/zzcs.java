...
final class zzcs implements ObjectEncoderContext {
    private static final Charset zza = Charset.forName(Key.STRING_CHARSET_NAME);
    private static final FieldDescriptor zzb;
    private static final FieldDescriptor zzc;
    private static final ObjectEncoder<Map.Entry<Object, Object>> zzd = zzcr.zza;
    ...
    zzcs(OutputStream outputStream, Map<Class<?>, ObjectEncoder<?>> map, Map<Class<?>, ValueEncoder<?>> map2, ObjectEncoder<Object> objectEncoder) {
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzcq zzcq = (zzcq) fieldDescriptor.getProperty(zzcq.class);
        if (zzcq != null) {
            return zzcq.zza();
        }
    ...
    /* access modifiers changed from: package-private */
    public final zzcs zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
        zzcq zzj = zzj(fieldDescriptor);
        zzcp zzcp = zzcp.DEFAULT;
    ...
    /* access modifiers changed from: package-private */
    public final zzcs zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzcq zzj = zzj(fieldDescriptor);
    ...
    /* access modifiers changed from: package-private */
    public final zzcs zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = this.zzf.get(obj.getClass());
