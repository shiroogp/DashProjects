...
public final class zzlq {
    ...
    public final synchronized void zzc(int i, int i2, long j, long j2) {
        synchronized (this) {
            ...
            this.zza.log(new TelemetryData(0, Arrays.asList(new MethodInvocation[]{new MethodInvocation(i, i2, 0, j, j2, (String) null, (String) null, 0)}))).addOnFailureListener(new zzlp(this, elapsedRealtime));
        }
    }
}
