...
final class zzdc implements ObjectEncoderContext {
    ...
    private static final ObjectEncoder<Map.Entry<Object, Object>> zzd = zzdb.zza;
    ...
    zzdc(OutputStream outputStream, Map<Class<?>, ObjectEncoder<?>> map, Map<Class<?>, ValueEncoder<?>> map2, ObjectEncoder<Object> objectEncoder) {
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzda zzda = (zzda) fieldDescriptor.getProperty(zzda.class);
        if (zzda != null) {
            return zzda.zza();
        }
    ...
    /* access modifiers changed from: package-private */
    public final zzdc zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
        zzda zzj = zzj(fieldDescriptor);
        zzcz zzcz = zzcz.DEFAULT;
    ...
    /* access modifiers changed from: package-private */
    public final zzdc zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzda zzj = zzj(fieldDescriptor);
    ...
    /* access modifiers changed from: package-private */
    public final zzdc zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = this.zzf.get(obj.getClass());
