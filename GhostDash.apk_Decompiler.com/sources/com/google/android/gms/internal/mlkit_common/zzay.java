...
final class zzay implements ObjectEncoderContext {
    ...
    private static final ObjectEncoder<Map.Entry<Object, Object>> zzd = zzax.zza;
    ...
    zzay(OutputStream outputStream, Map<Class<?>, ObjectEncoder<?>> map, Map<Class<?>, ValueEncoder<?>> map2, ObjectEncoder<Object> objectEncoder) {
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzaw zzaw = (zzaw) fieldDescriptor.getProperty(zzaw.class);
        if (zzaw != null) {
            return zzaw.zza();
        }
    ...
    private static zzaw zzj(FieldDescriptor fieldDescriptor) {
        zzaw zzaw = (zzaw) fieldDescriptor.getProperty(zzaw.class);
        if (zzaw != null) {
            return zzaw;
        }
    ...
    private final <T> zzay zzk(ObjectEncoder<T> objectEncoder, FieldDescriptor fieldDescriptor, T t, boolean z) throws IOException {
    ...
    private final <T> zzay zzl(ValueEncoder<T> valueEncoder, FieldDescriptor fieldDescriptor, T t, boolean z) throws IOException {
    ...
    public final ObjectEncoderContext zzc(FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
        ...
        if (obj instanceof CharSequence) {
            ...
            if (valueEncoder != null) {
                ...
                zzd(fieldDescriptor, ((zzau) obj).zza(), true);
                return this;
    ...
    /* access modifiers changed from: package-private */
    public final zzay zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
        zzaw zzj = zzj(fieldDescriptor);
        zzav zzav = zzav.DEFAULT;
    ...
    /* access modifiers changed from: package-private */
    public final zzay zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzaw zzj = zzj(fieldDescriptor);
