...
public enum zzgv implements zzau {
    UNKNOWN_EVENT(0),
    ...
    ON_DEVICE_DI_CLOSE(ExifDirectoryBase.TAG_ARTIST),
    ...
    AGGREGATED_CUSTOM_MODEL_INFERENCE(XMPError.BADXML),
    AGGREGATED_ON_DEVICE_BARCODE_DETECTION(XMPError.BADRDF),
    AGGREGATED_ON_DEVICE_FACE_DETECTION(XMPError.BADXMP),
    AGGREGATED_ON_DEVICE_IMAGE_LABEL_DETECTION(XMPError.BADSTREAM),
    ...
    INSTALLATION_ID_FIS_CREATE_INSTALLATION(ExifDirectoryBase.TAG_TRANSFER_FUNCTION),
