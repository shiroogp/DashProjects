...
final class zzz implements ObjectEncoderContext {
    private static final Charset zza = Charset.forName(Key.STRING_CHARSET_NAME);
    private static final FieldDescriptor zzb;
    private static final FieldDescriptor zzc;
    private static final ObjectEncoder<Map.Entry<Object, Object>> zzd = zzy.zza;
    ...
    zzz(OutputStream outputStream, Map<Class<?>, ObjectEncoder<?>> map, Map<Class<?>, ValueEncoder<?>> map2, ObjectEncoder<Object> objectEncoder) {
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzx zzx = (zzx) fieldDescriptor.getProperty(zzx.class);
        if (zzx != null) {
            return zzx.zza();
        }
    ...
    private static zzx zzj(FieldDescriptor fieldDescriptor) {
        zzx zzx = (zzx) fieldDescriptor.getProperty(zzx.class);
        if (zzx != null) {
            return zzx;
        }
    ...
    private final <T> zzz zzk(ObjectEncoder<T> objectEncoder, FieldDescriptor fieldDescriptor, T t, boolean z) throws IOException {
    ...
    private final <T> zzz zzl(ValueEncoder<T> valueEncoder, FieldDescriptor fieldDescriptor, T t, boolean z) throws IOException {
    ...
    public final ObjectEncoderContext zzc(FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
        ...
        if (obj instanceof CharSequence) {
            ...
            if (valueEncoder != null) {
                ...
                zzd(fieldDescriptor, ((zzv) obj).zza(), true);
                return this;
    ...
    /* access modifiers changed from: package-private */
    public final zzz zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
        zzx zzj = zzj(fieldDescriptor);
        zzw zzw = zzw.DEFAULT;
    ...
    /* access modifiers changed from: package-private */
    public final zzz zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzx zzj = zzj(fieldDescriptor);
    ...
    /* access modifiers changed from: package-private */
    public final zzz zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = this.zzf.get(obj.getClass());
