...
final class zzcn implements ObjectEncoderContext {
    private static final Charset zza = Charset.forName(Key.STRING_CHARSET_NAME);
    private static final FieldDescriptor zzb;
    private static final FieldDescriptor zzc;
    private static final ObjectEncoder<Map.Entry<Object, Object>> zzd = zzcm.zza;
    ...
    private final zzcr zzi = new zzcr(this);
    ...
    zzcn(OutputStream outputStream, Map<Class<?>, ObjectEncoder<?>> map, Map<Class<?>, ValueEncoder<?>> map2, ObjectEncoder<Object> objectEncoder) {
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzcl zzcl = (zzcl) fieldDescriptor.getProperty(zzcl.class);
        if (zzcl != null) {
            return zzcl.zza();
        }
    ...
    private static zzcl zzj(FieldDescriptor fieldDescriptor) {
        zzcl zzcl = (zzcl) fieldDescriptor.getProperty(zzcl.class);
        if (zzcl != null) {
            return zzcl;
        }
    ...
    private final <T> zzcn zzk(ObjectEncoder<T> objectEncoder, FieldDescriptor fieldDescriptor, T t, boolean z) throws IOException {
    ...
    private final <T> zzcn zzl(ValueEncoder<T> valueEncoder, FieldDescriptor fieldDescriptor, T t, boolean z) throws IOException {
    ...
    public final ObjectEncoderContext zzc(FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
        ...
        if (obj instanceof CharSequence) {
            ...
            if (valueEncoder != null) {
                ...
                return this;
            } else if (obj instanceof zzcj) {
                zzd(fieldDescriptor, ((zzcj) obj).zza(), true);
                return this;
    ...
    /* access modifiers changed from: package-private */
    public final zzcn zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
        zzcl zzj = zzj(fieldDescriptor);
        zzck zzck = zzck.DEFAULT;
    ...
    /* access modifiers changed from: package-private */
    public final zzcn zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzcl zzj = zzj(fieldDescriptor);
    ...
    /* access modifiers changed from: package-private */
    public final zzcn zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = this.zzf.get(obj.getClass());
