...
public final class zznh implements zzng {
    ...
    static {
        ...
        zza = zzhr.zzc("measurement.ad_id_cache_time", FetchDefaults.DEFAULT_NOTIFICATION_TIMEOUT_AFTER);
        ...
        zzo = zzhr.zzc("measurement.upload.realtime_upload_interval", FetchDefaults.DEFAULT_NOTIFICATION_TIMEOUT_AFTER);
