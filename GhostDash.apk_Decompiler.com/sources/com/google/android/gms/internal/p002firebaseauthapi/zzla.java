...
final class zzla {
    ...
    private static long zzc(byte[] bArr, int i) {
        return ((long) (((bArr[i + 3] & UByte.MAX_VALUE) << 24) | (bArr[i] & UByte.MAX_VALUE) | ((bArr[i + 1] & UByte.MAX_VALUE) << 8) | ((bArr[i + 2] & UByte.MAX_VALUE) << Tnaf.POW_2_WIDTH))) & BodyPartID.bodyIdMax;
    }
        ...
        if (bArr3.length == 32) {
            ...
            while (true) {
                ...
                if (i3 < length) {
                    ...
                    long zzc = (((j23 & j30) | (j25 & 67108863 & j31) | (j32 << 26)) & BodyPartID.bodyIdMax) + zzc(bArr3, 16);
                    long zzc2 = (((j32 >> 6) | (j33 << 20)) & BodyPartID.bodyIdMax) + zzc(bArr3, 20) + (zzc >> 32);
                    long zzc3 = (((j33 >> 12) | (j34 << 14)) & BodyPartID.bodyIdMax) + zzc(bArr3, 24) + (zzc2 >> 32);
                    long zzc4 = zzc(bArr3, 28);
                    byte[] bArr6 = new byte[16];
                    zzd(bArr6, zzc & BodyPartID.bodyIdMax, 0);
                    zzd(bArr6, zzc2 & BodyPartID.bodyIdMax, 4);
                    zzd(bArr6, zzc3 & BodyPartID.bodyIdMax, 8);
                    zzd(bArr6, ((((((j29 & j31) | (j30 & j21)) << 8) | (j34 >> 18)) & BodyPartID.bodyIdMax) + zzc4 + (zzc3 >> 32)) & BodyPartID.bodyIdMax, 12);
                    return bArr6;
                }
            }
        } else {
