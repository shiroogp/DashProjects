...
public final class zzwq extends AbstractSafeParcelable implements zzuj<zzwq> {
    ...
    public final boolean zzj() {
        return DefaultClock.getInstance().currentTimeMillis() + FetchDefaults.DEFAULT_HAS_ACTIVE_DOWNLOADS_INTERVAL_IN_MILLISECONDS < this.zzf.longValue() + (this.zzd.longValue() * 1000);
    }
