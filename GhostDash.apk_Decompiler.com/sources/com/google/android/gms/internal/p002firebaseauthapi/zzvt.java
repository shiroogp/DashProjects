...
public final class zzvt implements zzuj<zzvt> {
    ...
    public final zzvt zzb(String str) throws zzpz {
        try {
            JSONObject jSONObject = new JSONObject(new JSONObject(str).getString(ReactVideoView.EVENT_PROP_ERROR));
            jSONObject.getInt("code");
            this.zzb = jSONObject.getString(FFmpegKitReactNativeModule.KEY_LOG_MESSAGE);
            return this;
