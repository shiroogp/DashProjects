...
public class GoogleApiManager implements Handler.Callback {
    ...
    /* access modifiers changed from: private */
    public long zag = FetchDefaults.DEFAULT_NOTIFICATION_TIMEOUT_AFTER;
    /* access modifiers changed from: private */
    ...
    public final boolean handleMessage(Message message) {
        int i = message.what;
        long j = FetchDefaults.DEFAULT_HAS_ACTIVE_DOWNLOADS_INTERVAL_IN_MILLISECONDS;
        zabq zabq = null;
        switch (i) {
            case 1:
                if (true == ((Boolean) message.obj).booleanValue()) {
                    j = FetchDefaults.DEFAULT_NOTIFICATION_TIMEOUT_AFTER;
                }
                this.zag = j;
            ...
            case 6:
                if (this.zak.getApplicationContext() instanceof Application) {
                    ...
                    if (!BackgroundDetector.getInstance().readCurrentStateIfPossible(true)) {
                        this.zag = FetchDefaults.DEFAULT_HAS_ACTIVE_DOWNLOADS_INTERVAL_IN_MILLISECONDS;
                        break;
                    }
                }
                break;
