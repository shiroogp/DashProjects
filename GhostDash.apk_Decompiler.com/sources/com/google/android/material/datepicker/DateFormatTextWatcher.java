...
abstract class DateFormatTextWatcher implements TextWatcher {
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        try {
            ...
            this.textInputLayout.setError(string + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + format + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + String.format(this.textInputLayout.getContext().getString(R.string.mtrl_picker_invalid_format_example), new Object[]{this.dateFormat.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))}));
            onInvalidDate();
        }
    }
}
