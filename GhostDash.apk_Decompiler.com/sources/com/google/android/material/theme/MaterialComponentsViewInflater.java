...
public class MaterialComponentsViewInflater extends AppCompatViewInflater {
    ...
    public boolean shouldInflateAppCompatButton(Context context, AttributeSet attributeSet) {
        ...
        if (floatingToolbarItemBackgroundResId == -1) {
            floatingToolbarItemBackgroundResId = context.getResources().getIdentifier("floatingToolbarItemBackgroundDrawable", "^attr-private", FFmpegKitReactNativeModule.PLATFORM_NAME);
        }
