...
final class CctTransportBackend implements TransportBackend {
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        ...
        try {
            ...
            return new HttpResponse(CropImageView.DEFAULT_IMAGE_TO_CROP_BOUNDS_ANIM_DURATION, (URL) null, 0);
        } catch (EncodingException | IOException e2) {
            Logging.e(LOG_TAG, "Couldn't encode request, returning with 400", e2);
            return new HttpResponse(StatFsHelper.DEFAULT_DISK_YELLOW_LEVEL_IN_MB, (URL) null, 0);
        } catch (Throwable th4) {
