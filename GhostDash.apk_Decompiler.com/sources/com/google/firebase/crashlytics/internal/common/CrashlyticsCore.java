    ...
    public boolean onPreExecute(AppData appData, SettingsDataProvider settingsDataProvider) {
        ...
        if (isBuildIdValid(appData.buildId, CommonUtils.getBooleanResourceValue(this.context, CRASHLYTICS_REQUIRE_BUILD_ID, true))) {
            ...
            try {
                ...
                String str = clsuuid;
                this.controller = new CrashlyticsController(context3, crashlyticsBackgroundWorker2, idManager2, dataCollectionArbiter2, fileStore2, crashlyticsFileMarker, appData, userMetadata2, logFileManager2, create, this.nativeComponent, this.analyticsEventLogger);
