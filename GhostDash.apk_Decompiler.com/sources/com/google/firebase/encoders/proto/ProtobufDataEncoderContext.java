...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private void writeVarInt32(int i) throws IOException {
        while (((long) (i & -128)) != 0) {
            this.output.write((i & CertificateBody.profileType) | 128);
            i >>>= 7;
        }
        this.output.write(i & CertificateBody.profileType);
    }

    private void writeVarInt64(long j) throws IOException {
        while ((-128 & j) != 0) {
            this.output.write((((int) j) & CertificateBody.profileType) | 128);
            j >>>= 7;
        }
        this.output.write(((int) j) & CertificateBody.profileType);
    }
}
