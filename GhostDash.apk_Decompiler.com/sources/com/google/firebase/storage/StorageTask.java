...
public abstract class StorageTask<ResultT extends ProvideError> extends ControllableTask<ResultT> {
    ...
    final TaskListenerImpl<OnCanceledListener, ResultT> cancelManager = new TaskListenerImpl<>(this, 256, new TaskListenerImpl.OnRaise() {
    ...
    final TaskListenerImpl<OnCompleteListener<ResultT>, ResultT> completeListener = new TaskListenerImpl<>(this, STATES_COMPLETE, new TaskListenerImpl.OnRaise() {
        public final void raise(Object obj, Object obj2) {
            StorageTask.this.lambda$new$2$StorageTask((OnCompleteListener) obj, (StorageTask.ProvideError) obj2);
        }
    });
    private volatile int currentState = 1;
    final TaskListenerImpl<OnFailureListener, ResultT> failureManager = new TaskListenerImpl<>(this, 64, new TaskListenerImpl.OnRaise() {
        public final void raise(Object obj, Object obj2) {
            StorageTask.this.lambda$new$1$StorageTask((OnFailureListener) obj, (StorageTask.ProvideError) obj2);
        }
    });
    private ResultT finalResult;
    final TaskListenerImpl<OnPausedListener<? super ResultT>, ResultT> pausedManager = new TaskListenerImpl<>(this, 16, $$Lambda$HI9VWfkLzWJEKLQBX3mZC5p1s.INSTANCE);
    final TaskListenerImpl<OnProgressListener<? super ResultT>, ResultT> progressManager = new TaskListenerImpl<>(this, STATES_INPROGRESS, $$Lambda$XYrrQpsB_p_00PPOCyqc7ym51TA.INSTANCE);
    final TaskListenerImpl<OnSuccessListener<? super ResultT>, ResultT> successManager = new TaskListenerImpl<>(this, 128, new TaskListenerImpl.OnRaise() {
        public final void raise(Object obj, Object obj2) {
    ...
    private <ContinuationResultT> Task<ContinuationResultT> continueWithImpl(Executor executor, Continuation<ResultT, ContinuationResultT> continuation) {
        ...
        this.completeListener.addListener((Activity) null, executor, new OnCompleteListener(continuation, taskCompletionSource) {
            ...
            public final void onComplete(Task task) {
                StorageTask.this.lambda$continueWithImpl$4$StorageTask(this.f$1, this.f$2, task);
            }
        });
    ...
    private <ContinuationResultT> Task<ContinuationResultT> continueWithTaskImpl(Executor executor, Continuation<ResultT, Task<ContinuationResultT>> continuation) {
        ...
        this.completeListener.addListener((Activity) null, executor, new OnCompleteListener(continuation, taskCompletionSource, cancellationTokenSource) {
            public final /* synthetic */ Continuation f$1;
            public final /* synthetic */ TaskCompletionSource f$2;
            ...
            public final void onComplete(Task task) {
                StorageTask.this.lambda$continueWithTaskImpl$5$StorageTask(this.f$1, this.f$2, this.f$3, task);
            }
        });
        return taskCompletionSource.getTask();
    }
    ...
    public /* synthetic */ void lambda$continueWithTaskImpl$5$StorageTask(Continuation continuation, TaskCompletionSource taskCompletionSource, CancellationTokenSource cancellationTokenSource, Task task) {
        try {
            ...
            task2.addOnCanceledListener(new OnCanceledListener() {
    ...
    private <ContinuationResultT> Task<ContinuationResultT> successTaskImpl(Executor executor, SuccessContinuation<ResultT, ContinuationResultT> successContinuation) {
        CancellationTokenSource cancellationTokenSource = new CancellationTokenSource();
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource(cancellationTokenSource.getToken());
        this.successManager.addListener((Activity) null, executor, new OnSuccessListener(taskCompletionSource, cancellationTokenSource) {
            ...
            public final void onSuccess(Object obj) {
                StorageTask.lambda$successTaskImpl$6(SuccessContinuation.this, this.f$1, this.f$2, (StorageTask.ProvideError) obj);
            }
        });
        return taskCompletionSource.getTask();
    }
    ...
    static /* synthetic */ void lambda$successTaskImpl$6(SuccessContinuation successContinuation, TaskCompletionSource taskCompletionSource, CancellationTokenSource cancellationTokenSource, ProvideError provideError) {
        try {
            ...
            Objects.requireNonNull(taskCompletionSource);
            then.addOnSuccessListener(new OnSuccessListener() {
                public final void onSuccess(Object obj) {
                    TaskCompletionSource.this.setResult(obj);
                }
            });
            Objects.requireNonNull(taskCompletionSource);
            then.addOnFailureListener(new OnFailureListener() {
                public final void onFailure(Exception exc) {
                    TaskCompletionSource.this.setException(exc);
                }
            });
            Objects.requireNonNull(cancellationTokenSource);
            then.addOnCanceledListener(new OnCanceledListener() {
                public final void onCanceled() {
                    CancellationTokenSource.this.cancel();
                }
            });
