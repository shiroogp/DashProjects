...
public class LogWrapper {
    ...
    public void error(String str, Throwable th) {
        this.logger.onLogMessage(Logger.Level.ERROR, this.component, toLog(str, new Object[0]) + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + exceptionStacktrace(th), now());
    }
    ...
    public void warn(String str, Throwable th) {
        ...
        if (th != null) {
            log = log + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + exceptionStacktrace(th);
        }
