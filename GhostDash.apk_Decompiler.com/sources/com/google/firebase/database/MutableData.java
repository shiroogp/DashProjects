...
public class MutableData {
    ...
    public Iterable<MutableData> getChildren() {
        ...
        final Iterator<NamedNode> it2 = IndexedNode.from(node).iterator();
        return new Iterable<MutableData>() {
            public Iterator<MutableData> iterator() {
                return new Iterator<MutableData>() {
                    public boolean hasNext() {
                    ...
                    public MutableData next() {
                        return new MutableData(MutableData.this.holder, MutableData.this.prefixPath.child(((NamedNode) it2.next()).getName()));
                    }
