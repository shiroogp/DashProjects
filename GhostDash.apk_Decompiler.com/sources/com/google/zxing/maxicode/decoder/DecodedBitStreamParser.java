...
final class DecodedBitStreamParser {
    ...
    private static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, 42, 31, RevocationReasonTags.USER_NO_LONGER_VALID});
    }
