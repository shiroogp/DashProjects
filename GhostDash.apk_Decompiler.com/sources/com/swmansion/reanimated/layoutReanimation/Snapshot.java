...
public class Snapshot {
    ...
    public static ArrayList<String> currentKeysToTransform = new ArrayList<>(Arrays.asList(new String[]{CURRENT_WIDTH, CURRENT_HEIGHT, CURRENT_ORIGIN_X, CURRENT_ORIGIN_Y, CURRENT_GLOBAL_ORIGIN_X, CURRENT_GLOBAL_ORIGIN_Y}));
    public static ArrayList<String> targetKeysToTransform = new ArrayList<>(Arrays.asList(new String[]{TARGET_WIDTH, TARGET_HEIGHT, TARGET_ORIGIN_X, TARGET_ORIGIN_Y, TARGET_GLOBAL_ORIGIN_X, TARGET_GLOBAL_ORIGIN_Y}));
