    ...
    public synchronized void manageChildren(int i, int[] iArr, ViewAtIndex[] viewAtIndexArr, int[] iArr2) {
        ...
        try {
            ...
            if (this.toBeRemoved.containsKey(Integer.valueOf(i))) {
                ...
                while (it2.hasNext()) {
                    hashSet.add(Integer.valueOf(((View) it2.next()).getId()));
                }
            ...
            if (iArr2 != null) {
                ...
                while (i2 < length2) {
                    try {
                        ...
                        this.cleanerCallback.put(Integer.valueOf(resolveView.getId()), new Runnable(arrayList, resolveView, viewGroupManager, viewGroup) {
            ...
            if (this.toBeRemoved.containsKey(Integer.valueOf(i))) {
                Iterator it3 = this.toBeRemoved.get(Integer.valueOf(i)).iterator();
                while (it3.hasNext()) {
                    viewGroupManager.addView(viewGroup, (View) it3.next(), viewGroupManager.getChildCount(viewGroup));
                }
            }
