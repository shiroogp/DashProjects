...
public class LayoutAnimations {
    ...
    public native void cancelAnimationForTag(int i, int i2, boolean z, boolean z2);
    ...
    private void endLayoutAnimation(int i, boolean z, boolean z2) {
        AnimationsManager animationsManager = getAnimationsManager();
        if (animationsManager != null) {
            animationsManager.endLayoutAnimation(i, z, z2);
        }
    }
