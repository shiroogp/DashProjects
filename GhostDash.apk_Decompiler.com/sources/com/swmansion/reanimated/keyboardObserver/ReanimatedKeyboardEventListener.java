...
public class ReanimatedKeyboardEventListener {
    ...
    public void setupWindowInsets() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(rootView, new OnApplyWindowInsetsListener(rootView) {
            ...
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                return ReanimatedKeyboardEventListener.this.lambda$setupWindowInsets$0$ReanimatedKeyboardEventListener(this.f$1, view, windowInsetsCompat);
            }
        });
    }

    public /* synthetic */ WindowInsetsCompat lambda$setupWindowInsets$0$ReanimatedKeyboardEventListener(View view, View view2, WindowInsetsCompat windowInsetsCompat) {
    ...
    private class WindowInsetsCallback extends WindowInsetsAnimationCompat.Callback {
        ...
        public WindowInsetsAnimationCompat.BoundsCompat onStart(WindowInsetsAnimationCompat windowInsetsAnimationCompat, WindowInsetsAnimationCompat.BoundsCompat boundsCompat) {
            KeyboardState unused = ReanimatedKeyboardEventListener.this.state = this.keyboardHeight == 0 ? KeyboardState.OPENING : KeyboardState.CLOSING;
        ...
        public void onEnd(WindowInsetsAnimationCompat windowInsetsAnimationCompat) {
            KeyboardState unused = ReanimatedKeyboardEventListener.this.state = this.keyboardHeight == 0 ? KeyboardState.CLOSED : KeyboardState.OPEN;
            ReanimatedKeyboardEventListener.this.updateKeyboard(this.keyboardHeight);
        }
    }
