...
public final class PanGestureHandler extends GestureHandler<PanGestureHandler> {
    ...
    private final Runnable activateDelayed = new Runnable() {
        public final void run() {
            PanGestureHandler.m13activateDelayed$lambda0(PanGestureHandler.this);
        }
    };
    ...
    public static final void m13activateDelayed$lambda0(PanGestureHandler panGestureHandler) {
