...
public final class RNGestureHandlerRootHelper {
    ...
    public static final void m20handleSetJSResponder$lambda6(RNGestureHandlerRootHelper rNGestureHandlerRootHelper) {
        ...
        if (z) {
            UiThreadUtil.runOnUiThread(new Runnable() {
                public final void run() {
                    RNGestureHandlerRootHelper.m20handleSetJSResponder$lambda6(RNGestureHandlerRootHelper.this);
                }
            });
        }
    }
