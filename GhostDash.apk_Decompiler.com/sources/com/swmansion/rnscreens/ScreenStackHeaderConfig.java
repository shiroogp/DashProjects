    ...
    public void onAttachedToWindow() {
        ...
        if (this.headerTopInset == null) {
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                num = Integer.valueOf((int) (((float) 25) * resources.getDisplayMetrics().density));
            }
