...
final class ListenerCoordinator$mainListener$1$onWaitingNetwork$$inlined$synchronized$lambda$1 implements Runnable {
    ...
    ListenerCoordinator$mainListener$1$onWaitingNetwork$$inlined$synchronized$lambda$1(FetchListener fetchListener, ListenerCoordinator$mainListener$1 listenerCoordinator$mainListener$1, Download download) {
    ...
    public final void run() {
        this.$fetchListener.onWaitingNetwork(this.$download$inlined);
    }
}
