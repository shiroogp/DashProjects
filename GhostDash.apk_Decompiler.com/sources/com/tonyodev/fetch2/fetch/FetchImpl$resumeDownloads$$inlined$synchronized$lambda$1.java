...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002¨\u0006\u0003"}, d2 = {"<anonymous>", "", "invoke", "com/tonyodev/fetch2/fetch/FetchImpl$resumeDownloads$1$1"}, k = 3, mv = {1, 1, 16})
/* compiled from: FetchImpl.kt */
final class FetchImpl$resumeDownloads$$inlined$synchronized$lambda$1 extends Lambda implements Function0<Unit> {
    ...
    FetchImpl$resumeDownloads$$inlined$synchronized$lambda$1(FetchImpl fetchImpl, List list, Integer num, Func func, Func func2) {
        super(0);
    ...
    public final void invoke() {
        ...
        try {
            if (this.$ids$inlined != null) {
                list = this.this$0.fetchHandler.resume(this.$ids$inlined);
            } else if (this.$groupId$inlined != null) {
                list = this.this$0.fetchHandler.resumeGroup(this.$groupId$inlined.intValue());
            } else {
            ...
            for (Download download : list) {
                ...
                this.this$0.listenerCoordinator.getMainListener().onResumed(download);
            }
            this.this$0.uiHandler.post(new Runnable(this) {
                final /* synthetic */ FetchImpl$resumeDownloads$$inlined$synchronized$lambda$1 this$0;
