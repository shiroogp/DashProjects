...
final class ListenerCoordinator$mainListener$1$onError$$inlined$synchronized$lambda$3 implements Runnable {
    ...
    ListenerCoordinator$mainListener$1$onError$$inlined$synchronized$lambda$3(FetchObserver fetchObserver, ListenerCoordinator$mainListener$1 listenerCoordinator$mainListener$1, Download download, Error error, Throwable th) {
    ...
    public final void run() {
        this.$observer.onChanged(this.$download$inlined, Reason.DOWNLOAD_ERROR);
    }
}
