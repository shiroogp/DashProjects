...
final class ListenerCoordinator$mainListener$1$onStarted$$inlined$synchronized$lambda$1 implements Runnable {
    final /* synthetic */ Download $download$inlined;
    final /* synthetic */ List $downloadBlocks$inlined;
    final /* synthetic */ int $totalBlocks$inlined;
    final /* synthetic */ ListenerCoordinator$mainListener$1 this$0;

    ListenerCoordinator$mainListener$1$onStarted$$inlined$synchronized$lambda$1(ListenerCoordinator$mainListener$1 listenerCoordinator$mainListener$1, Download download, List list, int i) {
    ...
    public final void run() {
        ...
        L_0x002d:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tonyodev.fetch2.fetch.ListenerCoordinator$mainListener$1$onStarted$$inlined$synchronized$lambda$1.run():void");
    }
}
