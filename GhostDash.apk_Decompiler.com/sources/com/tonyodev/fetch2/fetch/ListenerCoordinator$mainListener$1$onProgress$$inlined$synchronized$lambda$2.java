...
final class ListenerCoordinator$mainListener$1$onProgress$$inlined$synchronized$lambda$2 implements Runnable {
    ...
    ListenerCoordinator$mainListener$1$onProgress$$inlined$synchronized$lambda$2(FetchListener fetchListener, ListenerCoordinator$mainListener$1 listenerCoordinator$mainListener$1, Download download, long j, long j2) {
    ...
    public final void run() {
        this.$fetchListener.onProgress(this.$download$inlined, this.$etaInMilliSeconds$inlined, this.$downloadedBytesPerSecond$inlined);
    }
}
