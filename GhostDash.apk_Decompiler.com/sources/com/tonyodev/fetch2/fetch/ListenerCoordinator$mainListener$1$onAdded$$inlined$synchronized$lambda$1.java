...
final class ListenerCoordinator$mainListener$1$onAdded$$inlined$synchronized$lambda$1 implements Runnable {
    ...
    ListenerCoordinator$mainListener$1$onAdded$$inlined$synchronized$lambda$1(FetchListener fetchListener, ListenerCoordinator$mainListener$1 listenerCoordinator$mainListener$1, Download download) {
    ...
    public final void run() {
        this.$fetchListener.onAdded(this.$download$inlined);
    }
}
