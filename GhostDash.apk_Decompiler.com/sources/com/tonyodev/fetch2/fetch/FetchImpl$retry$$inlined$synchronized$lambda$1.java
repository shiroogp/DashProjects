...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002¨\u0006\u0003"}, d2 = {"<anonymous>", "", "invoke", "com/tonyodev/fetch2/fetch/FetchImpl$retry$1$1"}, k = 3, mv = {1, 1, 16})
/* compiled from: FetchImpl.kt */
final class FetchImpl$retry$$inlined$synchronized$lambda$1 extends Lambda implements Function0<Unit> {
    ...
    FetchImpl$retry$$inlined$synchronized$lambda$1(FetchImpl fetchImpl, List list, Func func, Func func2) {
        super(0);
    ...
    public final void invoke() {
        try {
            final List<Download> retry = this.this$0.fetchHandler.retry(this.$ids$inlined);
            ...
            this.this$0.uiHandler.post(new Runnable(this) {
                final /* synthetic */ FetchImpl$retry$$inlined$synchronized$lambda$1 this$0;
