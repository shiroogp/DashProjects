...
final class ListenerCoordinator$mainListener$1$onQueued$$inlined$synchronized$lambda$2 implements Runnable {
    ...
    ListenerCoordinator$mainListener$1$onQueued$$inlined$synchronized$lambda$2(FetchObserver fetchObserver, ListenerCoordinator$mainListener$1 listenerCoordinator$mainListener$1, Download download, boolean z) {
    ...
    public final void run() {
        this.$observer.onChanged(this.$download$inlined, Reason.DOWNLOAD_QUEUED);
    }
}
