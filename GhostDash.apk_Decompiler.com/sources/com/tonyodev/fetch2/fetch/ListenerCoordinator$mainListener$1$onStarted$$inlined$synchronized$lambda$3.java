...
final class ListenerCoordinator$mainListener$1$onStarted$$inlined$synchronized$lambda$3 implements Runnable {
    ...
    ListenerCoordinator$mainListener$1$onStarted$$inlined$synchronized$lambda$3(FetchObserver fetchObserver, ListenerCoordinator$mainListener$1 listenerCoordinator$mainListener$1, Download download, List list, int i) {
    ...
    public final void run() {
        this.$observer.onChanged(this.$download$inlined, Reason.DOWNLOAD_STARTED);
    }
}
