...
final class FetchImpl$deleteAllInGroupWithStatus$1 extends Lambda implements Function0<List<? extends Download>> {
    final /* synthetic */ int $id;
    final /* synthetic */ List $statuses;
    final /* synthetic */ FetchImpl this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FetchImpl$deleteAllInGroupWithStatus$1(FetchImpl fetchImpl, int i, List list) {
        super(0);
