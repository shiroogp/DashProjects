...
final class ListenerCoordinator$mainListener$1$onCompleted$$inlined$synchronized$lambda$2 implements Runnable {
    ...
    ListenerCoordinator$mainListener$1$onCompleted$$inlined$synchronized$lambda$2(FetchListener fetchListener, ListenerCoordinator$mainListener$1 listenerCoordinator$mainListener$1, Download download) {
    ...
    public final void run() {
        this.$fetchListener.onCompleted(this.$download$inlined);
    }
}
