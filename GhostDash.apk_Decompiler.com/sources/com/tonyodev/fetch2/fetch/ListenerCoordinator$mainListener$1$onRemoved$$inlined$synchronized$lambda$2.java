...
final class ListenerCoordinator$mainListener$1$onRemoved$$inlined$synchronized$lambda$2 implements Runnable {
    ...
    ListenerCoordinator$mainListener$1$onRemoved$$inlined$synchronized$lambda$2(FetchListener fetchListener, ListenerCoordinator$mainListener$1 listenerCoordinator$mainListener$1, Download download) {
    ...
    public final void run() {
        this.$fetchListener.onRemoved(this.$download$inlined);
    }
}
