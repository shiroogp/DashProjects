...
final class ListenerCoordinator$mainListener$1$onQueued$$inlined$synchronized$lambda$1 implements Runnable {
    final /* synthetic */ Download $download$inlined;
    final /* synthetic */ FetchListener $fetchListener;
    final /* synthetic */ boolean $waitingOnNetwork$inlined;
    final /* synthetic */ ListenerCoordinator$mainListener$1 this$0;

    ListenerCoordinator$mainListener$1$onQueued$$inlined$synchronized$lambda$1(FetchListener fetchListener, ListenerCoordinator$mainListener$1 listenerCoordinator$mainListener$1, Download download, boolean z) {
    ...
    public final void run() {
        this.$fetchListener.onQueued(this.$download$inlined, this.$waitingOnNetwork$inlined);
    }
}
