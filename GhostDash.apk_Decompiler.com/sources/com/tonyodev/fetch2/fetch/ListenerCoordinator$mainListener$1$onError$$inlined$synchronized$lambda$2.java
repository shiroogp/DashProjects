...
final class ListenerCoordinator$mainListener$1$onError$$inlined$synchronized$lambda$2 implements Runnable {
    ...
    ListenerCoordinator$mainListener$1$onError$$inlined$synchronized$lambda$2(FetchListener fetchListener, ListenerCoordinator$mainListener$1 listenerCoordinator$mainListener$1, Download download, Error error, Throwable th) {
    ...
    public final void run() {
        this.$fetchListener.onError(this.$download$inlined, this.$error$inlined, this.$throwable$inlined);
    }
}
