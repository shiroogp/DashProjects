var PropTypes = require('prop-types'),
  ...
  n = {
    ...
    scaleX: module76(PropTypes.number, 'Use the transform prop instead.'),
    scaleY: module76(PropTypes.number, 'Use the transform prop instead.'),
    rotation: module76(PropTypes.number, 'Use the transform prop instead.'),
    translateX: module76(PropTypes.number, 'Use the transform prop instead.'),
    translateY: module76(PropTypes.number, 'Use the transform prop instead.'),
  };
