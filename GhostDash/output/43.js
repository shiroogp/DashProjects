...
class b {
  ...
  removeCurrentListener() {
    module6(!!this._currentSubscription, 'Not in an emitting cycle; there is no current subscription');
    this.removeSubscription(this._currentSubscription);
  }

  removeSubscription(t) {
    module6(t.emitter === this, 'Subscription does not belong to this emitter.');
