...
function l(t) {
  var s = c.pickScale(t.scales, module62.get()),
    o = 1 === s ? '' : '@' + s + 'x';
  return module188.getBasePath(t) + '/' + t.name + o + '.' + t.type;
}

function h(t) {
  var s = c.pickScale(t.scales, module62.get());
  return module188.getAndroidResourceFolderName(t, s) + '/' + module188.getAndroidResourceIdentifier(t) + '.' + t.type;
}
  ...
  module28(
    ...
    [
      ...
      },
      {
        key: 'assetServerURL',
        value: function () {
          module6(!!this.serverUrl, 'need server to load from');
      ...
      },
      {
        ...
        value: function () {
          module6(true, 'resource identifiers work on Android');
          return this.fromSource(module188.getAndroidResourceIdentifier(this.asset));
        },
      },
      {
