...
if os.path.exists("/.local/share/Boosted Garage/BoostedGarage/remotedash.cfg"):
	try:
...
if os.path.exists("/dev/ttyUSB1"):
	...
	chgps=sergps.read(size=1)
        ...
        while o<>36 and scant<500:
           #pygame.draw.rect(background,(250,250,250),(200,450,450,30))
           #font = pygame.font.Font(None, 30)
           #text = font.render("SCANNING GPS MODULE ",2,(0,0,0))
           #textpos.top = 450
           #textpos.left = 200
           #background.blit(text,textpos)
           #screen.blit(background,(0,0))
...
if reload==1 and os.path.exists("/dev/ttyUSB1"):
                        #pygame.draw.rect(background,(250,250,250),(200,450,450,30))
                        #font = pygame.font.Font(None, 30)
                        #text = font.render("RELOADING GPS MODULE DATA",2,(0,0,0))
                        #textpos.top = 450
                        #textpos.left = 200
                        #background.blit(text,textpos)
			#screen.blit(background,(0,0))
...
while True:
	try:
		if screen_view==11:
	                ...
	                #pygame.draw.rect(background,black,(0,0,800,480))
			disp_start=0
			#font = pygame.font.Font(None, 25)
			#text = font.render("SET No: " + str(set_conf),2,cyan)
                        #textpos.top = 0
                        #textpos.left = 600
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				disp_color=cyan
			else:
				disp_color=white
			disp_start=disp_start+1
			#text = font.render("Shift Light Max:",2,disp_color)
                        #textpos.top = 0
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("Shift Light Step:",2,disp_color)
                        #textpos.top = 25
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("Max Boost Alarm:",2,disp_color)
                        #textpos.top = 50
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("Oil Temp/Fuel Press Alarm:",2,disp_color)
                        #textpos.top = 75
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("Oil Press Alarm:",2,disp_color)
                        #textpos.top = 100
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("Water Temp Alarm:",2,disp_color)
                        #textpos.top = 125
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("Battery V Alarm:",2,disp_color)
                        #textpos.top = 150
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("Air Fuel R Alarm:",2,disp_color)
                        #textpos.top = 175
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("MAP Sensor Type:",2,disp_color)
                        #textpos.top = 200
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("Lap Trig Circle:",2,disp_color)
                        #textpos.top = 225
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("Analog Inp Mode:",2,disp_color)
                        #textpos.top = 250
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
			...
			disp_start=disp_start+1
			#if ecu_sel<2:
	                        #text = font.render("Ignition Preset:",2,disp_color)
			#else:
	                        #text = font.render("Cylinders:",2,disp_color)
                        #textpos.top = 275
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("Boot Up Screen:",2,disp_color)
                        #textpos.top = 300
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("G Force Meter On:",2,disp_color)
                        #textpos.top = 325
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("Additional ADC On:",2,disp_color)
                        #textpos.top = 350
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("GPS Sensor Select:",2,disp_color)
                        #textpos.top = 375
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("ECU Serial Type:",2,disp_color)
                        #textpos.top = 400
                        #textpos.left = 20
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render("Ratio kph@3000rpm:",2,disp_color)
                        #textpos.top = 425
                        #textpos.left = 20
                        #background.blit(text,textpos)
                        ...
                        if disp_start==set_conf:
                                ...
                                disp_color=white
                        disp_start=disp_start+1
                        #text = font.render("Water Temp Cal:",2,disp_color)
                        #textpos.top = 50
                        #textpos.left = 420
                        #background.blit(text,textpos)
                        if disp_start==set_conf:
                                ...
                                disp_color=white
                        disp_start=disp_start+1
                        #text = font.render("Air Temp Calibrate:",2,disp_color)
                        #textpos.top = 75
                        #textpos.left = 420
                        #background.blit(text,textpos)
                        if disp_start==set_conf:
                                ...
                                disp_color=white
                        disp_start=disp_start+1
                        #text = font.render("Oil Press Calibrate:",2,disp_color)
                        #textpos.top = 100
                        #textpos.left = 420
                        #background.blit(text,textpos)
                        if disp_start==set_conf:
                                ...
                                disp_color=white
                        disp_start=disp_start+1
                        #text = font.render("Analog2 Calibrate:",2,disp_color)
                        #textpos.top = 125
                        #textpos.left = 420
                        #background.blit(text,textpos)
                        if disp_start==set_conf:
                                ...
                                disp_color=white
                        disp_start=disp_start+1
                        #text = font.render("Kw Calibrate:",2,disp_color)
                        #textpos.top = 150
                        #textpos.left = 420
                        #background.blit(text,textpos)
                        ...
                        if disp_start==set_conf:
                                ...
                                disp_color=white
                        disp_start=disp_start+1
                        #text = font.render("Exit Setup Press (M) for 3 sec to save",2,disp_color)
                        #textpos.top = 200
                        #textpos.left = 400
                        #background.blit(text,textpos)
                        #text = font.render(" Press (M) < 1 sec to exit witout save",2,disp_color)
                        #textpos.top = 225
                        #textpos.left = 400
                        #background.blit(text,textpos)
			...
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
			#text = font.render(str(sl_max),2,disp_color)
                        #textpos.top = 0
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(sl_step),2,disp_color)
                        #textpos.top = 25
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(boost_lim),2,disp_color)
                        #textpos.top = 50
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(oiltemp_lim),2,disp_color)
                        #textpos.top = 75
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(oilpress_lim),2,disp_color)
                        #textpos.top = 100
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(watertemp_lim),2,disp_color)
                        #textpos.top = 125
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(batt_lim),2,disp_color)
                        #textpos.top = 150
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(afr_lim),2,disp_color)
                        #textpos.top = 175
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(map_kpa),2,disp_color)
                        #textpos.top = 200
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(lap_dia),2,disp_color)
                        #textpos.top = 225
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(an_mode),2,disp_color)
                        #textpos.top = 250
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(ign_trig),2,disp_color)
                        #textpos.top = 275
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(scr_view),2,disp_color)
                        #textpos.top = 300
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(adxl_s),2,disp_color)
                        #textpos.top = 325
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(adc_s),2,disp_color)
                        #textpos.top = 350
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(gps_sel),2,disp_color)
                        #textpos.top = 375
                        #textpos.left = 320
                        #background.blit(text,textpos)
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(ecu_sel),2,disp_color)
                        #textpos.top = 400
                        #textpos.left = 320
                        #background.blit(text,textpos)
			...
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(ratio),2,disp_color)
                        #textpos.top = 425
                        #textpos.left = 320
                        #background.blit(text,textpos)
			...
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(k_temp),2,disp_color)
                        #textpos.top = 50
                        #textpos.left = 720
                        #background.blit(text,textpos)
			...
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(ka_temp),2,disp_color)
                        #textpos.top = 75
                        #textpos.left = 720
                        #background.blit(text,textpos)
			...
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(k_an1),2,disp_color)
                        #textpos.top = 100
                        #textpos.left = 720
                        #background.blit(text,textpos)
			...
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(k_an2),2,disp_color)
                        #textpos.top = 125
                        #textpos.left = 720
                        #background.blit(text,textpos)
			...
			if disp_start==set_conf:
				...
				disp_color=white
			disp_start=disp_start+1
                        #text = font.render(str(kw_cal),2,disp_color)
                        #textpos.top = 150
                        #textpos.left = 720
                        #background.blit(text,textpos)
			...
			if uparrow==1:
				...
				if set_conf==1:
					sl_step=sl_step + 50
				if set_conf==2:
					boost_lim=boost_lim + 0.1
				if set_conf==3:
				    if an_mode<3:
					oiltemp_lim=oiltemp_lim + 1
				    else:
					oiltemp_lim=oiltemp_lim + 0.1
				if set_conf==4:
				    if an_mode==0 or an_mode==3:
					oilpress_lim=oilpress_lim + 0.1
				    else:
					oilpress_lim=oilpress_lim + 1
				if set_conf==5:
					watertemp_lim=watertemp_lim + 1
				if set_conf==6:
					batt_lim=batt_lim + 0.1
				if set_conf==7:
					afr_lim=afr_lim + 0.5
				if set_conf==8:
					map_kpa=map_kpa + 1
				if set_conf==9:
					lap_dia=lap_dia + 1
				if set_conf==10 and an_mode<4:
					an_mode=an_mode + 1
				if set_conf==11:
					ign_trig=ign_trig + 1
				if set_conf==12 and scr_view<12:
					scr_view=scr_view + 1
				if set_conf==13 and adxl_s<2:
					adxl_s=adxl_s + 1
				if set_conf==14 and adc_s<2:
					adc_s=adc_s + 1
				if set_conf==15 and gps_sel<1:
					gps_sel=gps_sel + 1
				if set_conf==16 and ecu_sel<300:
					ecu_sel=ecu_sel + 1
				if set_conf==17 and ratio<500:
					ratio=ratio + 1
				if set_conf==18 and k_temp>0:
					k_temp=k_temp + 0.1 
				if set_conf==19 and ka_temp>0:
					ka_temp=ka_temp + 0.1 
				if set_conf==20 and k_an1>0:
					k_an1=k_an1 + 0.1 
				if set_conf==21 and k_an2>0:
					k_an2=k_an2 + 0.1 
				if set_conf==22 and kw_cal>50:
					kw_cal=kw_cal + 1 
				time.sleep(.2)
			...
			if downarrow==1:
				...
				if set_conf==9:
					lap_dia=lap_dia - 1
				if set_conf==10 and an_mode>0:
					an_mode=an_mode - 1
				if set_conf==11:
					ign_trig=ign_trig - 1
				if set_conf==12 and scr_view>0:
					scr_view=scr_view - 1
				if set_conf==13 and adxl_s>=0:
					adxl_s=adxl_s - 1
				if set_conf==14 and adc_s>0:
					adc_s=adc_s - 1
				if set_conf==15 and gps_sel>0:
					gps_sel=gps_sel - 1
				if set_conf==16 and ecu_sel>0:
					ecu_sel=ecu_sel - 1 
				if set_conf==17 and ratio>0:
					ratio=ratio - 1 
				if set_conf==18 and k_temp>0:
					k_temp=k_temp - 0.1 
				if set_conf==19 and ka_temp>0:
			...
			if GPIO.input(22)==0 and en_buttons==1:
			  ...
			  disp_now=1 
	                  ...
	                  screen_init=0
			  screen_view=0
			  if GPIO.input(22)==0 and  set_conf==23 and en_buttons==1:
			    print "writing config file"
			    file = open("/home/pi/dash.cfg", "w")
			    file.write("Rpm max eg 6800:- " + "\n")
			    file.write(str(sl_max) + "\n")
			    file.write("Rpm sl step eg 150:- " + "\n")
			    file.write(str(sl_step) + "\n")
			    ...
			    file.write(str(ign_trig) + "\n")
			    file.write("Boot Screen eg 0=classic 1=data 2=gauge 3=laptimes 4=GPs 5=mapping 6=hi speed log :- " + "\n")
			    file.write(str(scr_view) + "\n")
			    file.write("Adxl Screen eg 0=no adxl345, 1=adxl345 present:- " + "\n")
			    file.write(str(adxl_s) + "\n")
			    file.write("Adc Screen eg 0=no Adc, 1=Adc present:- " + "\n")
			    file.write(str(adc_s) + "\n")
			    file.write("Gps Screen eg 0=no Gps, 1=Gps present:- " + "\n")
			    file.write(str(gps_sel) + "\n")
			    file.write("ECUs Type eg 0=PowerMods, 1=Gotech, 2=Dicktator:- " + "\n")
			    file.write(str(ecu_sel) + "\n")
			    file.write("Ratio:- Speed at 100kph in 4th " + "\n")
			    file.write(str(ratio) + "\n")
			    file.write("Temp Cal:- " + "\n")
			    file.write(str(k_temp) + "\n")
			    file.write("A Temp Cal:- " + "\n")
...
#                    if screen_view==4:
			...
			time.sleep(1)
                 ...
                 if 0==log_en:
                    if  rpmd>4500:
                        rpmhigh_count=rpmhigh_count+1
                    
                           
                    if  rpmd>4500 and rpmhigh_count>20 and log_on==0:
			  disp_now=1 
                          hour=strftime("%H",time.localtime())  
                          minute=strftime("%M",time.localtime())  
                          gettime=strftime("%H%M",time.localtime())
                          getdate=strftime("%d%b",time.localtime())
                          if os.path.exists("/media/Transcend/logs/"):
                            screen_init=0
                            log_on=1
                            if not os.path.exists("/media/Transcend/logs/" + getdate+ "/"):
                               os.makedirs("/media/Transcend/logs/" + getdate+ "/")
                            logfile = "/media/Transcend/logs/" + getdate + "/" + gettime + ".csv"
                            logdisp = (0,0,0)
                            f= open(logfile, "w")
                            f.write("PowerMods log file rpm triggered"+"\n")
                            f.write("ECU version1.0"+"\n")
                            f.write("\n")
                            if an_mode==0:
                                f.write("Count, RPM, Oil P, Oil T, MAP, Load Site, Water T, Air T, Cyl, Throttle, Volts, AFR, Ign A, Fuel mS, Acc mS, Lat G, Long G, Zaxis G, Speed, Vector, LAT, LONG, GPS Val, Gps Date, Gps Time, Last Lap, Lap Number, Lap Time, ADC 0, ADC WT, ADC OilT, ADC OilP, ADC FuelP, ADC 4, ADC 5, ADC 6, ADC 7, D Inp, RPM 2, WS "+"\n")
                            if an_mode==1:
                                f.write("Count, RPM, EGT 1, EGT 2, MAP, Load Site, Water T, Air T, Cyl, Throttle, Volts, AFR, Ign A, Fuel mS, Acc mS, Lat G, Long G, Zaxis G, Speed, Vector, LAT, LONG, GPS Val, Gps Date, Gps Time, Last Lap, Lap Number, Lap Time, ADC WT, ADC OilT, ADC OilP, ADC FuelP, ADC 4, ADC 5, ADC 6, ADC 7, D Inp, RPM 2, WS "+"\n")
                            if an_mode==2:
                                f.write("Count, RPM, DBW 1, DBW 2, MAP, Load Site, Water T, Air T, Cyl, Throttle, Volts, AFR, Ign A, Fuel mS, Acc mS, Lat G, Long G, Zaxis G, Speed, Vector, LAT, LONG, GPS Val, Gps Date, Gps Time, Last Lap, Lap Number, Lap Time, ADC WT, ADC OilT, ADC OilP, ADC FuelP, ADC 4, ADC 5, ADC 6, ADC 7, D Inp, RPM 2, WS "+"\n")
                            if an_mode==3:
                                f.write("Count, RPM, Oil P, Fuel P, MAP, Load Site, Water T, Air T, Cyl, Throttle, Volts, AFR, Ign A, Fuel mS, Acc mS, Lat G, Long G, Zaxis G, Speed, Vector, LAT, LONG, GPS Val, Gps Date, Gps Time, Last Lap, Lap Number, Lap Time, ADC WT, ADC OilT, ADC OilP, ADC FuelP, ADC 4, ADC 5, ADC 6, ADC 7, D Inp, RPM 2, WS "+"\n")
                            if dtset == 0:
                                ...
                                if minutes>59:
                                   hours=hours+1
                                   minutes=0
                                gpsdt =  str('%.0f' %hours) + ":" + str('%.0f' %minutes) + ":" + "00.000"
                                os.system('sudo date -u --set="%s"' % gpsdt)
                            ...
                            #font = pygame.font.Font(None,50)
                            #text = font.render("LOGGING STARTED RPM +4500" ,2,(logdisp))#
                            #textpos.top = 20
                            #textpos.left = 20
                            #background.blit(text,textpos)
                            #screen.blit(background,(0,0))
                            #font = pygame.font.Font(None,30)
                            #text = font.render(logfile ,2,(logdisp))
                            #textpos.top = 60
                            #textpos.left = 20
                            #background.blit(text,textpos)
                            #screen.blit(background,(0,0))
...
#				#Lap timer top right	
#				      if x>400 and y<240:	
#                                          testtime = float(time.time()) - float(start_time)
#					  if testtime>5: 
#						disp_now=1 
...
#				      if x>400 and y>240 and log_on==0:	
#				       disp_now=1 
#                                       hour=strftime("%H",time.localtime())  
#                                       minute=strftime("%M",time.localtime())  
#                                       gettime=strftime("%H%M",time.localtime())
...
#
#                                        f= open(logfile, "w")
#                                        f.write("PowerMods log file tsc user triggered"+"\n")
#                                        f.write("ECU version1.0"+"\n")
#                                        f.write("\n")
#                            		if an_mode==0:
#                                		f.write("Count, RPM, Oil P, Oil T, MAP, Load Site, Water T, Air T, Cyl, Throttle, Volts, AFR, Ign A, Fuel mS, Acc mS, Lat G, Long G, Zaxis G, Speed, Vector, LAT, LONG, GPS Val, Gps Date, Gps Time, Last Lap, Lap Number, Lap Time, ADC WT, ADC OilT, ADC OilP, ADC FuelP, ADC 4, ADC 5, ADC 6, ADC 7, D Inp, RPM 2, WS "+"\n")
#                            		if an_mode==1:
#                                		f.write("Count, RPM, EGT 1, EGT 2, MAP, Load Site, Water T, Air T, Cyl, Throttle, Volts, AFR, Ign A, Fuel mS, Acc mS, Lat G, Long G, Zaxis G, Speed, Vector, LAT, LONG, GPS Val, Gps Date, Gps Time, Last Lap, Lap Number, Lap Time, ADC WT, ADC OilT, ADC OilP, ADC FuelP, ADC 4, ADC 5, ADC 6, ADC 7, D Inp, RPM 2, WS "+"\n")
#                            		if an_mode==2:
#                                		f.write("Count, RPM, DBW 1, DBW 2, MAP, Load Site, Water T, Air T, Cyl, Throttle, Volts, AFR, Ign A, Fuel mS, Acc mS, Lat G, Long G, Zaxis G, Speed, Vector, LAT, LONG, GPS Val, Gps Date, Gps Time, Last Lap, Lap Number, Lap Time, ADC WT, ADC OilT, ADC OilP, ADC FuelP, ADC 4, ADC 5, ADC 6, ADC 7, D Inp, RPM 2, WS "+"\n")
...
#                                        #background.fill((100,100,100))
#                                        #font = pygame.font.Font(None,50)
#                                        #text = font.render("LOGGING STARTED TSC USER"  ,2,(logdisp))
#                                        #textpos.top = 20
#                                        #textpos.left = 20
#                                        #background.blit(text,textpos)
#                                        #screen.blit(background,(0,0))
...
#                                        	log_on=0
#                                        	f= open(logfile, "a")
#                                        	f.write("\n"+"log file stopped tsc user")
#                                        	f.close()
#                                        	log_en=0
#                                        	start_log_en=0
#                                        	#background.fill((100,100,100))
#                                        	#font = pygame.font.Font(None,50)
#                                        	#text = font.render("LOGGING STOPPED TSC USER" ,2,(0,0,0))
#                                        	#textpos.top = 20
#                                        	#textpos.left = 20
#                                        	#background.blit(text,textpos)
#                                        	#screen.blit(background,(0,0))
		...
		if ecu_sel<2:
		  n = ser.inWaiting()
                  while n>171:
                    ...
                    #print ("Serial read 1-86 : "+rawdata)
                    n = ser.inWaiting()
                  ...
                  if n>86:
                    ...
                    if 84==m:
                        ...
                        #print ("Serial read 2 = 64 : "+rawdata)
...
#Screen 7		-----------------------------------------------------------------------------
		  ...
		  gps_scan=0
		   ...
		   while gps_scan==0: 
			...
			gps_scan=1
                    ...
                    lattisend = str(latbit1)+str(latbit2)+str(latbit3)+str(latbit4)+str(latbit5)+str(latbit6)+str(latbit7)+str(latbit8)+str(latbit9) 
                    longisend = str(longbit1)+str(longbit2)+str(longbit3)+str(longbit4)+str(longbit5)+str(longbit6)+str(longbit7)+str(longbit8)+str(longbit9)+str(longbit10)
                    lattidir = str(latdirbit1)+str(latdirbit2)+str(latdirbit3)+str(latdirbit4)+str(latdirbit5)+str(latdirbit6)+str(latdirbit7)+str(latdirbit8)+str(latdirbit9) 
                    longidir = str(longdirbit1)+str(longdirbit2)+str(longdirbit3)+str(longdirbit4)+str(longdirbit5)+str(longdirbit6)+str(longdirbit7)+str(longdirbit8)+str(longdirbit9)+str(longdirbit10)
                    gpsssdata = "GPS~"+timegps+","+gpslockStr+","+lattisend+","+lattidir+","+longisend+","+longidir+","+speed+","+vector
		...
		if not os.path.exists("/dev/ttyUSB0"):
			...
			#font = pygame.font.Font(None,50)
        		#text = font.render("USB 0 FAIL" ,2,(255,0,0))
	        	#textpos.top = 200
	        	#textpos.left = 20
		        #background.blit(text,textpos)
	        	#screen.blit(background,(0,0))
		  ...
		  if not os.path.exists("/dev/ttyUSB1") and gps_sel==1:
                        background.fill(white)
			#font = pygame.font.Font(None,50)
        		#text = font.render("USB 1 FAIL" ,2,(255,0,0))
	        	#textpos.top = 200
	        	#textpos.left = 20
		        #background.blit(text,textpos)
	        	#screen.blit(background,(0,0))
	...
	boost+=0.1
#	if intspeed > 319:
#	    intspeed = randint(1,200)
#	if intrpm > 10000:
#	    intrpm = randint(100,9000)
#	if boost > 3:
#	    boost=0.1   
...
#				UDP_PORT_REMOTE=int(file.readline().strip())
	...
	if remotehost == 1:
		#print ("remote = 1")
		sock.sendto(gpsssdata, ('<broadcast>', UDP_PORT))
		sock.sendto("199,"+str(speedg), ('<broadcast>', UDP_PORT))
		sock.sendto("179,"+str(rpmd), ('<broadcast>', UDP_PORT))
		sock.sendto("6,"+str(afr), ('<broadcast>', UDP_PORT))
		sock.sendto("22,"+str(mapsensor), ('<broadcast>', UDP_PORT))
		sock.sendto("7,"+str(a_temp), ('<broadcast>', UDP_PORT))
		sock.sendto("109,"+str(x_lat), ('<broadcast>', UDP_PORT))
		sock.sendto("110,"+str(y_long), ('<broadcast>', UDP_PORT))
		sock.sendto("111,"+str(speedg), ('<broadcast>', UDP_PORT))
		sock.sendto("112,"+str(timegps), ('<broadcast>', UDP_PORT))
		sock.sendto("135,"+str(a_temp), ('<broadcast>', UDP_PORT))
		sock.sendto("142,"+str(afr), ('<broadcast>', UDP_PORT))
		sock.sendto("155,"+str(map_kpa), ('<broadcast>', UDP_PORT))
		sock.sendto("156,"+str(map_site), ('<broadcast>', UDP_PORT))
		sock.sendto("170,"+str(oil_temp), ('<broadcast>', UDP_PORT))
		sock.sendto("173,"+str(power), ('<broadcast>', UDP_PORT))
		sock.sendto("179,"+str(rpmd), ('<broadcast>', UDP_PORT))
		sock.sendto("202,"+str(tps), ('<broadcast>', UDP_PORT))
		sock.sendto("210,"+str(tps), ('<broadcast>', UDP_PORT))
		sock.sendto("228,"+str(volts), ('<broadcast>', UDP_PORT))
		if os.path.exists("/.local/share/Boosted Garage/BoostedGarage/remotedash.cfg"):
			remotehost = 1			
		else:
			remotehost = 0		
		...
		sock.sendto(gpsssdata, (UDP_IP, UDP_PORT))
		sock.sendto("199,"+str(speedg), (UDP_IP, UDP_PORT))
		sock.sendto("179,"+str(rpmd), (UDP_IP, UDP_PORT))
		sock.sendto("6,"+str(afr), (UDP_IP, UDP_PORT))
		sock.sendto("22,"+str(mapsensor), (UDP_IP, UDP_PORT))
		sock.sendto("7,"+str(a_temp), (UDP_IP, UDP_PORT))
		sock.sendto("109,"+str(x_lat), (UDP_IP, UDP_PORT))
		sock.sendto("110,"+str(y_long), (UDP_IP, UDP_PORT))
		sock.sendto("111,"+str(speedg), (UDP_IP, UDP_PORT))
		sock.sendto("112,"+str(timegps), (UDP_IP, UDP_PORT))
		sock.sendto("135,"+str(a_temp), (UDP_IP, UDP_PORT))
		sock.sendto("142,"+str(afr), (UDP_IP, UDP_PORT))
		sock.sendto("155,"+str(map_kpa), (UDP_IP, UDP_PORT))
		sock.sendto("156,"+str(map_site), (UDP_IP, UDP_PORT))
		sock.sendto("170,"+str(oil_temp), (UDP_IP, UDP_PORT))
		sock.sendto("173,"+str(power), (UDP_IP, UDP_PORT))
		sock.sendto("179,"+str(rpmd), (UDP_IP, UDP_PORT))
		sock.sendto("202,"+str(tps), (UDP_IP, UDP_PORT))
		sock.sendto("210,"+str(tps), (UDP_IP, UDP_PORT))
		sock.sendto("228,"+str(volts), (UDP_IP, UDP_PORT))
...
#			background.fill(white)
#			#font = pygame.font.Font(None,50)
#        		#text = font.render("SYSTEM FAIL" ,2,(255,0,0))
#	        	#textpos.top = 200
#	        	#textpos.left = 20
#		        #background.blit(text,textpos)
#	        	#screen.blit(background,(0,0))
#		        #pygame.display.flip()
#			time.sleep(3)
		#Do complete reboot rather than trying to fix.
#		exit()
